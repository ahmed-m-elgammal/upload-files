...
public final class DevMenuOkHttpExtensionKt {
    ...
    public static final Request fetchGraphQL(Uri url, String query, Pair<String, String> pair) {
        ...
        String uri = url.toString();
        Intrinsics.checkNotNullExpressionValue(uri, "toString(...)");
        Request.Builder addHeader = builder.url(uri).method("POST", RequestBody.INSTANCE.create(MediaType.INSTANCE.m4268deprecated_parse("application/json"), "{\"query\": \"" + StringsKt.replace$default(StringsKt.replace$default(StringsKt.trimIndent(query), "\n", "\\n", false, 4, (Object) null), "\"", "\\\"", false, 4, (Object) null) + "\"}")).addHeader("Content-Type", "application/json");
        if (pair != null) {
