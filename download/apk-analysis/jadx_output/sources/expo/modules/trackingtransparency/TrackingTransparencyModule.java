...
public final class TrackingTransparencyModule extends Module {
    ...
    public ModuleDefinitionData definition() {
        ...
        try {
            ...
            moduleDefinitionBuilder.getSyncFunctions().put("getAdvertisingId", new SyncFunctionComponent("getAdvertisingId", new AnyType[0], new Function1<Object[], Object>() { // from class: expo.modules.trackingtransparency.TrackingTransparencyModule$definition$lambda$1$$inlined$FunctionWithoutArgs$1
                {
                    super(1);
                }
                ...
                public final Object invoke(Object[] it) {
                    ...
                    advertisingId = TrackingTransparencyModule.this.getAdvertisingId();
