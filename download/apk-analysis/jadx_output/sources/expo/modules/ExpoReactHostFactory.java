    ...
    public static final ReactHost createFromReactNativeHost(Context context, final ReactNativeHost reactNativeHost) {
        ...
        if (reactHost == null) {
            ...
            try {
                ...
                newInstance = ReactHostImpl.class.getConstructor(Context.class, ReactHostDelegate.class, ComponentFactory.class, cls, cls).newInstance(context, expoReactHostDelegate, componentFactory, true, Boolean.valueOf(useDeveloperSupport));
                Intrinsics.checkNotNullExpressionValue(newInstance, "newInstance(...)");
            } catch (NoSuchMethodException unused) {
                Class cls2 = Boolean.TYPE;
                newInstance = ReactHostImpl.class.getConstructor(Context.class, ReactHostDelegate.class, ComponentFactory.class, cls2, ReactJsExceptionHandler.class, cls2).newInstance(context, expoReactHostDelegate, componentFactory, true, reactJsExceptionHandler, Boolean.valueOf(useDeveloperSupport));
                Intrinsics.checkNotNullExpressionValue(newInstance, "newInstance(...)");
            }
