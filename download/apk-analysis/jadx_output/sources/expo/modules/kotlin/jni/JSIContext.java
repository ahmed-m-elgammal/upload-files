...
public final class JSIContext implements Destructible {
    ...
    public final void registerSharedObject(Object r2, JavaScriptObject js) {
        ...
        SharedObjectId.m2278boximpl(sharedObjectRegistry.m2288add5WKnsLU$expo_modules_core_release((SharedObject) r2, js));
    }
    ...
    public final void deleteSharedObject(int id) {
        ...
        sharedObjectRegistry.m2289deletekyJHjyY$expo_modules_core_release(SharedObjectId.m2279constructorimpl(id));
    }
