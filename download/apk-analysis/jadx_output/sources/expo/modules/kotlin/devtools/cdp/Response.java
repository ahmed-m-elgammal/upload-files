...
public final /* data */ class Response implements JsonSerializable {
    ...
    public int hashCode() {
        return (((((((((this.url.hashCode() * 31) + this.status) * 31) + this.statusText.hashCode()) * 31) + this.headers.hashCode()) * 31) + this.mimeType.hashCode()) * 31) + Utils$$ExternalSyntheticBackport0.m(this.encodedDataLength);
    }
