...
public final /* data */ class RequestWillBeSentParams implements JsonSerializable {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((this.requestId.hashCode() * 31) + this.loaderId.hashCode()) * 31) + this.documentURL.hashCode()) * 31) + this.request.hashCode()) * 31) + this.timestamp.hashCode()) * 31) + this.wallTime.hashCode()) * 31) + this.initiator.hashCode()) * 31) + Utils$$ExternalSyntheticBackport0.m(this.redirectHasExtraInfo)) * 31;
