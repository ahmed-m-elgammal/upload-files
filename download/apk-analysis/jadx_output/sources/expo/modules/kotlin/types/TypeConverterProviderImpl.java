...
public final class TypeConverterProviderImpl implements TypeConverterProvider {
    ...
    private final Map<KClass<?>, TypeConverter<?>> createCachedConverters(final boolean isOptional) {
        ...
        return Build.VERSION.SDK_INT >= 26 ? MapsKt.plus(mapOf, MapsKt.mapOf(TuplesKt.to(Reflection.getOrCreateKotlinClass(Downloader$$ExternalSyntheticApiModelOutline0.m2161m$1()), new PathTypeConverter(isOptional)), TuplesKt.to(Reflection.getOrCreateKotlinClass(Color.class), new ColorTypeConverter(isOptional)), TuplesKt.to(Reflection.getOrCreateKotlinClass(Downloader$$ExternalSyntheticApiModelOutline0.m2165m$2()), new DateTypeConverter(isOptional)))) : mapOf;
    }
}
