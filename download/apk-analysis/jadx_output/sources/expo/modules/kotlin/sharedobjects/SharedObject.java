...
public class SharedObject {
    ...
    public SharedObject(AppContext appContext) {
        this.sharedObjectId = SharedObjectId.m2279constructorimpl(0);
    ...
    public final void m2277setSharedObjectIdkyJHjyY$expo_modules_core_release(int i) {
    ...
    private final JavaScriptObject getJavaScriptObject() {
        int m2279constructorimpl = SharedObjectId.m2279constructorimpl(this.sharedObjectId);
        AppContext appContext = getAppContext();
        if (appContext == null) {
            return null;
        }
        return SharedObjectId.m2283toJavaScriptObjectimpl(m2279constructorimpl, appContext);
    }
