...
public final class SharedObjectRegistry {
    ...
    public SharedObjectRegistry(AppContext appContext) {
        ...
        this.currentId = SharedObjectId.m2279constructorimpl(1);
    ...
    private final int m2287pullNextIdHSeVr_g() {
        int i;
        synchronized (this) {
            i = this.currentId;
            this.currentId = SharedObjectId.m2279constructorimpl(i + 1);
        }
        return i;
    }

    /* renamed from: add-5WKnsLU$expo_modules_core_release, reason: not valid java name */
    public final int m2288add5WKnsLU$expo_modules_core_release(SharedObject r8, JavaScriptObject js) {
        Intrinsics.checkNotNullParameter(r8, "native");
        Intrinsics.checkNotNullParameter(js, "js");
        int m2287pullNextIdHSeVr_g = m2287pullNextIdHSeVr_g();
        r8.m2277setSharedObjectIdkyJHjyY$expo_modules_core_release(m2287pullNextIdHSeVr_g);
        JavaScriptObject.defineProperty$default(js, SharedObjectRegistryKt.sharedObjectIdPropertyName, m2287pullNextIdHSeVr_g, (List) null, 4, (Object) null);
        AppContext appContext = this.appContextHolder.get();
        if (appContext == null) {
            throw new Exceptions.AppContextLost();
        }
        appContext.getJsiInterop$expo_modules_core_release().setNativeStateForSharedObject(m2287pullNextIdHSeVr_g, js);
        JavaScriptWeakObject createWeak = js.createWeak();
        synchronized (this) {
            this.pairs.put(SharedObjectId.m2278boximpl(m2287pullNextIdHSeVr_g), TuplesKt.to(r8, createWeak));
        ...
        return m2287pullNextIdHSeVr_g;
    }

    /* renamed from: delete-kyJHjyY$expo_modules_core_release, reason: not valid java name */
    public final void m2289deletekyJHjyY$expo_modules_core_release(int id) {
        Pair<SharedObject, JavaScriptWeakObject> remove;
        synchronized (this) {
            remove = this.pairs.remove(SharedObjectId.m2278boximpl(id));
        }
        if (remove != null) {
            SharedObject component1 = remove.component1();
            component1.m2277setSharedObjectIdkyJHjyY$expo_modules_core_release(SharedObjectId.m2279constructorimpl(0));
            component1.deallocate();
        }
    }

    /* renamed from: toNativeObject-kyJHjyY$expo_modules_core_release, reason: not valid java name */
    public final SharedObject m2290toNativeObjectkyJHjyY$expo_modules_core_release(int id) {
        SharedObject first;
        synchronized (this) {
            Pair<SharedObject, JavaScriptWeakObject> pair = this.pairs.get(SharedObjectId.m2278boximpl(id));
    ...
    public final SharedObject toNativeObject$expo_modules_core_release(JavaScriptObject js) {
        ...
        Pair<SharedObject, JavaScriptWeakObject> pair = this.pairs.get(SharedObjectId.m2278boximpl(SharedObjectId.m2279constructorimpl(js.getProperty(SharedObjectRegistryKt.sharedObjectIdPropertyName).getInt())));
        if (pair != null) {
    ...
    public final JavaScriptObject toJavaScriptObject$expo_modules_core_release(SharedObject r2) {
        ...
        synchronized (this) {
            Pair<SharedObject, JavaScriptWeakObject> pair = this.pairs.get(SharedObjectId.m2278boximpl(r2.getSharedObjectId()));
