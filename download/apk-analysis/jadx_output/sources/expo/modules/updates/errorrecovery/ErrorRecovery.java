...
public final class ErrorRecovery {
    ...
    public ErrorRecovery(Context context) {
        ...
        this.contentAppearedListener = new ReactMarker.MarkerListener() { // from class: expo.modules.updates.errorrecovery.ErrorRecovery$$ExternalSyntheticLambda1
    ...
    public final void handleContentAppeared$expo_updates_release() {
        ...
        getHandler$expo_updates_release().postDelayed(new Runnable() { // from class: expo.modules.updates.errorrecovery.ErrorRecovery$$ExternalSyntheticLambda0
