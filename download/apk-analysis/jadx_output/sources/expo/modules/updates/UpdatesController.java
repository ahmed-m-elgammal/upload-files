...
public final class UpdatesController {
    ...
    public static final class Companion {
        ...
        public final void initializeWithoutStarting(Context context) {
            ...
            if ((reactApplication == null || (reactNativeHost = reactApplication.getReactNativeHost()) == null) ? false : reactNativeHost.getUseDeveloperSupport()) {
                UpdatesDevLauncherController initializeAsDevLauncherWithoutStarting = initializeAsDevLauncherWithoutStarting(context);
                UpdatesController.singletonInstance = initializeAsDevLauncherWithoutStarting;
                UpdatesControllerRegistry.INSTANCE.setController(new WeakReference<>(initializeAsDevLauncherWithoutStarting));
                return;
            }
