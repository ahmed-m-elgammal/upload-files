...
public final /* data */ class UpdatesConfiguration {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.launchWaitMs) * 31) + this.checkOnLaunch.hashCode()) * 31) + Utils$$ExternalSyntheticBackport0.m(this.hasEmbeddedUpdate)) * 31) + this.requestHeaders.hashCode()) * 31;
        String str2 = this.codeSigningCertificate;
        int hashCode3 = (hashCode2 + (str2 == null ? 0 : str2.hashCode())) * 31;
        Map<String, String> map = this.codeSigningMetadata;
        return ((((((hashCode3 + (map != null ? map.hashCode() : 0)) * 31) + Utils$$ExternalSyntheticBackport0.m(this.codeSigningIncludeManifestResponseCertificateChain)) * 31) + Utils$$ExternalSyntheticBackport0.m(this.codeSigningAllowUnsignedManifests)) * 31) + Utils$$ExternalSyntheticBackport0.m(this.enableExpoUpdatesProtocolV0CompatibilityMode);
    }
