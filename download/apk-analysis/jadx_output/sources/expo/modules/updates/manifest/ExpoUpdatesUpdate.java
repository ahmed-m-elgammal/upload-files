        ...
        this.assetEntityList = LazyKt.lazy(new Function0<List<AssetEntity>>() { // from class: expo.modules.updates.manifest.ExpoUpdatesUpdate$assetEntityList$2
            ...
            public final List<AssetEntity> invoke() {
                ...
                try {
                    ...
                    assetEntity.setExtraRequestHeaders((JSONObject) assetHeaders2.get(jSONObject6.getString(SDKConstants.PARAM_KEY)));
                    ...
                    if (jSONArray3.length() > 0) {
                        ...
                        for (int i = 0; i < length; i++) {
                            try {
                                ...
                                AssetEntity assetEntity2 = new AssetEntity(jSONObject10.getString(SDKConstants.PARAM_KEY), jSONObject10.getString("fileExtension"));
                                ...
                                assetEntity2.setExtraRequestHeaders((JSONObject) assetHeaders.get(jSONObject10.getString(SDKConstants.PARAM_KEY)));
