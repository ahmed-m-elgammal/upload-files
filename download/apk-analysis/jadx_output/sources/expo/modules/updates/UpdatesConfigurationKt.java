...
public final class UpdatesConfigurationKt {
    ...
    private static final int getDefaultPortForScheme(String str) {
        ...
        return (Intrinsics.areEqual("https", str) || Intrinsics.areEqual("wss", str)) ? GrpcUtil.DEFAULT_PORT_SSL : Intrinsics.areEqual("ftp", str) ? 21 : -1;
    }
