...
public final /* data */ class UpdatesLogEntry {
    ...
    public int hashCode() {
        int m = ((((((Utils$$ExternalSyntheticBackport0.m(this.timestamp) * 31) + this.message.hashCode()) * 31) + this.code.hashCode()) * 31) + this.level.hashCode()) * 31;
