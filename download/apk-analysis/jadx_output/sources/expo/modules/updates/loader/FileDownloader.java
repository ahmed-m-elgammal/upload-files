...
public final class FileDownloader {
    ...
    public FileDownloader(Context context, UpdatesConfiguration configuration) {
        ...
        this.client = new OkHttpClient.Builder().cache(INSTANCE.getCache(context)).connectTimeout(Math.max(configuration.getLaunchWaitMs(), WorkRequest.MIN_BACKOFF_MILLIS), TimeUnit.MILLISECONDS).readTimeout(Math.max(configuration.getLaunchWaitMs(), WorkRequest.MIN_BACKOFF_MILLIS), TimeUnit.MILLISECONDS).addInterceptor(BrotliInterceptor.INSTANCE).build();
