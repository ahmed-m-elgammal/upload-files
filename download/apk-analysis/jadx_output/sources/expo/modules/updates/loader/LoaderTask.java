...
public final class LoaderTask {
    ...
    public final void start(final Context context) {
        ...
        if (launchWaitMs > 0 && shouldCheckForUpdateOnLaunch) {
            ...
            new Handler(this.handlerThread.getLooper()).postDelayed(new Runnable() { // from class: expo.modules.updates.loader.LoaderTask$$ExternalSyntheticLambda1
