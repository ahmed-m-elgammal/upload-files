...
public final class UpdatesUtils {
    ...
    public final void sendEvent(EventEmitter eventEmitter, boolean shouldEmitJsEvents, UpdatesLogger logger, String eventName, String eventType, WritableMap params) {
        ...
        if (!shouldEmitJsEvents) {
            ...
            UpdatesLogger.error$default(logger, "Could not emit " + eventName + " " + eventType + " event; no subscribers registered.", UpdatesErrorCode.JSRuntimeError, null, 4, null);
            return;
        }
        ...
        try {
            ...
            UpdatesLogger.error$default(logger, "Could not emit " + eventName + " " + eventType + " event; " + e.getMessage(), UpdatesErrorCode.JSRuntimeError, null, 4, null);
            eventsToSendToJS.add(new Pair<>(eventName, params));
        }
    }
