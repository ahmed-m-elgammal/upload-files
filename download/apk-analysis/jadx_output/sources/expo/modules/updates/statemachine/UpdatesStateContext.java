...
public final /* data */ class UpdatesStateContext {
    ...
    public int hashCode() {
        int m = ((((((((Utils$$ExternalSyntheticBackport0.m(this.isUpdateAvailable) * 31) + Utils$$ExternalSyntheticBackport0.m(this.isUpdatePending)) * 31) + Utils$$ExternalSyntheticBackport0.m(this.isChecking)) * 31) + Utils$$ExternalSyntheticBackport0.m(this.isDownloading)) * 31) + Utils$$ExternalSyntheticBackport0.m(this.isRestarting)) * 31;
