...
public final class DatabaseLauncher implements Launcher {
    ...
    public Map<AssetEntity, String> mo2361getLocalAssetFiles() {
    ...
    public boolean getIsUsingEmbeddedAssets() {
        return mo2361getLocalAssetFiles() == null;
    }
    ...
    public final synchronized void maybeFinish(AssetEntity asset, File assetFile) {
        ...
        if (asset.getIsLaunchAsset()) {
            ...
            Map<AssetEntity, String> mo2361getLocalAssetFiles = mo2361getLocalAssetFiles();
            Intrinsics.checkNotNull(mo2361getLocalAssetFiles);
            String file2 = assetFile.toString();
            Intrinsics.checkNotNullExpressionValue(file2, "toString(...)");
            mo2361getLocalAssetFiles.put(asset, file2);
        }
