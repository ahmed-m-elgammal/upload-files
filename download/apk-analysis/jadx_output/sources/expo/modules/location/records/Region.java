...
public final class Region implements Record, Serializable {
    ...
    public Region() {
        this(null, AudioStats.AUDIO_AMPLITUDE_NONE, AudioStats.AUDIO_AMPLITUDE_NONE, null, null, null, null, 127, null);
    }
    ...
    public /* synthetic */ Region(String str, double d, double d2, Boolean bool, Boolean bool2, Double d3, GeofencingRegionState geofencingRegionState, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str, (i & 2) != 0 ? 0.0d : d, (i & 4) != 0 ? 0.0d : d2, (i & 8) != 0 ? true : bool, (i & 16) != 0 ? true : bool2, (i & 32) != 0 ? Double.valueOf(AudioStats.AUDIO_AMPLITUDE_NONE) : d3, (i & 64) != 0 ? GeofencingRegionState.UNKNOWN : geofencingRegionState);
    }
