            ...
            this.this$0.addPendingLocationRequest(prepareLocationRequest$expo_location_release, new LocationActivityResultListener() { // from class: expo.modules.location.LocationModule$definition$1$16$1$1
                ...
                public void onResult(int resultCode) {
                    if (resultCode == -1) {
                        ...
                        continuation.resumeWith(Result.m2566constructorimpl(null));
                    } else {
                        Continuation<String> continuation2 = safeContinuation2;
                        Result.Companion companion3 = Result.INSTANCE;
                        continuation2.resumeWith(Result.m2566constructorimpl(ResultKt.createFailure(new LocationSettingsUnsatisfiedException())));
                    }
                }
            });
