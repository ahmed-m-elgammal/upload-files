    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Build.VERSION.SDK_INT == 29) {
                this.label = 1;
                obj = LocationHelpers.INSTANCE.askForPermissionsWithPermissionsManager$expo_location_release(permissions, new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_BACKGROUND_LOCATION"}, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                this.label = 2;
                obj = LocationHelpers.INSTANCE.askForPermissionsWithPermissionsManager$expo_location_release(permissions, new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION"}, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
