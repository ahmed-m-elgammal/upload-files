...
public final /* data */ class SourceMap implements Record {
    ...
    public int hashCode() {
        String str = this.uri;
        int hashCode = (((((((str == null ? 0 : str.hashCode()) * 31) + this.width) * 31) + this.height) * 31) + Utils$$ExternalSyntheticBackport0.m(this.scale)) * 31;
