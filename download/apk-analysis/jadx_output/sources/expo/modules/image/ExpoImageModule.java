...
public final class ExpoImageModule extends Module {
    ...
    public ModuleDefinitionData definition() {
        ...
        try {
            ...
            viewDefinitionBuilder.getProps().put("backgroundColor", new ConcreteViewProp("backgroundColor", new AnyType(new LazyKType(Reflection.getOrCreateKotlinClass(Integer.class), true, new Function0<KType>() { // from class: expo.modules.image.ExpoImageModule$definition$lambda$17$lambda$16$$inlined$Prop$8
                @Override // kotlin.jvm.functions.Function0
                public final KType invoke() {
                    return Reflection.nullableTypeOf(Integer.class);
                }
