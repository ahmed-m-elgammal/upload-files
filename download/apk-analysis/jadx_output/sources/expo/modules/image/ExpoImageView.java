...
public final class ExpoImageView extends AppCompatImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.borderDrawableLazyHolder.isInitialized()) {
            ...
            try {
                declaredMethod = ReactViewBackgroundDrawable.class.getDeclaredMethod("setResolvedLayoutDirection", Integer.TYPE);
            ...
            declaredMethod.invoke(borderDrawable, Integer.valueOf(isRTL ? 1 : 0));
