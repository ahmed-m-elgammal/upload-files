...
public final class LocalizationUtilsKt {
    ...
    public static final String getCountryCode(Locale locale) {
        ...
        try {
            ...
            m2566constructorimpl = Result.m2566constructorimpl(country);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
        return (String) (Result.m2572isFailureimpl(m2566constructorimpl) ? null : m2566constructorimpl);
    }
    ...
    public static final String getSystemProperty(String key) {
        ...
        try {
            ...
            m2566constructorimpl = Result.m2566constructorimpl((String) invoke);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
        ...
        String str = (String) m2566constructorimpl;
        return str == null ? "" : str;
    }
    ...
    public static final String getCurrencyCode(Locale locale) {
        ...
        try {
            ...
            m2566constructorimpl = Result.m2566constructorimpl(currency != null ? currency.getCurrencyCode() : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
