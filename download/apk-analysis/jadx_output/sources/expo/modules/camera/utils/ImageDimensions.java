...
public final /* data */ class ImageDimensions {
    ...
    public int hashCode() {
        return (((((this.mWidth * 31) + this.mHeight) * 31) + this.rotation) * 31) + this.facing.hashCode();
    }
    ...
    public ImageDimensions(int i, int i2, int i3, CameraType facing) {
        Intrinsics.checkNotNullParameter(facing, "facing");
        this.mWidth = i;
        this.mHeight = i2;
        this.rotation = i3;
