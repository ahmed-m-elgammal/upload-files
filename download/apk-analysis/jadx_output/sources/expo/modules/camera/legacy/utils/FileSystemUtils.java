...
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0003\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004J\u001e\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\tJ\u001e\u0010\u000b\u001a\u00020\t2\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t¨\u0006\f"}, d2 = {"Lexpo/modules/camera/legacy/utils/FileSystemUtils;", "", "()V", "ensureDirExists", "Ljava/io/File;", "dir", "generateOutputFile", "internalDirectory", "dirName", "", ShareConstants.MEDIA_EXTENSION, "generateOutputPath", "expo-camera_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class FileSystemUtils {
    ...
    public final String generateOutputPath(File internalDirectory, String dirName, String extension) throws IOException {
        ...
        return file.toString() + File.separator + uuid + extension;
    }
    ...
    public final File generateOutputFile(File internalDirectory, String dirName, String extension) throws IOException {
        ...
        String uuid = UUID.randomUUID().toString();
        Intrinsics.checkNotNullExpressionValue(uuid, "toString(...)");
        return new File(file.toString() + File.separator + uuid + extension);
    }
}
