...
public class ExpoModulesPackageList implements ModulesProvider {
    ...
    private static class LazyHolder {
        static final List<Package> packagesList = Arrays.asList(new ReactAdapterPackage(), new AVPackage(), new ConstantsPackage(), new BasePackage(), new DevLauncherPackage(), new DevMenuPackage(), new FileSystemPackage(), new ImageLoaderPackage(), new KeepAwakePackage(), new LocalizationPackage(), new NotificationsPackage(), new SplashScreenPackage(), new SystemUIPackage(), new UpdatesPackage());
        static final List<Class<? extends Module>> modulesList = Arrays.asList(ApplicationModule.class, AssetModule.class, VideoViewModule.class, AVModule.class, CalendarModule.class, CameraViewModule.class, CameraViewLegacyModule.class, ConstantsModule.class, DevMenuModule.class, DevMenuPreferences.class, DocumentPickerModule.class, EASClientModule.class, FileSystemModule.class, FontLoaderModule.class, ExpoImageModule.class, ImageManipulatorModule.class, ImagePickerModule.class, IntentLauncherModule.class, KeepAwakeModule.class, LinearGradientModule.class, LocalizationModule.class, LocationModule.class, BadgeModule.class, ExpoBackgroundNotificationTasksModule.class, ExpoNotificationCategoriesModule.class, NotificationChannelGroupManagerModule.class, NotificationChannelManagerModule.class, NotificationsEmitter.class, NotificationsHandler.class, NotificationPermissionsModule.class, ExpoNotificationPresentationModule.class, NotificationScheduler.class, ServerRegistrationModule.class, PushTokenModule.class, ScreenOrientationModule.class, SharingModule.class, SplashScreenModule.class, SQLiteModule.class, SQLiteModuleNext.class, StoreReviewModule.class, SystemUIModule.class, TrackingTransparencyModule.class, UpdatesModule.class);
