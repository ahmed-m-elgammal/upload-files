...
public class SplashScreenViewController {
    ...
    public void showSplashScreen(final Function0<Unit> successCallback) {
        ...
        if (activity != null) {
            activity.runOnUiThread(new Runnable() { // from class: expo.modules.splashscreen.SplashScreenViewController$$ExternalSyntheticLambda2
    ...
    private final void searchForRootView() {
        ...
        if (findRootView != null) {
            ...
            this.handler.postDelayed(new Runnable() { // from class: expo.modules.splashscreen.SplashScreenViewController$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private final void handleRootView(ViewGroup view) {
        this.rootView = view;
        if ((view != null ? view.getChildCount() : 0) > 0 && this.autoHideEnabled) {
