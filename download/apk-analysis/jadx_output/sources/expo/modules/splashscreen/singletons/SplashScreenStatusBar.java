...
public final class SplashScreenStatusBar {
    ...
    public final void configureTranslucent(final Activity activity, Boolean translucent) {
        ...
        if (translucent != null) {
            ...
            activity.runOnUiThread(new Runnable() { // from class: expo.modules.splashscreen.singletons.SplashScreenStatusBar$$ExternalSyntheticLambda0
    ...
    public static final void configureTranslucent$lambda$2$lambda$1(Activity activity, boolean z) {
        ...
        if (z) {
            decorView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: expo.modules.splashscreen.singletons.SplashScreenStatusBar$$ExternalSyntheticLambda1
