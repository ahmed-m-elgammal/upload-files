...
public final class BrotliInterceptor implements Interceptor {
    ...
    public final okhttp3.Response uncompress$okhttp_brotli(okhttp3.Response response) {
        ...
        if (!okhttp3.internal.http.HttpHeaders.promisesBody(response) || (body = response.body()) == null || (header$default = okhttp3.Response.header$default(response, "Content-Encoding", null, 2, null)) == null) {
            return response;
        }
        ...
        return response.newBuilder().removeHeader("Content-Encoding").removeHeader("Content-Length").body(ResponseBody.INSTANCE.create(buffer, body.get$contentType(), -1L)).build();
    }
}
