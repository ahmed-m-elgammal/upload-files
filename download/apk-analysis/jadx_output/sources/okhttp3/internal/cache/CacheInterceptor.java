...
public final class CacheInterceptor implements Interceptor {
    ...
    private final okhttp3.Response cacheWritingResponse(final CacheRequest cacheRequest, okhttp3.Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(okhttp3.Response.header$default(response, "Content-Type", null, 2, null), response.body().getContentLength(), Okio.buffer(source2))).build();
    }
