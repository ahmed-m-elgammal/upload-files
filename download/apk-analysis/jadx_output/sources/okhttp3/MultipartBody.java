...
public final class MultipartBody extends RequestBody {
    ...
    public static final MediaType MIXED = MediaType.INSTANCE.get(FileUploadBase.MULTIPART_MIXED);
    ...
    public final String m4269deprecated_boundary() {
        return boundary();
    }
    ...
    public final int m4271deprecated_size() {
        return size();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "parts", imports = {}))
    /* renamed from: -deprecated_parts, reason: not valid java name */
    public final List<Part> m4270deprecated_parts() {
        return this.parts;
    }
