...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo4142scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m4073delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m4074toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m4074toDelayMillisLRDsOJo(long j) {
        if (Duration.m3908compareToLRDsOJo(j, Duration.INSTANCE.m4012getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m3927getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
