...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> m995m = Intl$$ExternalSyntheticApiModelOutline0.m995m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(newCoroutineContext, m995m);
        m995m.handle(Headers$Builder$$ExternalSyntheticApiModelOutline0.m4223m((Object) completableFutureCoroutine));
    ...
    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> m995m = Intl$$ExternalSyntheticApiModelOutline0.m995m();
        setupCancellation(deferred, m995m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$1
            ...
            public final void invoke2(Throwable th) {
                try {
                    m995m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    m995m.completeExceptionally(th2);
                }
            }
        });
        return m995m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> m995m = Intl$$ExternalSyntheticApiModelOutline0.m995m();
        setupCancellation(job, m995m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    m995m.complete(Unit.INSTANCE);
                } else {
                    m995m.completeExceptionally(th);
                }
            }
        });
        return m995m;
    ...
    private static final void setupCancellation(final Job job, CompletableFuture<?> completableFuture) {
        completableFuture.handle((BiFunction<? super Object, Throwable, ? extends U>) new BiFunction() { // from class: kotlinx.coroutines.future.FutureKt$$ExternalSyntheticLambda6
    ...
    public static final <T> Deferred<T> asDeferred(CompletionStage<T> completionStage) {
            ...
            */
            public final java.lang.Object invoke2(T r2, java.lang.Throwable r3) {
                ...
                L9:
                    ...
                    boolean r0 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m4228m(r3)     // Catch: java.lang.Throwable -> L2a
                    if (r0 == 0) goto L16
                    java.util.concurrent.CompletionException r0 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m4222m(r3)     // Catch: java.lang.Throwable -> L2a
                    goto L17
                L16:
                    r0 = 0
                L17:
        ...
        completionStage.handle(new BiFunction() { // from class: kotlinx.coroutines.future.FutureKt$$ExternalSyntheticLambda5
            @Override // java.util.function.BiFunction
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) {
        ...
        completionStage.handle(Headers$Builder$$ExternalSyntheticApiModelOutline0.m4223m((Object) continuationHandler));
