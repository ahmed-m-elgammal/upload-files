...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m2566constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        try {
            ...
            obj2 = Result.m2566constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            obj2 = Result.m2566constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m2569exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
