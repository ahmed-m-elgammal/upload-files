...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m2566constructorimpl = Result.m2566constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m2566constructorimpl = Result.m2566constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m2572isFailureimpl(m2566constructorimpl) ? null : m2566constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m2572isFailureimpl(m2566constructorimpl)) {
            m2566constructorimpl = valueOf;
        }
        return ((Number) m2566constructorimpl).intValue();
    }
