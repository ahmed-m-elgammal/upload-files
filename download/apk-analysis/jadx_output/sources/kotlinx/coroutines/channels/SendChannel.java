...
public interface SendChannel<E> {
    ...
    Object mo4085trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo4085trySendJP2dKIU = sendChannel.mo4085trySendJP2dKIU(e);
            if (ChannelResult.m4105isSuccessimpl(mo4085trySendJP2dKIU)) {
                return true;
            }
            Throwable m4099exceptionOrNullimpl = ChannelResult.m4099exceptionOrNullimpl(mo4085trySendJP2dKIU);
