...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m4113trySendImplMj0NB7M = conflatedBufferedChannel.m4113trySendImplMj0NB7M(e, true);
        if (m4113trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m4099exceptionOrNullimpl(m4113trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m4113trySendImplMj0NB7M = conflatedBufferedChannel.m4113trySendImplMj0NB7M(e, true);
        if (!(m4113trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo4085trySendJP2dKIU(E element) {
        return m4113trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m4113trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m4111trySendDropLatestMj0NB7M(element, isSendOp) : m4112trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m4111trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo4085trySendJP2dKIU = super.mo4085trySendJP2dKIU(element);
        if (ChannelResult.m4105isSuccessimpl(mo4085trySendJP2dKIU) || ChannelResult.m4103isClosedimpl(mo4085trySendJP2dKIU)) {
            return mo4085trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m4110successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m4112trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m4108closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo4085trySendJP2dKIU = mo4085trySendJP2dKIU(element);
        if (!(mo4085trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo4085trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m4099exceptionOrNullimpl(mo4085trySendJP2dKIU);
