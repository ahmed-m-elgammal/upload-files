...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m2566constructorimpl = Result.m2566constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m2572isFailureimpl(m2566constructorimpl) ? null : m2566constructorimpl);
