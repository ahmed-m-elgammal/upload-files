...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(m2569exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (m2569exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m2569exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m2569exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(m2569exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
