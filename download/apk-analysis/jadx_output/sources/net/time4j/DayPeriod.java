...
public final class DayPeriod {
    ...
    public static Map<String, String> loadTextForms(Locale locale, String str) {
        ...
        return (str.equals(CalendarText.ISO_CALENDAR_TYPE) || ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(textForms.get("hasDayPeriods"))) ? textForms : CalendarText.getIsoInstance(locale).getTextForms();
    }
