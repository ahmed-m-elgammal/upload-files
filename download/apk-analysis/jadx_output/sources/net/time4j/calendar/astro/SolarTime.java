...
public final class SolarTime implements GeoLocation, Serializable {
    ...
    private void checkShadow(double d, double d2) {
        ...
        if (Double.isInfinite(d2) || Double.isNaN(d2) || d2 < AudioStats.AUDIO_AMPLITUDE_NONE) {
    ...
    public Moment timeOfShadow(CalendarDate calendarDate, boolean z, double d, double d2) {
        ...
        double degrees = d2 == AudioStats.AUDIO_AMPLITUDE_NONE ? 90.0d : Math.toDegrees(Math.atan(d / d2));
    ...
    private Moment timeOfShadow(long j, long j2, double d) {
        ...
        if (Double.compare(d, r1) > AudioStats.AUDIO_AMPLITUDE_NONE) {
    ...
    public static class Builder {
        ...
        private static void check(int i, int i2, double d, int i3) {
            if (i < 0 || i > i3 || (i == i3 && i3 != 179 && (i2 > 0 || Double.compare(d, AudioStats.AUDIO_AMPLITUDE_NONE) > 0))) {
            ...
            if (Double.compare(d, AudioStats.AUDIO_AMPLITUDE_NONE) < 0 || Double.compare(d, 60.0d) >= 0) {
