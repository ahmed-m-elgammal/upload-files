...
public class SexagesimalName implements Comparable<SexagesimalName>, Serializable {
    ...
    static {
        ...
        hashMap.put(CodeSigningAlgorithmKt.CODE_SIGNING_METADATA_DEFAULT_KEY_ID, STEMS_SIMPLE);
        ...
        hashMap2.put(CodeSigningAlgorithmKt.CODE_SIGNING_METADATA_DEFAULT_KEY_ID, BRANCHES_SIMPLE);
    ...
    public enum Stem {
        ...
        public String getDisplayName(Locale locale) {
            ...
            if (language.isEmpty()) {
                language = CodeSigningAlgorithmKt.CODE_SIGNING_METADATA_DEFAULT_KEY_ID;
            }
