...
public final class JapaneseCalendar extends Calendrical<Unit, JapaneseCalendar> implements LocalizedPatternSupport {
    ...
    public static JapaneseCalendar of(Nengo nengo, int i, EastAsianMonth eastAsianMonth, int i2, Leniency leniency) {
        ...
        if (i3 >= 1873) {
            ...
            int i6 = firstRelatedGregorianYear - 702;
    ...
    private static class JapaneseUnitRule implements UnitRule<JapaneseCalendar> {
        ...
        public JapaneseCalendar addTo(JapaneseCalendar japaneseCalendar, long j) {
            ...
            if (i2 == 2) {
                try {
                    ...
                    } else if (eastAsianMonth.isLeap() && JapaneseCalendar.LEAP_INDICATORS[safeAdd - 701] != number + 1) {
                        eastAsianMonth = EastAsianMonth.valueOf(number);
                    }
            ...
            try {
                ...
                while (j != 0) {
                    ...
                    if (i3 >= 1873) {
                        ...
                        if (JapaneseCalendar.LEAP_INDICATORS[i3 - 701] != 0) {
                            i5 = 13;
                        }
                        if (monthIndex > i5) {
                            i3++;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:38:0x00a1, code lost:
            ...
            if (net.time4j.calendar.JapaneseCalendar.LEAP_INDICATORS[r3 - 702] != 0) goto L46;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:49:0x00b6, code lost:
            ...
            if (net.time4j.calendar.JapaneseCalendar.LEAP_INDICATORS[r3 - 702] == 0) goto L47;
         */
        @Override // net.time4j.engine.UnitRule
        /*
