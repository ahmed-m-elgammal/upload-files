...
public enum HistoricEra implements CalendarEra {
    ...
    public String getAlternativeName(Locale locale, TextWidth textWidth) {
        return CalendarText.getIsoInstance(locale).getTextForms(ChronoHistory.ofFirstGregorianReform().era(), textWidth == TextWidth.WIDE ? "w" : CmcdData.Factory.OBJECT_TYPE_AUDIO_ONLY, "alt").print(this);
    }
