...
public final class PlainDate extends Calendrical<IsoDateUnit, PlainDate> implements GregorianDate, Normalizer<CalendarUnit>, LocalizedPatternSupport {
    ...
    private static final int[] DAY_OF_YEAR_PER_MONTH = {31, 59, 90, 120, 151, 181, 212, 243, 273, HttpServletResponse.SC_NOT_MODIFIED, 334, 365};
    private static final int[] DAY_OF_LEAP_YEAR_PER_MONTH = {31, 60, 91, 121, 152, 182, 213, 244, TiffUtil.TIFF_TAG_ORIENTATION, HttpServletResponse.SC_USE_PROXY, 335, 366};
