...
final class ProportionalFunction implements ChronoFunction<ChronoEntity<?>, BigDecimal> {
    ...
    public BigDecimal apply(ChronoEntity<?> chronoEntity) {
        ...
        return JsonNodeFactory$$ExternalSyntheticBackportWithForwarding0.m(new BigDecimal(longValue - longValue2).setScale(15).divide(new BigDecimal((longValue3 - longValue2) + 1), RoundingMode.HALF_UP));
    }
}
