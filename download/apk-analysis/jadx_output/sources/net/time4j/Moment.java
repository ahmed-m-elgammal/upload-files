        ...
        switch (AnonymousClass1.$SwitchMap$net$time4j$scale$TimeScale[timeScale.ordinal()]) {
            ...
            case 3:
                if (getElapsedTimeUTC() < 0) {
                    ...
                    elapsedTimeUTC = floor - (-441763168);
                    if (nanos - 184000000 < 0) {
                        elapsedTimeUTC = floor - (-441763167);
                    }
                } else {
        ...
        switch (AnonymousClass1.$SwitchMap$net$time4j$scale$TimeScale[timeScale.ordinal()]) {
            ...
            case 3:
                if (getElapsedTimeUTC() < 0) {
                    ...
                    elapsedTimeUTC = floor - (-441763168);
                    nanosecond = i - 184000000;
                    if (nanosecond < 0) {
                        elapsedTimeUTC = floor - (-441763167);
                        nanosecond = i - (-816000000);
                    }
                } else {
            ...
            case 5:
                ...
                int i2 = nanosecond2 + 184000000;
                return i2 >= 1000000000 ? nanosecond2 - 816000000 : i2;
            case 6:
                if (this.posixTime < POSIX_UTC_DELTA) {
                    return getNanosecond();
                }
