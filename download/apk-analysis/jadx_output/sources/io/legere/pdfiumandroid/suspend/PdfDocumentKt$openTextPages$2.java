...
final class PdfDocumentKt$openTextPages$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends PdfTextPageKt>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        List<PdfTextPage> openTextPages = this.this$0.getDocument().openTextPages(this.$fromIndex, this.$toIndex);
        PdfDocumentKt pdfDocumentKt = this.this$0;
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(openTextPages, 10));
        for (PdfTextPage pdfTextPage : openTextPages) {
            coroutineDispatcher = pdfDocumentKt.dispatcher;
            arrayList.add(new PdfTextPageKt(pdfTextPage, coroutineDispatcher));
        }
        return arrayList;
    }
}
