...
final class PdfiumCoreKt$newDocument$6 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PdfDocumentKt>, Object> {
    final /* synthetic */ byte[] $data;
    int label;
    final /* synthetic */ PdfiumCoreKt this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PdfiumCoreKt$newDocument$6(PdfiumCoreKt pdfiumCoreKt, byte[] bArr, Continuation<? super PdfiumCoreKt$newDocument$6> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PdfiumCoreKt$newDocument$6(this.this$0, this.$data, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super PdfDocumentKt> continuation) {
        return ((PdfiumCoreKt$newDocument$6) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
