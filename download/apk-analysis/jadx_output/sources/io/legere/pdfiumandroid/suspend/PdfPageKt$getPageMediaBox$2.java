...
final class PdfPageKt$getPageMediaBox$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super RectF>, Object> {
    int label;
    final /* synthetic */ PdfPageKt this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PdfPageKt$getPageMediaBox$2(PdfPageKt pdfPageKt, Continuation<? super PdfPageKt$getPageMediaBox$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PdfPageKt$getPageMediaBox$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super RectF> continuation) {
        return ((PdfPageKt$getPageMediaBox$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
