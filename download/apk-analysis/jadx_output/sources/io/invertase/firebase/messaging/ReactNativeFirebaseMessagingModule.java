...
public class ReactNativeFirebaseMessagingModule extends ReactNativeFirebaseModule implements ActivityEventListener {
    ...
    public void isNotificationDelegationEnabled(final Promise promise) {
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseMessagingModule.lambda$isNotificationDelegationEnabled$2();
            }
    ...
    static /* synthetic */ Object lambda$isNotificationDelegationEnabled$2() throws Exception {
        FirebaseMessaging.getInstance().isNotificationDelegationEnabled();
        return null;
    }

    static /* synthetic */ void lambda$isNotificationDelegationEnabled$3(Promise promise, Task task) {
        if (task.isSuccessful()) {
    ...
    public void setNotificationDelegationEnabled(final Boolean bool, final Promise promise) {
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda2
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseMessagingModule.lambda$setNotificationDelegationEnabled$4(bool);
            }
        }).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda3
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    static /* synthetic */ Object lambda$setNotificationDelegationEnabled$4(Boolean bool) throws Exception {
        FirebaseMessaging.getInstance().setNotificationDelegationEnabled(bool.booleanValue());
        return null;
    }

    static /* synthetic */ void lambda$setNotificationDelegationEnabled$5(Promise promise, Task task) {
        if (task.isSuccessful()) {
    ...
    public void getToken(String str, String str2, final Promise promise) {
        ...
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda12
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseMessagingModule.lambda$getToken$6(FirebaseMessaging.this);
            }
        }).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda13
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    static /* synthetic */ String lambda$getToken$6(FirebaseMessaging firebaseMessaging) throws Exception {
        return (String) Tasks.await(firebaseMessaging.getToken());
    }

    static /* synthetic */ void lambda$getToken$7(Promise promise, Task task) {
        if (task.isSuccessful()) {
            promise.resolve(task.getResult());
        } else {
            rejectPromiseWithExceptionMap(promise, task.getException());
    ...
    public void deleteToken(String str, String str2, final Promise promise) {
        ...
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseMessagingModule.lambda$deleteToken$8(FirebaseMessaging.this);
            }
    ...
    static /* synthetic */ Object lambda$deleteToken$8(FirebaseMessaging firebaseMessaging) throws Exception {
        Tasks.await(firebaseMessaging.deleteToken());
        return null;
    }

    static /* synthetic */ void lambda$deleteToken$9(Promise promise, Task task) {
        if (task.isSuccessful()) {
            promise.resolve(task.getResult());
        } else {
            rejectPromiseWithExceptionMap(promise, task.getException());
    ...
    public void hasPermission(final Promise promise) {
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda10
            @Override // java.util.concurrent.Callable
            public final Object call() {
        ...
        }).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda11
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public /* synthetic */ Boolean lambda$hasPermission$10() throws Exception {
        return Boolean.valueOf(NotificationManagerCompat.from(getReactApplicationContext()).areNotificationsEnabled());
    }

    static /* synthetic */ void lambda$hasPermission$11(Promise promise, Task task) {
        if (task.isSuccessful()) {
    ...
    public void sendMessage(final ReadableMap readableMap, final Promise promise) {
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda14
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseMessagingModule.lambda$sendMessage$12(ReadableMap.this);
            }
        }).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda15
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    static /* synthetic */ Object lambda$sendMessage$12(ReadableMap readableMap) throws Exception {
        FirebaseMessaging.getInstance().send(ReactNativeFirebaseMessagingSerializer.remoteMessageFromReadableMap(readableMap));
        return null;
    }

    static /* synthetic */ void lambda$sendMessage$13(Promise promise, Task task) {
        if (task.isSuccessful()) {
            promise.resolve(task.getResult());
        } else {
            rejectPromiseWithExceptionMap(promise, task.getException());
    ...
    public void subscribeToTopic(String str, final Promise promise) {
        FirebaseMessaging.getInstance().subscribeToTopic(str).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda4
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    static /* synthetic */ void lambda$subscribeToTopic$14(Promise promise, Task task) {
        if (task.isSuccessful()) {
            promise.resolve(task.getResult());
        } else {
            rejectPromiseWithExceptionMap(promise, task.getException());
    ...
    public void unsubscribeFromTopic(String str, final Promise promise) {
        FirebaseMessaging.getInstance().unsubscribeFromTopic(str).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda16
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    static /* synthetic */ void lambda$unsubscribeFromTopic$15(Promise promise, Task task) {
        if (task.isSuccessful()) {
            promise.resolve(task.getResult());
        } else {
            rejectPromiseWithExceptionMap(promise, task.getException());
    ...
    public void setDeliveryMetricsExportToBigQuery(final Boolean bool, final Promise promise) {
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.messaging.ReactNativeFirebaseMessagingModule$$ExternalSyntheticLambda17
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseMessagingModule.lambda$setDeliveryMetricsExportToBigQuery$16(bool);
            }
    ...
    static /* synthetic */ Object lambda$setDeliveryMetricsExportToBigQuery$16(Boolean bool) throws Exception {
        FirebaseMessaging.getInstance().setDeliveryMetricsExportToBigQuery(bool.booleanValue());
        return null;
    }

    static /* synthetic */ void lambda$setDeliveryMetricsExportToBigQuery$17(Promise promise, Task task) {
        if (task.isSuccessful()) {
