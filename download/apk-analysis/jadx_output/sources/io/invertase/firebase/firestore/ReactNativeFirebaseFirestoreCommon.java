...
class ReactNativeFirebaseFirestoreCommon {
    ...
    static DocumentSnapshot.ServerTimestampBehavior getServerTimestampBehavior(String str, String str2) {
        ...
        String stringValue = UniversalFirebasePreferences.getSharedInstance().getStringValue(UniversalFirebaseFirestoreStatics.FIRESTORE_SERVER_TIMESTAMP_BEHAVIOR + "_" + createFirestoreKey, "none");
