...
public class GeofencingStore implements Store<GeofenceModel> {
    ...
    public GeofenceModel get(String str) {
        ...
        builder.setLatitude(Double.longBitsToDouble(this.preferences.getLong(getFieldKey(str, LATITUDE_ID), 0L)));
        builder.setLongitude(Double.longBitsToDouble(this.preferences.getLong(getFieldKey(str, LONGITUDE_ID), 0L)));
        ...
        builder.setExpiration(this.preferences.getLong(getFieldKey(str, EXPIRATION_ID), 0L));
