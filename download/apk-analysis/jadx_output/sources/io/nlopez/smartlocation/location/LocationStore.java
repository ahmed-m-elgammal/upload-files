...
public class LocationStore implements Store<Location> {
    ...
    public Location get(String str) {
        ...
        location.setLatitude(Double.longBitsToDouble(this.preferences.getLong(getFieldKey(str, LATITUDE_ID), 0L)));
        location.setLongitude(Double.longBitsToDouble(this.preferences.getLong(getFieldKey(str, LONGITUDE_ID), 0L)));
        location.setAccuracy(this.preferences.getFloat(getFieldKey(str, ACCURACY_ID), 0.0f));
        location.setAltitude(Double.longBitsToDouble(this.preferences.getLong(getFieldKey(str, ALTITUDE_ID), 0L)));
        location.setSpeed(this.preferences.getFloat(getFieldKey(str, SPEED_ID), 0.0f));
        location.setTime(this.preferences.getLong(getFieldKey(str, TIME_ID), 0L));
