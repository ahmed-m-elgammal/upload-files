...
public final class OutlierDetectionLoadBalancer extends LoadBalancer {
    ...
    class DetectionTimer implements Runnable {
        ...
        public void run() {
            ...
            Iterator<OutlierEjectionAlgorithm> it = OutlierEjectionAlgorithm.CC.forConfig(this.config, this.logger).iterator();
            while (it.hasNext()) {
    ...
    interface OutlierEjectionAlgorithm {
        ...
        public final /* synthetic */ class CC {
            @Nullable
            public static List<OutlierEjectionAlgorithm> forConfig(OutlierDetectionLoadBalancerConfig outlierDetectionLoadBalancerConfig, ChannelLogger channelLogger) {
    ...
    static class SuccessRateOutlierEjectionAlgorithm implements OutlierEjectionAlgorithm {
        ...
        public void ejectOutliers(AddressTrackerMap addressTrackerMap, long j) {
            Iterator it;
            List trackersWithVolume = OutlierDetectionLoadBalancer.trackersWithVolume(addressTrackerMap, this.config.successRateEjection.requestVolume.intValue());
            ...
            while (it2.hasNext()) {
                arrayList.add(Double.valueOf(((AddressTracker) it2.next()).successRate()));
            }
            ...
            while (it3.hasNext()) {
                AddressTracker addressTracker = (AddressTracker) it3.next();
