...
class GzipInflatingBuffer implements Closeable {
    ...
    */
    int inflateBytes(byte[] r7, int r8, int r9) throws java.util.zip.DataFormatException, java.util.zip.ZipException {
        /*
            r6 = this;
    ...
    private int inflate(byte[] bArr, int i, int i2) throws DataFormatException, ZipException {
        ...
        try {
            ...
            if (this.inflater.finished()) {
                this.expectedGzipTrailerIsize = this.inflater.getBytesWritten() & BodyPartID.bodyIdMax;
