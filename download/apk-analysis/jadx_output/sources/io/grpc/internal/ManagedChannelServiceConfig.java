...
final class ManagedChannelServiceConfig {
    ...
    static final class MethodInfo {
        ...
        private static RetryPolicy retryPolicy(Map<String, ?> map, int i) {
            ...
            Double d = (Double) Preconditions.checkNotNull(ServiceConfigUtil.getBackoffMultiplierFromRetryPolicy(map), "backoffMultiplier cannot be empty");
            double doubleValue = d.doubleValue();
            Preconditions.checkArgument(doubleValue > AudioStats.AUDIO_AMPLITUDE_NONE, "backoffMultiplier must be greater than 0: %s", d);
