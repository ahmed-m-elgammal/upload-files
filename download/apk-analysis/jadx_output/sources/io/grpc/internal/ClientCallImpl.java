...
final class ClientCallImpl<ReqT, RespT> extends ClientCall<ReqT, RespT> {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add(Request.JsonKeys.METHOD, this.method).toString();
    }
