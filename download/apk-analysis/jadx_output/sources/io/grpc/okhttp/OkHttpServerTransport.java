...
final class OkHttpServerTransport implements ServerTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler, OutboundFlowController.Transport {
    ...
    public void start(ServerTransportListener serverTransportListener) {
        ...
        serializingExecutor.execute(new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$$ExternalSyntheticLambda5
            ...
            public final void run() {
                OkHttpServerTransport.this.m2386lambda$start$0$iogrpcokhttpOkHttpServerTransport(serializingExecutor);
            }
        });
    }
    ...
    public void m2386lambda$start$0$iogrpcokhttpOkHttpServerTransport(SerializingExecutor serializingExecutor) {
        try {
            ...
            if (this.config.maxConnectionAgeInNanos != Long.MAX_VALUE) {
                this.maxConnectionAgeMonitor = this.scheduledExecutorService.schedule(new LogExceptionRunnable(new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        OkHttpServerTransport.this.m2387lambda$startIo$1$iogrpcokhttpOkHttpServerTransport();
                    }
    ...
    /* synthetic */ void m2387lambda$startIo$1$iogrpcokhttpOkHttpServerTransport() {
    ...
    class FrameHandler implements FrameReader.Handler, Runnable {
                            ...
                            if (byteString3.size() != 0 && byteString3.getByte(0) == 47) {
                                ...
                                if (headerGetRequiredSingle != null) {
                                    ...
                                    if (GrpcUtil.isGrpcContentType(asciiString)) {
                                        ...
                                        respondWithHttpError(i, z2, HttpServletResponse.SC_METHOD_NOT_ALLOWED, Status.Code.INTERNAL, "HTTP Method is not supported: " + OkHttpServerTransport.asciiString(byteString));
                                        return;
                                    }
                                    respondWithHttpError(i, z2, HttpServletResponse.SC_UNSUPPORTED_MEDIA_TYPE, Status.Code.INTERNAL, "Content-Type is not supported: " + asciiString);
                                    return;
                                }
                                respondWithHttpError(i, z2, HttpServletResponse.SC_UNSUPPORTED_MEDIA_TYPE, Status.Code.INTERNAL, "Content-Type is missing or duplicated");
                                return;
                            }
                            respondWithHttpError(i, z2, HttpServletResponse.SC_NOT_FOUND, Status.Code.UNIMPLEMENTED, "Expected path to start with /: " + OkHttpServerTransport.asciiString(byteString3));
                            return;
                        }
        ...
        private void respondWithHttpError(int i, boolean z, int i2, Status.Code code, String str) {
            ...
            synchronized (OkHttpServerTransport.this.lock) {
                ...
                OkHttpServerTransport.this.outboundFlow.notifyWhenNoPendingData(http2ErrorStreamState.getOutboundFlowState(), new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$FrameHandler$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        OkHttpServerTransport.FrameHandler.this.m2388x6fc8eaa(http2ErrorStreamState);
                    }
                });
            }
        }
        ...
        public void m2388x6fc8eaa(Http2ErrorStreamState http2ErrorStreamState) {
            synchronized (OkHttpServerTransport.this.lock) {
