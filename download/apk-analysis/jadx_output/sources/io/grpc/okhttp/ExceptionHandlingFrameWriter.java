...
final class ExceptionHandlingFrameWriter implements FrameWriter {
    ...
    public void ping(boolean z, int i, int i2) {
        if (z) {
            this.frameLogger.logPingAck(OkHttpFrameLogger.Direction.OUTBOUND, (BodyPartID.bodyIdMax & i2) | (i << 32));
        } else {
            this.frameLogger.logPing(OkHttpFrameLogger.Direction.OUTBOUND, (BodyPartID.bodyIdMax & i2) | (i << 32));
        }
        try {
