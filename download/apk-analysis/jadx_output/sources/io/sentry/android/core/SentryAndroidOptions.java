...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion updateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), BuildConfig.SENTRY_ANDROID_SDK_NAME, "7.22.6");
        updateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "7.22.6");
