...
public final class ActivityFramesTracker {
        ...
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ActivityFramesTracker.this.m2472xd056273f(activity);
                }
    ...
    /* synthetic */ void m2472xd056273f(Activity activity) {
    ...
    public synchronized void setMetrics(final Activity activity, SentryId sentryId) {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m2474lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(activity);
                }
            }, null);
    ...
    /* synthetic */ void m2474lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(Activity activity) {
    ...
    public synchronized void stop() {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m2475lambda$stop$2$iosentryandroidcoreActivityFramesTracker();
                }
    ...
    /* synthetic */ void m2475lambda$stop$2$iosentryandroidcoreActivityFramesTracker() {
        ...
        try {
            if (AndroidMainThreadChecker.getInstance().isMainThread()) {
                ...
                this.handler.post(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityFramesTracker.this.m2473x49051cca(runnable, str);
                    }
                });
            }
    ...
    /* synthetic */ void m2473x49051cca(Runnable runnable, String str) {
        try {
            runnable.run();
        } catch (Throwable unused) {
            if (str != null) {
