...
public final class ScreenshotEventProcessor implements EventProcessor {
    ...
    public /* synthetic */ SentryReplayEvent process(SentryReplayEvent sentryReplayEvent, Hint hint) {
        return EventProcessor.CC.$default$process(this, sentryReplayEvent, hint);
    }
    ...
    public SentryEvent process(SentryEvent sentryEvent, Hint hint) {
        ...
        if (activity != null && !HintUtils.isFromHybridSdk(hint)) {
            ...
            final Bitmap captureScreenshot = ScreenshotUtils.captureScreenshot(activity, this.options.getMainThreadChecker(), this.options.getLogger(), this.buildInfoProvider);
            ...
            hint.setScreenshot(Attachment.fromByteProvider(new Callable() { // from class: io.sentry.android.core.ScreenshotEventProcessor$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return ScreenshotEventProcessor.this.m2495lambda$process$0$iosentryandroidcoreScreenshotEventProcessor(captureScreenshot);
                }
    ...
    /* synthetic */ byte[] m2495lambda$process$0$iosentryandroidcoreScreenshotEventProcessor(Bitmap bitmap) throws Exception {
