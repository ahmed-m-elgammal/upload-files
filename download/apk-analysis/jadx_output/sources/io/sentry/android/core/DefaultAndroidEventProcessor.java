    ...
    public DefaultAndroidEventProcessor(Context context, BuildInfoProvider buildInfoProvider, final SentryAndroidOptions sentryAndroidOptions) {
        ...
        this.deviceInfoUtil = newSingleThreadExecutor.submit(new Callable() { // from class: io.sentry.android.core.DefaultAndroidEventProcessor$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return DefaultAndroidEventProcessor.this.m2491lambda$new$0$iosentryandroidcoreDefaultAndroidEventProcessor(sentryAndroidOptions);
            }
        });
        newSingleThreadExecutor.shutdown();
    }

    /* renamed from: lambda$new$0$io-sentry-android-core-DefaultAndroidEventProcessor, reason: not valid java name */
    /* synthetic */ DeviceInfoUtil m2491lambda$new$0$iosentryandroidcoreDefaultAndroidEventProcessor(SentryAndroidOptions sentryAndroidOptions) throws Exception {
