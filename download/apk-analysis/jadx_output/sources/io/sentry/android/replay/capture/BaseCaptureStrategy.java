...
public abstract class BaseCaptureStrategy implements CaptureStrategy {
        ...
        this.recorderConfig = new ReadWriteProperty<Object, ScreenshotRecorderConfig>(obj, this, str, this) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$1
            ...
            private final void runInBackground(final Function0<Unit> task) {
                ...
                if (sentryOptions.getMainThreadChecker().isMainThread()) {
                    ...
                    ExecutorsKt.submitSafely(persistingExecutor, sentryOptions3, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$1.1
        ...
        this.segmentTimestamp = new ReadWriteProperty<Object, Date>(obj, this, str2, this) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$1
            ...
            private final void runInBackground(final Function0<Unit> task) {
                ...
                if (sentryOptions.getMainThreadChecker().isMainThread()) {
                    persistingExecutor = this.this$0$inline_fun.getPersistingExecutor();
                    sentryOptions3 = this.this$0$inline_fun.options;
                    ExecutorsKt.submitSafely(persistingExecutor, sentryOptions3, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$1.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Function0.this.invoke();
                        }
        ...
        this.screenAtStart = new ReadWriteProperty<Object, String>(obj2, this, str3, this, str3) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$2
            ...
            private final void runInBackground(final Function0<Unit> task) {
                ...
                if (sentryOptions.getMainThreadChecker().isMainThread()) {
                    persistingExecutor = this.this$0$inline_fun.getPersistingExecutor();
                    sentryOptions3 = this.this$0$inline_fun.options;
                    ExecutorsKt.submitSafely(persistingExecutor, sentryOptions3, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Function0.this.invoke();
                        }
        ...
        this.currentReplayId = new ReadWriteProperty<Object, SentryId>(sentryId, this, str4, this, str4) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$1
            ...
            private final void runInBackground(final Function0<Unit> task) {
                ...
                if (sentryOptions.getMainThreadChecker().isMainThread()) {
                    persistingExecutor = this.this$0$inline_fun.getPersistingExecutor();
                    sentryOptions3 = this.this$0$inline_fun.options;
                    ExecutorsKt.submitSafely(persistingExecutor, sentryOptions3, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$1.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Function0.this.invoke();
                        }
        ...
        this.currentSegment = new ReadWriteProperty<Object, Integer>(i, this, str5, this, str5) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$2
            ...
            private final void runInBackground(final Function0<Unit> task) {
                ...
                if (sentryOptions.getMainThreadChecker().isMainThread()) {
                    persistingExecutor = this.this$0$inline_fun.getPersistingExecutor();
                    sentryOptions3 = this.this$0$inline_fun.options;
                    ExecutorsKt.submitSafely(persistingExecutor, sentryOptions3, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Function0.this.invoke();
                        }
        ...
        this.replayType = new ReadWriteProperty<Object, SentryReplayEvent.ReplayType>(obj3, this, str6, this, str6) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$3
            ...
            private final void runInBackground(final Function0<Unit> task) {
                ...
                if (sentryOptions.getMainThreadChecker().isMainThread()) {
                    persistingExecutor = this.this$0$inline_fun.getPersistingExecutor();
                    sentryOptions3 = this.this$0$inline_fun.options;
                    ExecutorsKt.submitSafely(persistingExecutor, sentryOptions3, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$3.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Function0.this.invoke();
                        }
    ...
    protected final CaptureStrategy.ReplaySegment createSegmentInternal(long duration, Date currentSegmentTimestamp, SentryId replayId, int segmentId, int height, int width, SentryReplayEvent.ReplayType replayType, ReplayCache cache, int frameRate, int bitRate, String screenAtStart, List<Breadcrumb> breadcrumbs, Deque<RRWebEvent> events) {
        ...
        return CaptureStrategy.INSTANCE.createSegment(this.hub, this.options, duration, currentSegmentTimestamp, replayId, segmentId, height, width, replayType, cache, frameRate, bitRate, screenAtStart, breadcrumbs, events);
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        if (convert != null) {
            CollectionsKt.addAll(this.currentEvents, convert);
        }
    }
    ...
    static /* synthetic */ ReadWriteProperty persistableAtomicNullable$default(final BaseCaptureStrategy baseCaptureStrategy, Object obj, final String str, Function3 function3, int i, Object obj2) {
        if (obj2 != null) {
    ...
    static /* synthetic */ ReadWriteProperty persistableAtomic$default(final BaseCaptureStrategy baseCaptureStrategy, Object obj, final String str, Function3 function3, int i, Object obj2) {
        if (obj2 != null) {
