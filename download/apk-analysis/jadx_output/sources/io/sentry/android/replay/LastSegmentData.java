...
public final /* data */ class LastSegmentData {
    ...
    public int hashCode() {
        int hashCode = ((((((((((this.recorderConfig.hashCode() * 31) + this.cache.hashCode()) * 31) + this.timestamp.hashCode()) * 31) + this.id) * 31) + UByte$$ExternalSyntheticBackport0.m(this.duration)) * 31) + this.replayType.hashCode()) * 31;
