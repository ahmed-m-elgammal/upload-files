        ...
        */
        ...
        public final ViewHierarchyNode fromView(View view, ViewHierarchyNode parent, int distance, SentryOptions options) {
            ...
            if (view instanceof TextView) {
                ...
                return new TextViewHierarchyNode(layout != null ? new AndroidTextLayout(layout) : null, Integer.valueOf(ViewsKt.toOpaque(textView.getCurrentTextColor())), textView.getTotalPaddingLeft(), ViewsKt.getTotalPaddingTopSafe(textView), textView.getX(), textView.getY(), textView.getWidth(), textView.getHeight(), (parent != null ? parent.getElevation() : 0.0f) + textView.getElevation(), distance, parent, z, true, booleanValue, component2);
            }
            if (view instanceof ImageView) {
                ...
                return new ImageViewHierarchyNode(imageView.getX(), imageView.getY(), imageView.getWidth(), imageView.getHeight(), imageView.getElevation() + (parent != null ? parent.getElevation() : 0.0f), distance, parent, z && (drawable = imageView.getDrawable()) != null && ViewsKt.isMaskable(drawable), true, booleanValue, component2);
            }
