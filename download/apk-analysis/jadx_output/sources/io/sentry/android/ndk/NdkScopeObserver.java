...
public final class NdkScopeObserver extends ScopeObserverAdapter {
        ...
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.ndk.NdkScopeObserver$$ExternalSyntheticLambda5
                ...
                public final void run() {
                    NdkScopeObserver.this.m2519lambda$setUser$0$iosentryandroidndkNdkScopeObserver(user);
                }
            });
        } catch (Throwable th) {
    ...
    /* synthetic */ void m2519lambda$setUser$0$iosentryandroidndkNdkScopeObserver(User user) {
        if (user == null) {
    ...
    public void addBreadcrumb(final Breadcrumb breadcrumb) {
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.ndk.NdkScopeObserver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    NdkScopeObserver.this.m2514lambda$addBreadcrumb$1$iosentryandroidndkNdkScopeObserver(breadcrumb);
                }
            });
        } catch (Throwable th) {
    ...
    /* synthetic */ void m2514lambda$addBreadcrumb$1$iosentryandroidndkNdkScopeObserver(Breadcrumb breadcrumb) {
        String str = null;
    ...
    /* synthetic */ void m2518lambda$setTag$2$iosentryandroidndkNdkScopeObserver(String str, String str2) {
    ...
    public void setTag(final String str, final String str2) {
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.ndk.NdkScopeObserver$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    NdkScopeObserver.this.m2518lambda$setTag$2$iosentryandroidndkNdkScopeObserver(str, str2);
                }
            });
        } catch (Throwable th) {
    ...
    /* synthetic */ void m2516lambda$removeTag$3$iosentryandroidndkNdkScopeObserver(String str) {
    ...
    public void removeTag(final String str) {
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.ndk.NdkScopeObserver$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    NdkScopeObserver.this.m2516lambda$removeTag$3$iosentryandroidndkNdkScopeObserver(str);
                }
            });
        } catch (Throwable th) {
    ...
    /* synthetic */ void m2517lambda$setExtra$4$iosentryandroidndkNdkScopeObserver(String str, String str2) {
    ...
    public void setExtra(final String str, final String str2) {
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.ndk.NdkScopeObserver$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    NdkScopeObserver.this.m2517lambda$setExtra$4$iosentryandroidndkNdkScopeObserver(str, str2);
                }
            });
        } catch (Throwable th) {
    ...
    /* synthetic */ void m2515lambda$removeExtra$5$iosentryandroidndkNdkScopeObserver(String str) {
    ...
    public void removeExtra(final String str) {
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.ndk.NdkScopeObserver$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    NdkScopeObserver.this.m2515lambda$removeExtra$5$iosentryandroidndkNdkScopeObserver(str);
                }
            });
        } catch (Throwable th) {
