...
public final class ShutdownHookIntegration implements Integration, Closeable {
    ...
    public void register(final IHub iHub, final SentryOptions sentryOptions) {
        ...
        if (sentryOptions.isEnableShutdownHook()) {
            ...
            handleShutdownInProgress(new Runnable() { // from class: io.sentry.ShutdownHookIntegration$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ShutdownHookIntegration.this.m2469lambda$register$1$iosentryShutdownHookIntegration(sentryOptions);
                }
            });
        } else {
    ...
    /* synthetic */ void m2469lambda$register$1$iosentryShutdownHookIntegration(SentryOptions sentryOptions) {
    ...
    public void close() throws IOException {
        if (this.thread != null) {
            handleShutdownInProgress(new Runnable() { // from class: io.sentry.ShutdownHookIntegration$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ShutdownHookIntegration.this.m2468lambda$close$2$iosentryShutdownHookIntegration();
                }
            });
        }
    }
    ...
    /* synthetic */ void m2468lambda$close$2$iosentryShutdownHookIntegration() {
