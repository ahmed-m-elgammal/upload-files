...
public final class SentryClient implements ISentryClient, IMetricsClient {
    ...
    */
    public io.sentry.protocol.SentryId captureEvent(io.sentry.SentryEvent r14, io.sentry.IScope r15, io.sentry.Hint r16) {
        /*
            ...
            if (iScope != null) {
                return iScope.withSession(new Scope.IWithSession() { // from class: io.sentry.SentryClient$$ExternalSyntheticLambda1
                    ...
                    public final void accept(Session session) {
                        SentryClient.this.m2424lambda$updateSessionData$1$iosentrySentryClient(sentryEvent, hint, session);
                    }
                });
            }
    ...
    /* synthetic */ void m2424lambda$updateSessionData$1$iosentrySentryClient(SentryEvent sentryEvent, Hint hint, Session session) {
        if (session == null) {
    ...
    public SentryId captureTransaction(SentryTransaction sentryTransaction, TraceContext traceContext, IScope iScope, Hint hint, ProfilingTraceData profilingTraceData) {
        ...
        try {
            ...
            hint2.clear();
            return buildEnvelope != null ? sendEnvelope(buildEnvelope, hint2) : sentryId2;
