...
public final class Hub implements IHub, MetricsApi.IMetricsInterface {
            ...
            if (z) {
                executorService.submit(new Runnable() { // from class: io.sentry.Hub$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        Hub.this.m2415lambda$close$1$iosentryHub(executorService);
                    }
                });
            } else {
    ...
    /* synthetic */ void m2415lambda$close$1$iosentryHub(ISentryExecutorService iSentryExecutorService) {
    ...
    public void pushScope() {
        ...
        Stack.StackItem peek = this.stack.peek();
        this.stack.push(new Stack.StackItem(this.options, peek.getClient(), peek.getScope().m2420clone()));
    }
    ...
    private IScope buildLocalScope(IScope iScope, ScopeCallback scopeCallback) {
        if (scopeCallback != null) {
            try {
                IScope m2420clone = iScope.m2420clone();
                scopeCallback.run(m2420clone);
                return m2420clone;
            } catch (Throwable th) {
