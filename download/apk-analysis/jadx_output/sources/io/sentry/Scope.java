...
public final class Scope implements IScope {
    ...
    public Session withSession(IWithSession iWithSession) {
        ...
        synchronized (this.sessionLock) {
            ...
            m2467clone = this.session != null ? this.session.m2467clone() : null;
        }
        return m2467clone;
    }
    ...
    public SessionPair startSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m2467clone(), session != null ? session.m2467clone() : null);
            } else {
    ...
    public Session endSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.session != null) {
                this.session.end();
                Session m2467clone = this.session.m2467clone();
                this.session = null;
                session = m2467clone;
            }
        }
