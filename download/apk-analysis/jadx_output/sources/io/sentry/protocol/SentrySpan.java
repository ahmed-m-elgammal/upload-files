        ...
        public SentrySpan deserialize(ObjectReader objectReader, ILogger iLogger) throws Exception {
            ...
            while (true) {
                ...
                if (objectReader.peek() != JsonToken.NAME) {
                    ...
                    SentrySpan sentrySpan = new SentrySpan(d, d2, sentryId, spanId, spanId3, str, str5, spanStatus2, str4, hashMap, hashMap2, map3, map4);
                ...
                switch (nextName) {
                    ...
                    case "_metrics_summary":
                        map3 = objectReader.nextMapOfListOrNull(iLogger, new MetricSummary.Deserializer());
                        str3 = str4;
                        spanStatus = spanStatus2;
                        str2 = str5;
                        spanId2 = spanId3;
