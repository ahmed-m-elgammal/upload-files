...
public abstract class GenericPortlet implements Portlet, PortletConfig, EventPortlet, ResourceServingPortlet, HeaderPortlet {
    ...
    public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws PortletException, IOException {
        ...
        if (initParameter == null || !initParameter.equalsIgnoreCase(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE) || resourceRequest.getResourceID() == null || (requestDispatcher = getPortletConfig().getPortletContext().getRequestDispatcher(resourceRequest.getResourceID())) == null) {
            return;
        }
