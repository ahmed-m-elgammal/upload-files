...
public interface HttpServletResponse extends ServletResponse {
    ...
    /* renamed from: javax.servlet.http.HttpServletResponse$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static Supplier $default$getTrailerFields(HttpServletResponse _this) {
            return null;
        }

        public static void $default$setTrailerFields(HttpServletResponse _this, Supplier supplier) {
        }
    }
