...
public interface TimeMark {
    ...
    TimeMark mo3900minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo3902plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m4047plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m4046minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo3902plusLRDsOJo(Duration.m3962unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m3942isNegativeimpl(timeMark.mo3899elapsedNowUwyO8pc());
        }
