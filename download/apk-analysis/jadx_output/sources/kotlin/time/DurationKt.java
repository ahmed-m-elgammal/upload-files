...
public final class DurationKt {
    ...
    private static final long m4036timesmvk6XK0(int i, long j) {
        return Duration.m3947timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m4035timeskIfJnKk(double d, long j) {
        return Duration.m3946timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m4012getZEROUwyO8pc = Duration.INSTANCE.m4012getZEROUwyO8pc();
        ...
        if (str.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str.charAt(i2) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m3945plusLRDsOJo = Duration.m3945plusLRDsOJo(m4012getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m4012getZEROUwyO8pc = Duration.m3945plusLRDsOJo(m3945plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m4012getZEROUwyO8pc = Duration.m3945plusLRDsOJo(m4012getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    obj2 = obj;
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m4012getZEROUwyO8pc = Duration.INSTANCE.m4010getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m3945plusLRDsOJo2 = Duration.m3945plusLRDsOJo(m4012getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m4012getZEROUwyO8pc = Duration.m3945plusLRDsOJo(m3945plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m4012getZEROUwyO8pc = Duration.m3945plusLRDsOJo(m4012getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m3962unaryMinusUwyO8pc(m4012getZEROUwyO8pc) : m4012getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m3909constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m3909constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m3909constructorimpl((j << 1) + i);
    }
