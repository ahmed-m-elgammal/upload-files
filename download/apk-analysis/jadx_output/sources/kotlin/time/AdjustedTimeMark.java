...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo3900minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m4046minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo3899elapsedNowUwyO8pc() {
        return Duration.m3944minusLRDsOJo(this.mark.mo3899elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo3902plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m3945plusLRDsOJo(this.adjustment, duration), null);
    }
}
