...
final class ExceptionsCollector {
    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                SentryWrapper$$ExternalSyntheticApiModelOutline0.m2457m();
                initCause = SentryWrapper$$ExternalSyntheticApiModelOutline0.m2442m(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(initCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = SentryWrapper$$ExternalSyntheticApiModelOutline0.m2441m((Object) initCause);
            }
