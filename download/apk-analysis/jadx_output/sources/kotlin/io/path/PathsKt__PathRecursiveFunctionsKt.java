        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(Z$$ExternalSyntheticApiModelOutline0.m(obj2), Z$$ExternalSyntheticApiModelOutline0.m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, Z$$ExternalSyntheticApiModelOutline0.m((Object) path2), Z$$ExternalSyntheticApiModelOutline0.m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, Z$$ExternalSyntheticApiModelOutline0.m((Object) path3), Z$$ExternalSyntheticApiModelOutline0.m((Object) path4));
                }
    ...
    */
    public static final java.nio.file.Path copyToRecursively(final java.nio.file.Path r7, final java.nio.file.Path r8, final kotlin.jvm.functions.Function3<? super java.nio.file.Path, ? super java.nio.file.Path, ? super java.lang.Exception, ? extends kotlin.io.path.OnErrorResult> r9, boolean r10, final kotlin.jvm.functions.Function3<? super kotlin.io.path.CopyActionContext, ? super java.nio.file.Path, ? super java.nio.file.Path, ? extends kotlin.io.path.CopyActionResult> r11) {
        /*
            ...
            java.lang.Object[] r0 = java.util.Arrays.copyOf(r0, r1)
            java.nio.file.LinkOption[] r0 = (java.nio.file.LinkOption[]) r0
            boolean r0 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r7, r0)
            if (r0 == 0) goto Ld4
            r0 = 0
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r1 = (java.nio.file.LinkOption[]) r1
            boolean r1 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r7, r1)
            if (r1 == 0) goto Lc3
            if (r10 != 0) goto L45
            boolean r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m4229m(r7)
            if (r1 != 0) goto Lc3
        L45:
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r1 = (java.nio.file.LinkOption[]) r1
            boolean r1 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r8, r1)
            r2 = 1
            if (r1 == 0) goto L5c
            boolean r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m4229m(r8)
            if (r1 != 0) goto L5c
            r1 = r2
            goto L5d
        L5c:
        ...
        L5d:
            if (r1 == 0) goto L65
            boolean r3 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m2460m(r7, r8)
            if (r3 != 0) goto Lc3
        L65:
            java.nio.file.FileSystem r3 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m2440m(r7)
            java.nio.file.FileSystem r4 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m2440m(r8)
        ...
        L74:
            if (r1 == 0) goto L87
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m(r8, r1)
            java.nio.file.LinkOption[] r0 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r0 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m(r7, r0)
            boolean r0 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m2466m$1(r1, r0)
            goto Lae
        L87:
            java.nio.file.Path r1 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r8)
            if (r1 == 0) goto Lae
            ...
            boolean r3 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r1, r3)
            if (r3 == 0) goto Lae
            java.nio.file.LinkOption[] r3 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m(r1, r3)
            java.nio.file.LinkOption[] r3 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r3 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m(r7, r3)
            boolean r1 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m2466m$1(r1, r3)
            if (r1 == 0) goto Lae
            r0 = r2
        Lae:
            if (r0 != 0) goto Lb1
            goto Lc3
        Lb1:
            io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m2457m()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = r8.toString()
            java.lang.String r9 = "Recursively copying a directory into its subdirectory is prohibited."
            java.nio.file.FileSystemException r7 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m(r7, r8, r9)
            throw r7
        Lc3:
            ...
            return r8
        Ld4:
            okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m4225m()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = r8.toString()
            java.lang.String r9 = "The source file doesn't exist."
            java.nio.file.NoSuchFileException r7 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m4206m(r7, r8, r9)
            throw r7
        */
    ...
    public static final void deleteRecursively(Path path) {
        ...
        FileSystemException m2442m = SentryWrapper$$ExternalSyntheticApiModelOutline0.m2442m("Failed to delete one or more files. See suppressed exceptions for details.");
        Iterator<T> it = deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.iterator();
        while (it.hasNext()) {
            ExceptionsKt.addSuppressed(m2442m, (Exception) it.next());
        }
        throw m2442m;
    }
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) {
        ...
        if (parent != null) {
            ...
            if (directoryStream != null) {
                ...
                try {
                    DirectoryStream m = SentryWrapper$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream2);
                    if (SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(m)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream m4209m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m4209m((Object) m);
                        fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(m4209m, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream m4209m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m4209m((Object) secureDirectoryStream3);
            it = m4209m.iterator();
            while (it.hasNext()) {
                fileName = Z$$ExternalSyntheticApiModelOutline0.m(it.next()).getFileName();
                Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                handleEntry$PathsKt__PathRecursiveFunctionsKt(m4209m, fileName, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        ...
        boolean isDirectory;
        try {
            fileAttributeView = secureDirectoryStream.getFileAttributeView(path, SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
            readAttributes = SentryWrapper$$ExternalSyntheticApiModelOutline0.m2451m((Object) fileAttributeView).readAttributes();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        DirectoryStream directoryStream2 = directoryStream;
        try {
            it = SentryWrapper$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream2).iterator();
            while (it.hasNext()) {
                Path m = Z$$ExternalSyntheticApiModelOutline0.m(it.next());
                Intrinsics.checkNotNull(m);
                insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(m, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
            CloseableKt.closeFinally(directoryStream2, null);
        } finally {
