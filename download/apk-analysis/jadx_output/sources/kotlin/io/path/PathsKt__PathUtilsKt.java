...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream m = SentryWrapper$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        fileAttributeView = Files.getFileAttributeView(path, Headers$Builder$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        if (fileAttributeView != null) {
            return (V) Headers$Builder$$ExternalSyntheticApiModelOutline0.m4213m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        PathsKt.fileAttributeViewNotAvailable(path, Headers$Builder$$ExternalSyntheticApiModelOutline0.m());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        readAttributes = Files.readAttributes(path, (Class<BasicFileAttributes>) SentryWrapper$$ExternalSyntheticApiModelOutline0.m2435m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(readAttributes, "readAttributes(...)");
        return (A) Headers$Builder$$ExternalSyntheticApiModelOutline0.m4212m((Object) readAttributes);
    }
