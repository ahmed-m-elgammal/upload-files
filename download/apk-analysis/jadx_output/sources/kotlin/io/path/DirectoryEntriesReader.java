...
final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public final List<PathNode> readEntries(PathNode directoryNode) {
        ...
        Files.walkFileTree(directoryNode.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, SentryWrapper$$ExternalSyntheticApiModelOutline0.m2447m((Object) this));
