...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (mo3847getDeclarationDescriptor != null) {
            return getFunctionTypeKind(mo3847getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo3847getDeclarationDescriptor = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        return mo3847getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo3847getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo3842findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo3842findAnnotation = kotlinType.getAnnotations().mo3842findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (mo3842findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(mo3842findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo3842findAnnotation = kotlinType.getAnnotations().mo3842findAnnotation(StandardNames.FqNames.parameterName);
        if (mo3842findAnnotation == null) {
            return null;
        }
