...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public abstract ClassDescriptor mo3847getDeclarationDescriptor();
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo3847getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    protected boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo3847getDeclarationDescriptor(), classifierDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo3847getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo3840getCompanionObjectDescriptor = classDescriptor.mo3840getCompanionObjectDescriptor();
        if (z && mo3840getCompanionObjectDescriptor != null) {
            smartList.add(mo3840getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    protected KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo3847getDeclarationDescriptor())) {
            return null;
        }
