...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ClassifierDescriptor mo3847getDeclarationDescriptor = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        if (mo3847getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(mo3847getDeclarationDescriptor);
                return;
            }
            for (KotlinType upperBound : ((TypeParameterDescriptor) mo3847getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNullExpressionValue(upperBound, "upperBound");
                extractTypeParametersFromUpperBounds(upperBound, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor mo3847getDeclarationDescriptor2 = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo3847getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo3847getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo3847getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor mo3847getDeclarationDescriptor = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo3847getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo3847getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters(KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$containsTypeAliasParameters$1
            ...
            public final Boolean invoke(UnwrappedType it) {
                ...
                ClassifierDescriptor mo3847getDeclarationDescriptor = it.getConstructor().mo3847getDeclarationDescriptor();
                return Boolean.valueOf(mo3847getDeclarationDescriptor != null ? TypeUtilsKt.isTypeAliasParameter(mo3847getDeclarationDescriptor) : false);
            }
        });
    }
    ...
    public static final boolean requiresTypeAliasExpansion(KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$requiresTypeAliasExpansion$1
            ...
            public final Boolean invoke(UnwrappedType it) {
                ...
                ClassifierDescriptor mo3847getDeclarationDescriptor = it.getConstructor().mo3847getDeclarationDescriptor();
                boolean z = false;
                if (mo3847getDeclarationDescriptor != null && ((mo3847getDeclarationDescriptor instanceof TypeAliasDescriptor) || (mo3847getDeclarationDescriptor instanceof TypeParameterDescriptor))) {
                    z = true;
                }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor mo3847getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo3847getDeclarationDescriptor();
            ClassDescriptor classDescriptor = mo3847getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo3847getDeclarationDescriptor : null;
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo3847getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo3847getDeclarationDescriptor() != null) {
            ...
            if (!simpleType2.getConstructor().getParameters().isEmpty() && simpleType2.getConstructor().mo3847getDeclarationDescriptor() != null) {
