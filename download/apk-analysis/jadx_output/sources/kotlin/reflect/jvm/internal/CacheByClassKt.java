...
public final class CacheByClassKt {
    ...
    static {
        ...
        try {
            ...
            m2566constructorimpl = Result.m2566constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m2566constructorimpl = Result.m2566constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m2573isSuccessimpl(m2566constructorimpl)) {
            Result.Companion companion3 = Result.INSTANCE;
            m2566constructorimpl = true;
        }
        Object m2566constructorimpl2 = Result.m2566constructorimpl(m2566constructorimpl);
        if (Result.m2572isFailureimpl(m2566constructorimpl2)) {
            m2566constructorimpl2 = false;
        }
        useClassValue = ((Boolean) m2566constructorimpl2).booleanValue();
    }
