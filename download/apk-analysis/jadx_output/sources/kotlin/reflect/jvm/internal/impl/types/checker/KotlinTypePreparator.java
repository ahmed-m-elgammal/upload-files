    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo3848getSupertypes = capturedTypeConstructorImpl.mo3848getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3848getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo3848getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo3848getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3848getSupertypes2, 10));
            Iterator<T> it2 = mo3848getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo3848getSupertypes3 = intersectionTypeConstructor2.mo3848getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3848getSupertypes3, 10));
        Iterator<T> it3 = mo3848getSupertypes3.iterator();
        while (it3.hasNext()) {
