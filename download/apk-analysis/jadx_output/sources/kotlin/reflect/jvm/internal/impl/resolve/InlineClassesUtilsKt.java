...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (mo3847getDeclarationDescriptor != null) {
            return isInlineClass(mo3847getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo3847getDeclarationDescriptor = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        if (mo3847getDeclarationDescriptor != null) {
            return isValueClass(mo3847getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo3847getDeclarationDescriptor = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        return (mo3847getDeclarationDescriptor == null || !isMultiFieldValueClass(mo3847getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
