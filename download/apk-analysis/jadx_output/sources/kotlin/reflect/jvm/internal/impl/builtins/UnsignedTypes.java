...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ClassifierDescriptor mo3847getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (mo3847getDeclarationDescriptor = type.getConstructor().mo3847getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(mo3847getDeclarationDescriptor);
    }
