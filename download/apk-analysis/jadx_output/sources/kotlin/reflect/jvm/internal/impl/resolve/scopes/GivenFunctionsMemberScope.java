...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> mo3848getSupertypes = this.containingClass.getTypeConstructor().mo3848getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo3848getSupertypes, "containingClass.typeConstructor.supertypes");
