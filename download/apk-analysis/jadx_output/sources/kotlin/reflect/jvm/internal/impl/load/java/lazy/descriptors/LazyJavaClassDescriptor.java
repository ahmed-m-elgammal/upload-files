...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor mo3847getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo3847getDeclarationDescriptor();
    ...
    private final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo3847getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo3847getDeclarationDescriptor = mo3847getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo3847getDeclarationDescriptor, arrayList5);
            }
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo3842findAnnotation = annotations.mo3842findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (mo3842findAnnotation == null) {
                return null;
            }
            Object singleOrNull = CollectionsKt.singleOrNull(mo3842findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo3847getDeclarationDescriptor() {
