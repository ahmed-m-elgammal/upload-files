        ...
        public Data() {
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo3848getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo3848getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo3848getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(mo3848getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo3848getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo3847getDeclarationDescriptor = KotlinType.this.getConstructor().mo3847getDeclarationDescriptor();
                                if (!(mo3847getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + mo3847getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo3847getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo3847getDeclarationDescriptor);
                                }
                                ...
                                if (indexOf < 0) {
                                    throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo3847getDeclarationDescriptor);
                                }
