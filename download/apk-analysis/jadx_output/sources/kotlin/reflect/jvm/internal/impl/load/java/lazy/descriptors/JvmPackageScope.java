...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo3849getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo3849getContributedClassifier = this.javaScope.mo3849getContributedClassifier(name, location);
        if (mo3849getContributedClassifier != null) {
            return mo3849getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo3849getContributedClassifier(name, location);
