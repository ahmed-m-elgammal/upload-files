...
public final class RawSubstitution extends TypeSubstitution {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.TypeSubstitution
    /* renamed from: get */
    public TypeProjectionImpl mo3852get(KotlinType key) {
    ...
    private final KotlinType eraseType(KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (mo3847getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return eraseType(this.typeParameterUpperBoundEraser.getErasedUpperBound((TypeParameterDescriptor) mo3847getDeclarationDescriptor, javaTypeAttributes.markIsRaw(true)), javaTypeAttributes);
        }
        if (mo3847getDeclarationDescriptor instanceof ClassDescriptor) {
            ClassifierDescriptor mo3847getDeclarationDescriptor2 = FlexibleTypesKt.upperIfFlexible(kotlinType).getConstructor().mo3847getDeclarationDescriptor();
            if (!(mo3847getDeclarationDescriptor2 instanceof ClassDescriptor)) {
                throw new IllegalStateException(("For some reason declaration for upper bound is not a class but \"" + mo3847getDeclarationDescriptor2 + "\" while for lower it's \"" + mo3847getDeclarationDescriptor + Typography.quote).toString());
            }
            Pair<SimpleType, Boolean> eraseInflexibleBasedOnClassDescriptor = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.lowerIfFlexible(kotlinType), (ClassDescriptor) mo3847getDeclarationDescriptor, lowerTypeAttr);
            ...
            Pair<SimpleType, Boolean> eraseInflexibleBasedOnClassDescriptor2 = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.upperIfFlexible(kotlinType), (ClassDescriptor) mo3847getDeclarationDescriptor2, upperTypeAttr);
        ...
        throw new IllegalStateException(("Unexpected declaration kind: " + mo3847getDeclarationDescriptor).toString());
    }
