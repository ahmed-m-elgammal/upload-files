...
public abstract class AbstractSignatureParts<TAnnotation> {
    ...
    private final JavaTypeQualifiers extractQualifiersFromAnnotations(final TypeAndDefaultQualifiers typeAndDefaultQualifiers) {
        ...
        if (extractNullability != null) {
            return new JavaTypeQualifiers(extractNullability.getQualifier(), extractMutability, extractNullability.getQualifier() == NullabilityQualifier.NOT_NULL && typeParameterClassifier != null, extractNullability.isForWarningOnly());
        }
        if (z || z2) {
        ...
        boolean z3 = (boundsNullability != null ? boundsNullability.getQualifier() : null) == NullabilityQualifier.NOT_NULL || !(typeParameterClassifier == null || javaDefaultQualifiers == null || !javaDefaultQualifiers.getDefinitelyNotNull());
        ...
        return new JavaTypeQualifiers(mostSpecific != null ? mostSpecific.getQualifier() : null, extractMutability, z3, mostSpecific != null && mostSpecific.isForWarningOnly());
    }
