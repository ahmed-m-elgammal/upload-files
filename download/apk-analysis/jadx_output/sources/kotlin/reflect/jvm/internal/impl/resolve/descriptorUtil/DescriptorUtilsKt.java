...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = memberScope.mo3849getContributedClassifier(shortName, location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo3848getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ClassifierDescriptor mo3847getDeclarationDescriptor = kotlinType.getConstructor().mo3847getDeclarationDescriptor();
                if (DescriptorUtils.isClassOrEnumClass(mo3847getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor mo3847getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo3847getDeclarationDescriptor();
