...
public final class BuiltinSpecialProperties {
    ...
    static {
        ...
        Map<FqName, Name> mapOf = MapsKt.mapOf(TuplesKt.to(childSafe, Name.identifier("name")), TuplesKt.to(childSafe2, Name.identifier("ordinal")), TuplesKt.to(child, Name.identifier(RRWebVideoEvent.JsonKeys.SIZE)), TuplesKt.to(child2, Name.identifier(RRWebVideoEvent.JsonKeys.SIZE)), TuplesKt.to(childSafe3, Name.identifier("length")), TuplesKt.to(child3, Name.identifier("keySet")), TuplesKt.to(child4, Name.identifier("values")), TuplesKt.to(child5, Name.identifier("entrySet")));
