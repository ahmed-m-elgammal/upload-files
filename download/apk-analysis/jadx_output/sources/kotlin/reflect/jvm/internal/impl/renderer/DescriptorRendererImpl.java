...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor mo3847getDeclarationDescriptor = typeConstructor.mo3847getDeclarationDescriptor();
        if (mo3847getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo3847getDeclarationDescriptor instanceof ClassDescriptor ? true : mo3847getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(mo3847getDeclarationDescriptor);
        }
        if (mo3847getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo3847getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo3847getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor mo3841getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo3841getUnsubstitutedPrimaryConstructor = annotationClass.mo3841getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo3841getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ...
        if (!getIncludePropertyConstant() || (mo3843getCompileTimeInitializer = variableDescriptor.mo3843getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(mo3843getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo3841getUnsubstitutedPrimaryConstructor = classDescriptor.mo3841getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo3841getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo3841getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo3841getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, mo3841getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> mo3848getSupertypes = classDescriptor.getTypeConstructor().mo3848getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo3848getSupertypes, "klass.typeConstructor.supertypes");
        if (mo3848getSupertypes.isEmpty()) {
            return;
        }
        if (mo3848getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo3848getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo3848getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            {
                super(1);
            }
