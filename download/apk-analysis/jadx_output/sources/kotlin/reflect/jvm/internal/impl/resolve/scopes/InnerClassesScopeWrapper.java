...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo3849getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = this.workerScope.mo3849getContributedClassifier(name, location);
    ...
    public void mo3853recordLookup(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo3853recordLookup(name, location);
    }
