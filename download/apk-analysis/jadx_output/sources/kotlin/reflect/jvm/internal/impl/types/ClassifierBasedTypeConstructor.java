...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo3847getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor mo3847getDeclarationDescriptor = mo3847getDeclarationDescriptor();
        if (hasMeaningfulFqName(mo3847getDeclarationDescriptor)) {
            identityHashCode = DescriptorUtils.getFqName(mo3847getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor mo3847getDeclarationDescriptor = mo3847getDeclarationDescriptor();
        ClassifierDescriptor mo3847getDeclarationDescriptor2 = typeConstructor.mo3847getDeclarationDescriptor();
        if (mo3847getDeclarationDescriptor2 != null && hasMeaningfulFqName(mo3847getDeclarationDescriptor) && hasMeaningfulFqName(mo3847getDeclarationDescriptor2)) {
            return isSameClassifier(mo3847getDeclarationDescriptor2);
        }
        return false;
    }
