...
public final class TypeParameterUpperBoundEraser {
    ...
    private final Set<KotlinType> substituteErasedUpperBounds(TypeSubstitutor typeSubstitutor, List<? extends KotlinType> list, ErasureTypeAttributes erasureTypeAttributes) {
        ...
        for (KotlinType kotlinType : list) {
            ...
            } else if (mo3847getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                Set<TypeParameterDescriptor> visitedTypeParameters = erasureTypeAttributes.getVisitedTypeParameters();
                if (visitedTypeParameters != null && visitedTypeParameters.contains(mo3847getDeclarationDescriptor)) {
                    createSetBuilder.add(getDefaultType(erasureTypeAttributes));
                } else {
                    List<KotlinType> upperBounds = ((TypeParameterDescriptor) mo3847getDeclarationDescriptor).getUpperBounds();
                ...
                if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo3847getDeclarationDescriptor() != null) {
                    ...
                    for (TypeParameterDescriptor typeParameterDescriptor : list) {
                        ...
                        if (starProjectionImpl != null && !z2) {
                            ...
                            if (substitution.mo3852get(type4) != null) {
                                arrayList.add(starProjectionImpl);
                            }
                        }
                ...
                if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo3847getDeclarationDescriptor() != null) {
                    ...
                    for (TypeParameterDescriptor typeParameterDescriptor2 : list2) {
                        ...
                        if (starProjectionImpl2 != null && !z3) {
                            ...
                            if (substitution2.mo3852get(type5) != null) {
                                arrayList2.add(starProjectionImpl2);
                            }
                        }
                ...
                if (!simpleType2.getConstructor().getParameters().isEmpty() && simpleType2.getConstructor().mo3847getDeclarationDescriptor() != null) {
                    ...
                    for (TypeParameterDescriptor typeParameterDescriptor3 : list3) {
                        ...
                        if (starProjectionImpl3 != null && !z4) {
                            ...
                            if (substitution3.mo3852get(type6) != null) {
                                arrayList3.add(starProjectionImpl3);
                            }
                        }
