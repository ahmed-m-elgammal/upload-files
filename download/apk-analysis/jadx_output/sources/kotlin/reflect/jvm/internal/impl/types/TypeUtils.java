...
public class TypeUtils {
    ...
    */
    ...
    public static List<KotlinType> getImmediateSupertypes(KotlinType kotlinType) {
        ...
        Collection<KotlinType> mo3848getSupertypes = kotlinType.getConstructor().mo3848getSupertypes();
        ArrayList arrayList = new ArrayList(mo3848getSupertypes.size());
        Iterator<KotlinType> it = mo3848getSupertypes.iterator();
        while (it.hasNext()) {
    ...
    public static boolean isNullableType(KotlinType kotlinType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = constructor.mo3848getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static boolean hasNullableSuperType(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo3847getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static ClassDescriptor getClassDescriptor(KotlinType kotlinType) {
        ...
        if (mo3847getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) mo3847getDeclarationDescriptor;
        }
        return null;
    }
    ...
    private static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = ((IntersectionTypeConstructor) constructor).mo3848getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo3847getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo3847getDeclarationDescriptor();
        }
        return null;
    }
}
