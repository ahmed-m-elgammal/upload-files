...
public final class MemberDeserializer {
    ...
    public final PropertyDescriptor loadProperty(final ProtoBuf.Property proto) {
        ...
        for (Object obj : contextReceiverTypes) {
            ...
            arrayList.add(toContextReceiver((ProtoBuf.Type) obj, childContext$default, deserializedPropertyDescriptor, i));
            i = i2;
        }
        ...
        deserializedPropertyDescriptor.initialize(propertyGetterDescriptorImpl2, propertySetterDescriptorImpl, new FieldDescriptorImpl(getPropertyFieldAnnotations(proto, z), deserializedPropertyDescriptor2), new FieldDescriptorImpl(getPropertyFieldAnnotations(proto, true), deserializedPropertyDescriptor2));
