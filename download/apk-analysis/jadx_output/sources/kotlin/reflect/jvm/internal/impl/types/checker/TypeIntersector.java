    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> mo3848getSupertypes = simpleType.getConstructor().mo3848getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo3848getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = mo3848getSupertypes;
