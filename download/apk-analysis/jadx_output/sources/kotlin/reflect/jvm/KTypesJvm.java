    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo3847getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo3847getDeclarationDescriptor();
                classDescriptor = mo3847getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo3847getDeclarationDescriptor : null;
