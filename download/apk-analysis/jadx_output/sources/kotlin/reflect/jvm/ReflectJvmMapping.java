...
public final class ReflectJvmMapping {
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Object mo3839getMember = (asKCallableImpl == null || (caller = asKCallableImpl.getCaller()) == null) ? null : caller.mo3839getMember();
        if (mo3839getMember instanceof Method) {
            return (Method) mo3839getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> asKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Object mo3839getMember = (asKCallableImpl == null || (caller = asKCallableImpl.getCaller()) == null) ? null : caller.mo3839getMember();
        if (mo3839getMember instanceof Constructor) {
            return (Constructor) mo3839getMember;
        }
        return null;
    }
