...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m3775getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m2741constructorimpl = ((int) ULong.m2741constructorimpl(j ^ ULong.m2741constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m2741constructorimpl2 = (m2741constructorimpl + ((int) ULong.m2741constructorimpl(j2 ^ ULong.m2741constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m2741constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m2787toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m2787toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m3801fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
