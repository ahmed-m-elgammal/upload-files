...
public final class UStringsKt {
    ...
    public static final String m3896toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m3898toStringolVBNx4(short s, int i) {
    ...
    public static final String m3897toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m3895toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m2662constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m2578boximpl(UByte.m2584constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m2662constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m2842boximpl(UShort.m2848constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m2662constructorimpl = UInt.m2662constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m$1(-1, m2662constructorimpl);
            ...
            int m2662constructorimpl2 = UInt.m2662constructorimpl(i3 * m2662constructorimpl);
            int m2662constructorimpl3 = UInt.m2662constructorimpl(UInt.m2662constructorimpl(digitOf) + m2662constructorimpl2);
            compare2 = Integer.compare(m2662constructorimpl3 ^ Integer.MIN_VALUE, m2662constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m2662constructorimpl3;
        }
        return UInt.m2656boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m2741constructorimpl = ULong.m2741constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m2741constructorimpl);
            ...
            long m2741constructorimpl2 = ULong.m2741constructorimpl(j * m2741constructorimpl);
            long m2741constructorimpl3 = ULong.m2741constructorimpl(ULong.m2741constructorimpl(UInt.m2662constructorimpl(r13) & BodyPartID.bodyIdMax) + m2741constructorimpl2);
            compare2 = Long.compare(m2741constructorimpl3 ^ Long.MIN_VALUE, m2741constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m2741constructorimpl3;
        }
        return ULong.m2735boximpl(j);
    }
}
