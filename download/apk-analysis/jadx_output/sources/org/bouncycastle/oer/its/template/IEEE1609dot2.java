...
public class IEEE1609dot2 {
    ...
    static {
        ...
        OERDefinition.Builder extension = OERDefinition.extension();
        OERDefinition.Builder builder2 = Ieee1609Dot2BaseTypes.HashedId8;
        OERDefinition.Builder label8 = OERDefinition.choice(builder2, Ieee1609Dot2BaseTypes.HashAlgorithm, extension, builder2).label("IssuerIdentifier");
