...
public class AESEngine implements BlockCipher {
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        for (int i9 = 1; i7 > i9; i9 = 1) {
            ...
            int shift7 = (((iArr3[shift3 & 255] ^ shift(iArr3[(shift2 >> 8) & 255], 24)) ^ shift(iArr3[(shift >> 16) & 255], 16)) ^ shift(iArr3[(i11 >> 24) & 255], 8)) ^ iArr[i10][2];
            i7 -= 2;
        ...
        int[] iArr4 = Tinv0;
        int shift8 = (((iArr4[i4 & 255] ^ shift(iArr4[(i8 >> 8) & 255], 24)) ^ shift(iArr4[(i6 >> 16) & 255], 16)) ^ shift(iArr4[(i5 >> 24) & 255], 8)) ^ iArr[i7][0];
        int shift9 = (((iArr4[i5 & 255] ^ shift(iArr4[(i4 >> 8) & 255], 24)) ^ shift(iArr4[(i8 >> 16) & 255], 16)) ^ shift(iArr4[(i6 >> 24) & 255], 8)) ^ iArr[i7][1];
        int shift10 = (((iArr4[i6 & 255] ^ shift(iArr4[(i5 >> 8) & 255], 24)) ^ shift(iArr4[(i4 >> 16) & 255], 16)) ^ shift(iArr4[(i8 >> 24) & 255], 8)) ^ iArr[i7][2];
        int shift11 = (((iArr4[i8 & 255] ^ shift(iArr4[(i6 >> 8) & 255], 24)) ^ shift(iArr4[(i5 >> 16) & 255], 16)) ^ shift(iArr4[(i4 >> 24) & 255], 8)) ^ iArr[i7][3];
        byte[] bArr3 = Si;
        int i12 = bArr3[shift8 & 255] & 255;
        byte[] bArr4 = this.s;
        int i13 = ((i12 ^ ((bArr4[(shift11 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(shift10 >> 16) & 255] & 255) << 16)) ^ (bArr3[(shift9 >> 24) & 255] << Ascii.CAN);
        int[] iArr5 = iArr[0];
        int i14 = i13 ^ iArr5[0];
        int i15 = ((((bArr4[shift9 & 255] & 255) ^ ((bArr4[(shift8 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(shift11 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift10 >> 24) & 255] << Ascii.CAN)) ^ iArr5[1];
        int i16 = ((((bArr4[shift10 & 255] & 255) ^ ((bArr3[(shift9 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(shift8 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift11 >> 24) & 255] << Ascii.CAN)) ^ iArr5[2];
        int i17 = ((((bArr3[shift11 & 255] & 255) ^ ((bArr4[(shift10 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(shift9 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift8 >> 24) & 255] << Ascii.CAN)) ^ iArr5[3];
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        for (int i8 = 1; i7 < this.ROUNDS - i8; i8 = 1) {
            ...
            int shift7 = (((iArr3[shift3 & 255] ^ shift(iArr3[(i10 >> 8) & 255], 24)) ^ shift(iArr3[(shift >> 16) & 255], 16)) ^ shift(iArr3[(shift2 >> 24) & 255], 8)) ^ iArr[i9][2];
            i7 += 2;
        ...
        int[] iArr4 = T0;
        int shift8 = (((iArr4[i3 & 255] ^ shift(iArr4[(i4 >> 8) & 255], 24)) ^ shift(iArr4[(i5 >> 16) & 255], 16)) ^ shift(iArr4[(i6 >> 24) & 255], 8)) ^ iArr[i7][0];
        int shift9 = (((iArr4[i4 & 255] ^ shift(iArr4[(i5 >> 8) & 255], 24)) ^ shift(iArr4[(i6 >> 16) & 255], 16)) ^ shift(iArr4[(i3 >> 24) & 255], 8)) ^ iArr[i7][1];
        int shift10 = (((iArr4[i5 & 255] ^ shift(iArr4[(i6 >> 8) & 255], 24)) ^ shift(iArr4[(i3 >> 16) & 255], 16)) ^ shift(iArr4[(i4 >> 24) & 255], 8)) ^ iArr[i7][2];
        int shift11 = (((iArr4[i6 & 255] ^ shift(iArr4[(i3 >> 8) & 255], 24)) ^ shift(iArr4[(i4 >> 16) & 255], 16)) ^ shift(iArr4[(i5 >> 24) & 255], 8)) ^ iArr[i7][3];
        byte[] bArr3 = S;
        int i11 = (bArr3[shift8 & 255] & 255) ^ ((bArr3[(shift9 >> 8) & 255] & 255) << 8);
        byte[] bArr4 = this.s;
        int i12 = (i11 ^ ((bArr4[(shift10 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift11 >> 24) & 255] << Ascii.CAN);
        int[] iArr5 = iArr[i7 + 1];
        int i13 = i12 ^ iArr5[0];
        int i14 = ((((bArr4[shift9 & 255] & 255) ^ ((bArr3[(shift10 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(shift11 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift8 >> 24) & 255] << Ascii.CAN)) ^ iArr5[1];
        int i15 = ((((bArr4[shift10 & 255] & 255) ^ ((bArr3[(shift11 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(shift8 >> 16) & 255] & 255) << 16)) ^ (bArr3[(shift9 >> 24) & 255] << Ascii.CAN)) ^ iArr5[2];
        int i16 = ((((bArr4[shift11 & 255] & 255) ^ ((bArr4[(shift8 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(shift9 >> 16) & 255] & 255) << 16)) ^ (bArr3[(shift10 >> 24) & 255] << Ascii.CAN)) ^ iArr5[3];
