...
public class SRP6Client {
    ...
    private BigInteger calculateS() {
        ...
        return this.B.subtract(this.g.modPow(this.x, this.N).multiply(calculateK).mod(this.N)).mod(this.N).modPow(this.u.multiply(this.x).add(this.f230a), this.N);
    }
