...
public class Functions {
    ...
    public static void tryWithResources(FailableRunnable<? extends Throwable> failableRunnable, FailableConsumer<Throwable, ? extends Throwable> failableConsumer, FailableRunnable<? extends Throwable>... failableRunnableArr) {
        if (failableConsumer == null) {
            failableConsumer = new FailableConsumer() { // from class: org.apache.commons.lang3.Functions$$ExternalSyntheticLambda2
    ...
    public static RuntimeException rethrow(Throwable th) {
        ...
        if (th instanceof IOException) {
            Headers$Builder$$ExternalSyntheticApiModelOutline0.m4237m$1();
            throw Headers$Builder$$ExternalSyntheticApiModelOutline0.m((IOException) th);
        }
