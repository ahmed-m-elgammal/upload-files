...
public final class SingleInstanceFactory<T> extends InstanceFactory<T> {
    ...
    public T get(final InstanceContext context) {
        Intrinsics.checkNotNullParameter(context, "context");
        KoinPlatformTools.INSTANCE.m4379synchronized(this, new Function0<Unit>(this) { // from class: org.koin.core.instance.SingleInstanceFactory$get$1
