...
import org.bouncycastle.jce.provider.OcspCache$$ExternalSyntheticApiModelOutline2;

/* loaded from: classes7.dex */
public enum I18nConversionCategory {
    UNUSED(null, null),
    GENERAL(null, null),
    DATE(new Class[]{Date.class, Number.class}, new String[]{DateProp.name, "time"}),
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner m = OcspCache$$ExternalSyntheticApiModelOutline2.m(", ", " conversion category (one of: ", ")");
