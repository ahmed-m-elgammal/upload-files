...
public final class CameraX {
    ...
    private ListenableFuture<Void> initInternal(final Context context) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda2
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return CameraX.this.m162lambda$initInternal$0$androidxcameracoreCameraX(context, completer);
                }
            });
        }
        return future;
    ...
    /* synthetic */ Object m162lambda$initInternal$0$androidxcameracoreCameraX(Context context, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final int i, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda1
            ...
            public final void run() {
                CameraX.this.m161lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(context, executor, completer, j, i);
            }
        });
    }

    /* renamed from: lambda$initAndRetryRecursively$2$androidx-camera-core-CameraX, reason: not valid java name */
    /* synthetic */ void m161lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(Context context, final Executor executor, final CallbackToFutureAdapter.Completer completer, final long j, final int i) {
        ...
        try {
            ...
            RetryPolicy.RetryConfig onRetryDecisionRequested = this.mRetryPolicy.onRetryDecisionRequested(new CameraProviderExecutionState(j, i, e));
            if (onRetryDecisionRequested.shouldRetry() && i < Integer.MAX_VALUE) {
                ...
                HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        CameraX.this.m160lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(executor, j, i, applicationContext, completer);
                    }
    ...
    /* synthetic */ void m160lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(Executor executor, long j, int i, Context context, CallbackToFutureAdapter.Completer completer) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            if (ordinal == 2 || ordinal == 3) {
                ...
                this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda4
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return CameraX.this.m164lambda$shutdownInternal$4$androidxcameracoreCameraX(completer);
                    }
                });
            }
    ...
    /* synthetic */ Object m164lambda$shutdownInternal$4$androidxcameracoreCameraX(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraRepository.deinit().addListener(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                CameraX.this.m163lambda$shutdownInternal$3$androidxcameracoreCameraX(completer);
            }
    ...
    /* synthetic */ void m163lambda$shutdownInternal$3$androidxcameracoreCameraX(CallbackToFutureAdapter.Completer completer) {
