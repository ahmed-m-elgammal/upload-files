...
public class InternalImageProcessor {
        ...
        try {
            return (ImageProcessor.Response) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.InternalImageProcessor$$ExternalSyntheticLambda1
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return InternalImageProcessor.this.m223xe9947096(request, completer);
                }
            }).get();
        } catch (Exception e) {
    ...
    /* synthetic */ Object m223xe9947096(final ImageProcessor.Request request, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.InternalImageProcessor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                InternalImageProcessor.this.m222xe85e1db7(request, completer);
            }
        });
    ...
    /* synthetic */ void m222xe85e1db7(ImageProcessor.Request request, CallbackToFutureAdapter.Completer completer) {
        try {
