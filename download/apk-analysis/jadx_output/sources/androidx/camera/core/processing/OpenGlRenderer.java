...
public final class OpenGlRenderer {
    ...
    public static abstract class GraphicDeviceInfo {
        ...
        static abstract class Builder {
            ...
            abstract Builder setEglExtensions(String str);

            abstract Builder setEglVersion(String str);

            abstract Builder setGlExtensions(String str);

            abstract Builder setGlVersion(String str);
