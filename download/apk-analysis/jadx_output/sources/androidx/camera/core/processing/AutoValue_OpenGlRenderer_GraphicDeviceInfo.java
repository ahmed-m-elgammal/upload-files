...
final class AutoValue_OpenGlRenderer_GraphicDeviceInfo extends OpenGlRenderer.GraphicDeviceInfo {
    ...
    @Override // androidx.camera.core.processing.OpenGlRenderer.GraphicDeviceInfo
    ...
    static final class Builder extends OpenGlRenderer.GraphicDeviceInfo.Builder {
        ...
        @Override // androidx.camera.core.processing.OpenGlRenderer.GraphicDeviceInfo.Builder
        OpenGlRenderer.GraphicDeviceInfo.Builder setGlVersion(String str) {
            if (str == null) {
        ...
        @Override // androidx.camera.core.processing.OpenGlRenderer.GraphicDeviceInfo.Builder
        OpenGlRenderer.GraphicDeviceInfo.Builder setEglVersion(String str) {
            if (str == null) {
        ...
        @Override // androidx.camera.core.processing.OpenGlRenderer.GraphicDeviceInfo.Builder
        OpenGlRenderer.GraphicDeviceInfo.Builder setGlExtensions(String str) {
            if (str == null) {
        ...
        @Override // androidx.camera.core.processing.OpenGlRenderer.GraphicDeviceInfo.Builder
        OpenGlRenderer.GraphicDeviceInfo.Builder setEglExtensions(String str) {
            if (str == null) {
        ...
        @Override // androidx.camera.core.processing.OpenGlRenderer.GraphicDeviceInfo.Builder
        OpenGlRenderer.GraphicDeviceInfo build() {
            String str;
