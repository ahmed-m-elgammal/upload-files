...
public abstract class DeferrableSurface {
    ...
    public DeferrableSurface(Size size, int i) {
        ...
        ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return DeferrableSurface.this.m202lambda$new$0$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda1
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return DeferrableSurface.this.m203lambda$new$1$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        if (Logger.isDebugEnabled(TAG)) {
            ...
            future.addListener(new Runnable() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    DeferrableSurface.this.m204lambda$new$2$androidxcameracoreimplDeferrableSurface(stackTraceString);
                }
    ...
    /* synthetic */ Object m202lambda$new$0$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    /* synthetic */ Object m203lambda$new$1$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
    ...
    /* synthetic */ void m204lambda$new$2$androidxcameracoreimplDeferrableSurface(String str) {
        try {
