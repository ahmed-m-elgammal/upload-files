...
public final class CameraStateRegistry implements CameraCoordinator.ConcurrentCameraModeListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:15:0x0072 A[Catch: all -> 0x009c, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x001d, B:7:0x0053, B:9:0x0057, B:13:0x006a, B:15:0x0072, B:18:0x007f, B:21:0x0097, B:22:0x009a, B:26:0x0064), top: B:3:0x0003 }] */
    /* JADX WARN: Removed duplicated region for block: B:21:0x0097 A[Catch: all -> 0x009c, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x001d, B:7:0x0053, B:9:0x0057, B:13:0x006a, B:15:0x0072, B:18:0x007f, B:21:0x0097, B:22:0x009a, B:26:0x0064), top: B:3:0x0003 }] */
    /*
    ...
    */
    public boolean tryOpenCamera(androidx.camera.core.Camera r12) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<androidx.camera.core.Camera, androidx.camera.core.impl.CameraStateRegistry$CameraRegistration> r1 = r11.mCameraStates     // Catch: java.lang.Throwable -> L9c
            java.lang.Object r1 = r1.get(r12)     // Catch: java.lang.Throwable -> L9c
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r1 = (androidx.camera.core.impl.CameraStateRegistry.CameraRegistration) r1     // Catch: java.lang.Throwable -> L9c
            java.lang.String r2 = "Camera must first be registered with registerCamera()"
            java.lang.Object r1 = androidx.core.util.Preconditions.checkNotNull(r1, r2)     // Catch: java.lang.Throwable -> L9c
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r1 = (androidx.camera.core.impl.CameraStateRegistry.CameraRegistration) r1     // Catch: java.lang.Throwable -> L9c
            java.lang.String r2 = "CameraStateRegistry"
            boolean r2 = androidx.camera.core.Logger.isDebugEnabled(r2)     // Catch: java.lang.Throwable -> L9c
            r3 = 1
            r4 = 0
            if (r2 == 0) goto L53
            java.lang.StringBuilder r2 = r11.mDebugString     // Catch: java.lang.Throwable -> L9c
            ...
            int r7 = r11.mAvailableCameras     // Catch: java.lang.Throwable -> L9c
            java.lang.Integer r7 = java.lang.Integer.valueOf(r7)     // Catch: java.lang.Throwable -> L9c
            androidx.camera.core.impl.CameraInternal$State r8 = r1.getState()     // Catch: java.lang.Throwable -> L9c
            boolean r8 = isOpen(r8)     // Catch: java.lang.Throwable -> L9c
            java.lang.Boolean r8 = java.lang.Boolean.valueOf(r8)     // Catch: java.lang.Throwable -> L9c
            androidx.camera.core.impl.CameraInternal$State r9 = r1.getState()     // Catch: java.lang.Throwable -> L9c
            r10 = 4
            java.lang.Object[] r10 = new java.lang.Object[r10]     // Catch: java.lang.Throwable -> L9c
            r10[r4] = r12     // Catch: java.lang.Throwable -> L9c
            r10[r3] = r7     // Catch: java.lang.Throwable -> L9c
            r12 = 2
            r10[r12] = r8     // Catch: java.lang.Throwable -> L9c
            r12 = 3
            r10[r12] = r9     // Catch: java.lang.Throwable -> L9c
            java.lang.String r12 = java.lang.String.format(r5, r6, r10)     // Catch: java.lang.Throwable -> L9c
            r2.append(r12)     // Catch: java.lang.Throwable -> L9c
        L53:
            int r12 = r11.mAvailableCameras     // Catch: java.lang.Throwable -> L9c
            if (r12 > 0) goto L64
            androidx.camera.core.impl.CameraInternal$State r12 = r1.getState()     // Catch: java.lang.Throwable -> L9c
            boolean r12 = isOpen(r12)     // Catch: java.lang.Throwable -> L9c
            if (r12 == 0) goto L62
            goto L64
        L62:
            r12 = r4
            goto L6a
        L64:
            androidx.camera.core.impl.CameraInternal$State r12 = androidx.camera.core.impl.CameraInternal.State.OPENING     // Catch: java.lang.Throwable -> L9c
            r1.setState(r12)     // Catch: java.lang.Throwable -> L9c
            r12 = r3
        L6a:
            java.lang.String r1 = "CameraStateRegistry"
            boolean r1 = androidx.camera.core.Logger.isDebugEnabled(r1)     // Catch: java.lang.Throwable -> L9c
            if (r1 == 0) goto L95
            java.lang.StringBuilder r1 = r11.mDebugString     // Catch: java.lang.Throwable -> L9c
        ...
        L7f:
            ...
            androidx.camera.core.Logger.d(r1, r2)     // Catch: java.lang.Throwable -> L9c
        L95:
            if (r12 == 0) goto L9a
            r11.recalculateAvailableCameras()     // Catch: java.lang.Throwable -> L9c
        L9a:
    ...
    */
    public boolean tryOpenCaptureSession(java.lang.String r5, java.lang.String r6) {
        /*
            ...
            monitor-enter(r0)
            androidx.camera.core.concurrent.CameraCoordinator r1 = r4.mCameraCoordinator     // Catch: java.lang.Throwable -> L61
            int r1 = r1.getCameraOperatingMode()     // Catch: java.lang.Throwable -> L61
            r2 = 2
            r3 = 1
            if (r1 == r2) goto Lf
            ...
            return r3
        Lf:
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r1 = r4.getCameraRegistration(r5)     // Catch: java.lang.Throwable -> L61
            r2 = 0
            if (r1 == 0) goto L1f
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r5 = r4.getCameraRegistration(r5)     // Catch: java.lang.Throwable -> L61
            androidx.camera.core.impl.CameraInternal$State r5 = r5.getState()     // Catch: java.lang.Throwable -> L61
            goto L20
        L1f:
            r5 = r2
        L20:
            if (r6 == 0) goto L30
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r1 = r4.getCameraRegistration(r6)     // Catch: java.lang.Throwable -> L61
            if (r1 == 0) goto L30
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r6 = r4.getCameraRegistration(r6)     // Catch: java.lang.Throwable -> L61
            androidx.camera.core.impl.CameraInternal$State r2 = r6.getState()     // Catch: java.lang.Throwable -> L61
        L30:
            androidx.camera.core.impl.CameraInternal$State r6 = androidx.camera.core.impl.CameraInternal.State.OPEN     // Catch: java.lang.Throwable -> L61
            boolean r6 = r6.equals(r5)     // Catch: java.lang.Throwable -> L61
            r1 = 0
            if (r6 != 0) goto L44
            androidx.camera.core.impl.CameraInternal$State r6 = androidx.camera.core.impl.CameraInternal.State.CONFIGURED     // Catch: java.lang.Throwable -> L61
