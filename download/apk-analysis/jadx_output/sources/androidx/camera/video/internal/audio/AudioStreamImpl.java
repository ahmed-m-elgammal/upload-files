    ...
    */
    ...
    class AudioRecordingApi29Callback extends AudioManager$AudioRecordingCallback {
        ...
        public void onRecordingConfigChanged(List<AudioRecordingConfiguration> list) {
            ...
            while (it.hasNext()) {
                AudioRecordingConfiguration m16m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m16m((Object) it.next());
                if (Api24Impl.getClientAudioSessionId(m16m) == AudioStreamImpl.this.mAudioRecord.getAudioSessionId()) {
                    AudioStreamImpl.this.notifySilenced(Api29Impl.isClientSilenced(m16m));
                    return;
                }
            }
        }
