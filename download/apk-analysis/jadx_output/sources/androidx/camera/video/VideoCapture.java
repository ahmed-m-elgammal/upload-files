...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    static {
        ...
        boolean z = true;
        boolean z2 = DeviceQuirks.get(ExtraSupportedResolutionQuirk.class) != null;
        if (!hasVideoQualityQuirkAndWorkaroundBySurfaceProcessing && !z2) {
            z = false;
        }
    ...
    private SessionConfig.Builder createPipeline(final String str, final VideoCaptureConfig<T> videoCaptureConfig, final StreamSpec streamSpec) {
        ...
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m262lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig, resolveTimebase);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m263lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda6
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                VideoCapture.this.m264lambda$createPipeline$3$androidxcameravideoVideoCapture(str, videoCaptureConfig, streamSpec, sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m263lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    /* synthetic */ void m264lambda$createPipeline$3$androidxcameravideoVideoCapture(String str, VideoCaptureConfig videoCaptureConfig, StreamSpec streamSpec, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
    ...
    public void m262lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    private static boolean shouldEnableSurfaceProcessingByQuirk(CameraInternal cameraInternal) {
        return cameraInternal.getHasTransform() && (sEnableSurfaceProcessingByQuirk || SurfaceProcessingQuirk.CC.workaroundBySurfaceProcessing(cameraInternal.getCameraInfoInternal().getCameraQuirks()));
    }
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda2
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return VideoCapture.this.m265xc7537f7(builder, completer);
            }
        });
    ...
    /* synthetic */ Object m265xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i, CameraCaptureResult cameraCaptureResult) {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.AnonymousClass2.this.m266lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }

        /* renamed from: lambda$onCaptureCompleted$0$androidx-camera-video-VideoCapture$2, reason: not valid java name */
        /* synthetic */ void m266lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
