...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, final PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        this.mSurfaceView.post(new Runnable() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceViewImplementation.this.m326x6305943b(surfaceRequest, onSurfaceNotInUseListener);
            }
        });
    }

    /* renamed from: lambda$onSurfaceRequested$0$androidx-camera-view-SurfaceViewImplementation, reason: not valid java name */
    /* synthetic */ void m326x6305943b(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
    ...
    private static class Api24Impl {
        ...
        static void pixelCopyRequest(SurfaceView surfaceView, Bitmap bitmap, PixelCopy$OnPixelCopyFinishedListener pixelCopy$OnPixelCopyFinishedListener, Handler handler) {
