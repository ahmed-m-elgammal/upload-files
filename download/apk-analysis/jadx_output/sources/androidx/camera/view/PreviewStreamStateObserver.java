...
final class PreviewStreamStateObserver implements Observable.Observer<CameraInternal.State> {
    ...
    private void startPreviewStreamStateFlow(final CameraInfo cameraInfo) {
        ...
        FutureChain transform = FutureChain.from(waitForCaptureResult(cameraInfo, arrayList)).transformAsync(new AsyncFunction() { // from class: androidx.camera.view.PreviewStreamStateObserver$$ExternalSyntheticLambda1
            ...
            public final ListenableFuture apply(Object obj) {
                return PreviewStreamStateObserver.this.m318xafb6b767((Void) obj);
            }
            ...
            public final Object apply(Object obj) {
                return PreviewStreamStateObserver.this.m319xaf405168((Void) obj);
            }
    ...
    /* synthetic */ ListenableFuture m318xafb6b767(Void r1) throws Exception {
    ...
    /* synthetic */ Void m319xaf405168(Void r1) {
    ...
    private ListenableFuture<Void> waitForCaptureResult(final CameraInfo cameraInfo, final List<CameraCaptureCallback> list) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.PreviewStreamStateObserver$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return PreviewStreamStateObserver.this.m320xb52cbf9(cameraInfo, list, completer);
            }
        });
    }

    /* renamed from: lambda$waitForCaptureResult$2$androidx-camera-view-PreviewStreamStateObserver, reason: not valid java name */
    /* synthetic */ Object m320xb52cbf9(final CameraInfo cameraInfo, List list, final CallbackToFutureAdapter.Completer completer) throws Exception {
