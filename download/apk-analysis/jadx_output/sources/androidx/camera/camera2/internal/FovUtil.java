...
public class FovUtil {
    ...
    public static int focalLengthToViewAngleDegrees(float f, float f2) {
        ...
        Preconditions.checkArgumentInRange(degrees, 0, CropImageOptions.DEGREES_360, "The provided focal length and sensor length result in an invalid view angle degrees.");
        return degrees;
    }
