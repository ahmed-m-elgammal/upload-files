...
public final class OutputConfigurationCompat {
    ...
    public static OutputConfigurationCompat wrap(Object obj) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            wrap = OutputConfigurationCompatApi33Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m(obj));
        } else if (Build.VERSION.SDK_INT >= 28) {
            wrap = OutputConfigurationCompatApi28Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m(obj));
        } else if (Build.VERSION.SDK_INT >= 26) {
            wrap = OutputConfigurationCompatApi26Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m(obj));
        } else {
            wrap = Build.VERSION.SDK_INT >= 24 ? OutputConfigurationCompatApi24Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m(obj)) : null;
        }
        if (wrap == null) {
            return null;
        }
