...
final class SupportedSurfaceCombination {
    ...
    Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecifications(int i, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map, boolean z) {
        HashMap hashMap;
        HashMap hashMap2;
        HashMap hashMap3;
        Range<Integer> range;
        ...
        while (true) {
            ...
            int i11 = i2;
            boolean z4 = range == null || i11 <= i8 || i8 >= range.getLower().intValue();
            if (z2 || !checkSupported(createFeatureSettings, list10)) {
                i3 = i10;
            ...
            if (list3 == null || z3 || getOrderedSupportedStreamUseCaseSurfaceConfigList(createFeatureSettings, list10) == null) {
                i5 = i9;
            } else {
                i5 = i9;
                if (i5 == i4 || i5 < i8) {
