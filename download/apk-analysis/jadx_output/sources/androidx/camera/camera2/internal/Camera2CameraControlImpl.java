...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    public void clearInteropConfig() {
        this.mCamera2CameraControl.clearCaptureRequestOptions().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private ListenableFuture<Void> waitForSessionUpdateId(final long j) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda4
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraControlImpl.this.m48xf5e6a45(j, completer);
            }
        });
    }
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(final List<CaptureConfig> list, final int i, final int i2) {
        ...
        return FutureChain.from(Futures.nonCancellationPropagating(this.mFlashModeChangeSessionUpdateFuture)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda1
            ...
            public final ListenableFuture apply(Object obj) {
                return Camera2CameraControlImpl.this.m45xc07d4a5a(list, i, flashMode, i2, (Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    public ListenableFuture<Void> updateSessionConfigAsync() {
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda6
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraControlImpl.this.m47x56c0128f(completer);
            }
        }));
    }
    ...
    /* synthetic */ Object m47x56c0128f(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m46x460a45ce(completer);
            }
        });
        return "updateSessionConfigAsync";
    }

    /* renamed from: lambda$updateSessionConfigAsync$5$androidx-camera-camera2-internal-Camera2CameraControlImpl, reason: not valid java name */
    /* synthetic */ void m46x460a45ce(CallbackToFutureAdapter.Completer completer) {
    ...
    void addSessionCameraCaptureCallback(final Executor executor, final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m43x380d74ba(executor, cameraCaptureCallback);
            }
        });
    }

    /* renamed from: lambda$addSessionCameraCaptureCallback$7$androidx-camera-camera2-internal-Camera2CameraControlImpl, reason: not valid java name */
    /* synthetic */ void m43x380d74ba(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    void removeSessionCameraCaptureCallback(final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m44xbfd34038(cameraCaptureCallback);
            }
        });
    }

    /* renamed from: lambda$removeSessionCameraCaptureCallback$8$androidx-camera-camera2-internal-Camera2CameraControlImpl, reason: not valid java name */
    /* synthetic */ void m44xbfd34038(CameraCaptureCallback cameraCaptureCallback) {
    ...
    static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureCompleted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, final TotalCaptureResult totalCaptureResult) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$CameraControlSessionCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraControlImpl.CameraControlSessionCallback.this.m49xf57ef947(totalCaptureResult);
                }
            });
        }
