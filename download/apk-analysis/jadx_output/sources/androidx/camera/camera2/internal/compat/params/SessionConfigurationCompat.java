...
public final class SessionConfigurationCompat {
    ...
    static List<OutputConfigurationCompat> transformToCompat(List<OutputConfiguration> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(OutputConfigurationCompat.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m((Object) it.next())));
        }
        return arrayList;
    }
    ...
    public static List<OutputConfiguration> transformFromCompat(List<OutputConfigurationCompat> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m(it.next().unwrap()));
        }
        return arrayList;
    }
