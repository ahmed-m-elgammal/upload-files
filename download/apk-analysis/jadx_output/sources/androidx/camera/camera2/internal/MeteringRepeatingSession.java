...
class MeteringRepeatingSession {
    ...
    SessionConfig createSessionConfig() {
        ...
        createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.camera2.internal.MeteringRepeatingSession$$ExternalSyntheticLambda0
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                MeteringRepeatingSession.this.m106x1b0a2abb(sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m106x1b0a2abb(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        this.mSessionConfig = createSessionConfig();
