...
class SynchronizedCaptureSessionImpl extends SynchronizedCaptureSessionBaseImpl {
        ...
        synchronized (this.mObjectLock) {
            ...
            nonCancellationPropagating = Futures.nonCancellationPropagating(FutureChain.from(successfulAsList).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda2
                ...
                public final ListenableFuture apply(Object obj) {
                    return SynchronizedCaptureSessionImpl.this.m118xe055f2f(cameraDevice, sessionConfigurationCompat, list, (List) obj);
                }
            }, getExecutor()));
        }
    ...
    /* synthetic */ ListenableFuture m118xe055f2f(CameraDevice cameraDevice, SessionConfigurationCompat sessionConfigurationCompat, List list, List list2) throws Exception {
    ...
    public void onConfigured(SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        this.mForceCloseSessionQuirk.onSessionConfigured(synchronizedCaptureSession, this.mCaptureSessionRepository.getCreatingCaptureSessions(), this.mCaptureSessionRepository.getCaptureSessions(), new ForceCloseCaptureSession.OnConfigured() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda0
            ...
            public final void run(SynchronizedCaptureSession synchronizedCaptureSession2) {
                SynchronizedCaptureSessionImpl.this.m117xa3e3cc53(synchronizedCaptureSession2);
            }
        });
    }
    ...
    /* synthetic */ void m117xa3e3cc53(SynchronizedCaptureSession synchronizedCaptureSession) {
