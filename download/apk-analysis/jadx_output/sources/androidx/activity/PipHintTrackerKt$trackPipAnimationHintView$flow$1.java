        ...
        if (i == 0) {
            ...
            final ?? r3 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public void onViewAttachedToWindow(View v) {
                    ...
                    producerScope2.mo4085trySendJP2dKIU(trackPipAnimationHintView$positionInWindow2);
            ...
            if (this.$view.isAttachedToWindow()) {
                ...
                producerScope.mo4085trySendJP2dKIU(trackPipAnimationHintView$positionInWindow);
