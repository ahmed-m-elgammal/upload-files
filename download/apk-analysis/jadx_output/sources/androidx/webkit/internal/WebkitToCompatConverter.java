...
public class WebkitToCompatConverter {
    ...
    public ServiceWorkerWebSettings convertServiceWorkerSettings(InvocationHandler invocationHandler) {
        return WebViewCompat$$ExternalSyntheticApiModelOutline0.m873m(this.mImpl.convertServiceWorkerSettings(invocationHandler));
    }
    ...
    public SafeBrowsingResponse convertSafeBrowsingResponse(InvocationHandler invocationHandler) {
        return WebViewCompat$$ExternalSyntheticApiModelOutline0.m871m(this.mImpl.convertSafeBrowsingResponse(invocationHandler));
    }
