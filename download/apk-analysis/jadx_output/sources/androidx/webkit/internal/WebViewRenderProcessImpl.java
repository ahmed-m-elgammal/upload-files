...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (webViewFeatureInternal.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess m879m = WebViewCompat$$ExternalSyntheticApiModelOutline0.m879m((Object) this.mFrameworkObject.get());
            if (m879m == null) {
                return false;
            }
            terminate = m879m.terminate();
            return terminate;
        }
