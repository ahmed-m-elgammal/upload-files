...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    public static final class Factory implements HttpDataSource.Factory {
        ...
        public Factory(HttpEngine httpEngine, Executor executor) {
            this.httpEngine = AudioFocusManager$$ExternalSyntheticApiModelOutline0.m499m(Assertions.checkNotNull(httpEngine));
    ...
    public long open(DataSpec dataSpec) throws HttpDataSource.HttpDataSourceException {
        ...
        try {
            ...
            try {
                ...
                UrlResponseInfo m501m = AudioFocusManager$$ExternalSyntheticApiModelOutline0.m501m(Assertions.checkNotNull(this.responseInfo));
                httpStatusCode = m501m.getHttpStatusCode();
                headers = m501m.getHeaders();
                asMap = headers.getAsMap();
                long j = 0;
                if (httpStatusCode < 200 || httpStatusCode > 299) {
                    ...
                    httpStatusText = m501m.getHttpStatusText();
    ...
    private final class UrlRequestCallback implements UrlRequest$Callback {
        ...
        public synchronized void onFailed(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, HttpException httpException) {
            ...
            if (AudioFocusManager$$ExternalSyntheticApiModelOutline0.m505m((Object) httpException)) {
                errorCode = AudioFocusManager$$ExternalSyntheticApiModelOutline0.m500m((Object) httpException).getErrorCode();
                if (errorCode == 1) {
