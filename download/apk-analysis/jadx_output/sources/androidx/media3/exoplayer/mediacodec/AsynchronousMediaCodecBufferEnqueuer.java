...
class AsynchronousMediaCodecBufferEnqueuer implements MediaCodecBufferEnqueuer {
    ...
    public void setParameters(Bundle bundle) {
        maybeThrowException();
        ((Handler) Util.castNonNull(this.handler)).obtainMessage(3, bundle).sendToTarget();
    }
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            CanvasUtils$$ExternalSyntheticApiModelOutline0.m852m();
            cryptoInfo2.setPattern(AudioFocusManager$$ExternalSyntheticApiModelOutline0.m(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
