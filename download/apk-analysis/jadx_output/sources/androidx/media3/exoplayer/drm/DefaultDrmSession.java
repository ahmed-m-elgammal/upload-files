...
class DefaultDrmSession implements DrmSession {
    ...
    @org.checkerframework.checker.nullness.qual.EnsuresNonNullIf(expression = {com.microsoft.clarity.reactnative.ClarityEmitter.CLARITY_SESSION_ID_PARAMETER}, result = true)
    /*
    ...
    */
    ...
    @RequiresNonNull({ClarityEmitter.CLARITY_SESSION_ID_PARAMETER})
    ...
    @RequiresNonNull({ClarityEmitter.CLARITY_SESSION_ID_PARAMETER, "offlineLicenseKeySetId"})
    ...
    @EnsuresNonNullIf(expression = {ClarityEmitter.CLARITY_SESSION_ID_PARAMETER}, result = true)
