...
public final class ExoPlaybackException extends PlaybackException {
    ...
    public static final Bundleable.Creator<ExoPlaybackException> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.exoplayer.ExoPlaybackException$$ExternalSyntheticLambda0
        ...
        public final Bundleable fromBundle(Bundle bundle) {
            return ExoPlaybackException.m508$r8$lambda$jTIqJuGnIWSRQFd3O6cFsUL6Xg(bundle);
        }
    };
    ...
    public static /* synthetic */ ExoPlaybackException m508$r8$lambda$jTIqJuGnIWSRQFd3O6cFsUL6Xg(Bundle bundle) {
