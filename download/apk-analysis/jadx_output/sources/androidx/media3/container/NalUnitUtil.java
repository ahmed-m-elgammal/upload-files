...
public final class NalUnitUtil {
    ...
    */
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        int i12 = readUnsignedExpGolombCodedInt4;
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            for (int i16 = 0; i16 < readUnsignedExpGolombCodedInt12; i16++) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    parsableNalUnitBitArray.skipBits(8);
                    i17 = ColorInfo.isoColorPrimariesToColorSpace(readBits8);
        ...
        return new H265SpsData(readBits2, readBit, readBits3, i7, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt9, readUnsignedExpGolombCodedInt10, iArr, readBits4, readUnsignedExpGolombCodedInt, i13, i14, f, i3, i4, i5);
    }
