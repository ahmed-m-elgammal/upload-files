...
final class PlayerControlViewLayoutManager {
    ...
    public PlayerControlViewLayoutManager(final PlayerControlView playerControlView) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m827lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m828lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda6
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m829lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda7
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m830lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m827lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m828lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(floatValue);
    ...
    /* synthetic */ void m829lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m830lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
