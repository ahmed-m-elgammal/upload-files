...
class PlayerInfo implements Bundleable {
    ...
    public static PlayerInfo fromBundle(Bundle bundle) {
        ...
        if (bundle15 == null) {
            fromBundle8 = TrackSelectionParameters.DEFAULT_WITHOUT_CONTEXT;
        } else {
            fromBundle8 = TrackSelectionParameters.fromBundle(bundle15);
        }
        return new PlayerInfo(fromBundle9, i, sessionPositionInfo, positionInfo, positionInfo2, i2, playbackParameters, i3, z, fromBundle11, fromBundle10, i4, mediaMetadata, f, audioAttributes, fromBundle12, fromBundle13, i5, z2, z3, i6, i7, i8, z4, z5, mediaMetadata2, j, j2, j3, fromBundle14, fromBundle8);
    }
