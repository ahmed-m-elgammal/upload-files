...
class MediaControllerImplLegacy implements MediaController.MediaControllerImpl {
    ...
    public MediaControllerImplLegacy(Context context, MediaController mediaController, SessionToken sessionToken, Looper looper, androidx.media3.common.util.BitmapLoader bitmapLoader) {
        this.listeners = new ListenerSet<>(looper, Clock.DEFAULT, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda11
            @Override // androidx.media3.common.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                MediaControllerImplLegacy.this.m715lambda$new$0$androidxmedia3sessionMediaControllerImplLegacy((Player.Listener) obj, flagSet);
            }
        });
    ...
    /* synthetic */ void m715lambda$new$0$androidxmedia3sessionMediaControllerImplLegacy(Player.Listener listener, FlagSet flagSet) {
    ...
    public void stop() {
        ...
        updateStateMaskedControllerInfo(new ControllerInfo(copyWithSessionPositionInfo, this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
    ...
    */
    ...
    public void setPlaybackParameters(PlaybackParameters playbackParameters) {
        if (!playbackParameters.equals(getPlaybackParameters())) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithPlaybackParameters(playbackParameters), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void setPlaybackSpeed(float f) {
        if (f != getPlaybackParameters().speed) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithPlaybackParameters(new PlaybackParameters(f)), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void setRepeatMode(int i) {
        if (i != getRepeatMode()) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithRepeatMode(i), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void setShuffleModeEnabled(boolean z) {
        if (z != getShuffleModeEnabled()) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithShuffleModeEnabled(z), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void setDeviceVolume(int i, int i2) {
        ...
        if (i3 <= i && (i4 == 0 || i <= i4)) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithDeviceVolume(i, isDeviceMuted()), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void increaseDeviceVolume(int i) {
        ...
        if (i2 == 0 || deviceVolume + 1 <= i2) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithDeviceVolume(deviceVolume + 1, isDeviceMuted()), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void decreaseDeviceVolume(int i) {
        ...
        if (deviceVolume >= getDeviceInfo().minVolume) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithDeviceVolume(deviceVolume, isDeviceMuted()), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
        this.controllerCompat.adjustVolume(-1, i);
    }
    ...
    public void setDeviceMuted(boolean z, int i) {
        ...
        if (z != isDeviceMuted()) {
            updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithDeviceVolume(getDeviceVolume(), z), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
        }
    ...
    public void setPlayWhenReady(boolean z) {
        ...
        updateStateMaskedControllerInfo(new ControllerInfo(this.controllerInfo.playerInfo.copyWithPlayWhenReady(z, 1, 0), this.controllerInfo.availableSessionCommands, this.controllerInfo.availablePlayerCommands, this.controllerInfo.customLayout, this.controllerInfo.sessionExtras), null, null);
    ...
    public void connectToSession(final MediaSessionCompat.Token token) {
        getInstance().runOnApplicationLooper(new Runnable() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda20
            ...
            public final void run() {
                MediaControllerImplLegacy.this.m713xd2b261cf(token);
            }
        });
        getInstance().applicationHandler.post(new Runnable() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
                MediaControllerImplLegacy.this.m714x163d7f90();
            }
        });
    }

    /* renamed from: lambda$connectToSession$1$androidx-media3-session-MediaControllerImplLegacy, reason: not valid java name */
    /* synthetic */ void m713xd2b261cf(MediaSessionCompat.Token token) {
    ...
    private void addQueueItems(final List<MediaItem> list, final int i) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                MediaControllerImplLegacy.this.m711x7d622417(atomicInteger, list, arrayList, i);
            }
        };
    ...
    /* synthetic */ void m711x7d622417(AtomicInteger atomicInteger, List list, List list2, int i) {
    ...
    public void handleNewLegacyParameters(boolean z, LegacyPlayerInfo legacyPlayerInfo) {
        ...
        updateControllerInfo(z, legacyPlayerInfo, buildNewControllerInfo, (Integer) calculateDiscontinuityAndTransitionReason.first, (Integer) calculateDiscontinuityAndTransitionReason.second);
    }
    ...
    private void updateControllerInfo(boolean z, LegacyPlayerInfo legacyPlayerInfo, final ControllerInfo controllerInfo, final Integer num, final Integer num2) {
        ...
        if (z) {
            ...
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda23
                ...
                public final void accept(Object obj) {
                    MediaControllerImplLegacy.this.m719x2ebacb15(controllerInfo, (MediaController.Listener) obj);
                }
            });
            return;
        }
        if (!controllerInfo2.playerInfo.timeline.equals(controllerInfo.playerInfo.timeline)) {
            this.listeners.queueEvent(0, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda9
        ...
        if (!MediaUtils.areEqualError(legacyPlayerInfo2.playbackStateCompat, legacyPlayerInfo.playbackStateCompat)) {
            final PlaybackException convertToPlaybackException = LegacyConversions.convertToPlaybackException(legacyPlayerInfo.playbackStateCompat);
        ...
        if (legacyPlayerInfo2.mediaMetadataCompat != legacyPlayerInfo.mediaMetadataCompat) {
            this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda16
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    MediaControllerImplLegacy.this.m716xa9c99029((Player.Listener) obj);
                }
            });
        }
        ...
        if (controllerInfo2.playerInfo.repeatMode != controllerInfo.playerInfo.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (controllerInfo2.playerInfo.shuffleModeEnabled != controllerInfo.playerInfo.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda2
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!controllerInfo2.playerInfo.audioAttributes.equals(controllerInfo.playerInfo.audioAttributes)) {
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda3
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!controllerInfo2.playerInfo.deviceInfo.equals(controllerInfo.playerInfo.deviceInfo)) {
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda4
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (controllerInfo2.playerInfo.deviceVolume != controllerInfo.playerInfo.deviceVolume || controllerInfo2.playerInfo.deviceMuted != controllerInfo.playerInfo.deviceMuted) {
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda5
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!controllerInfo2.availablePlayerCommands.equals(controllerInfo.availablePlayerCommands)) {
            this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda6
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!controllerInfo2.availableSessionCommands.equals(controllerInfo.availableSessionCommands)) {
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda7
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplLegacy.this.m717x1b2d4849(controllerInfo, (MediaController.Listener) obj);
                }
            });
        }
        if (!controllerInfo2.customLayout.equals(controllerInfo.customLayout)) {
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplLegacy$$ExternalSyntheticLambda8
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplLegacy.this.m718x5eb8660a(controllerInfo, (MediaController.Listener) obj);
                }
            });
        }
    ...
    /* synthetic */ void m719x2ebacb15(ControllerInfo controllerInfo, MediaController.Listener listener) {
    ...
    /* synthetic */ void m716xa9c99029(Player.Listener listener) {
    ...
    /* synthetic */ void m717x1b2d4849(ControllerInfo controllerInfo, MediaController.Listener listener) {
    ...
    /* synthetic */ void m718x5eb8660a(ControllerInfo controllerInfo, MediaController.Listener listener) {
        ignoreFuture(listener.onSetCustomLayout(getInstance(), controllerInfo.customLayout));
        listener.onCustomLayoutChanged(getInstance(), controllerInfo.customLayout);
    }
    ...
    final class ControllerCompatCallback extends MediaControllerCompat.Callback {
        ...
        public ControllerCompatCallback(Looper looper) {
            this.pendingChangesHandler = new Handler(looper, new Handler.Callback() { // from class: androidx.media3.session.MediaControllerImplLegacy$ControllerCompatCallback$$ExternalSyntheticLambda1
                ...
                public final boolean handleMessage(Message message) {
                    return MediaControllerImplLegacy.ControllerCompatCallback.this.m720x38d58084(message);
                }
            });
        }
        ...
        /* synthetic */ boolean m720x38d58084(Message message) {
            if (message.what == 1) {
        ...
        public void onSessionEvent(final String str, final Bundle bundle) {
            MediaControllerImplLegacy.this.getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplLegacy$ControllerCompatCallback$$ExternalSyntheticLambda3
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplLegacy.ControllerCompatCallback.this.m723x2abd04a6(str, bundle, (MediaController.Listener) obj);
                }
            });
        }
        ...
        /* synthetic */ void m723x2abd04a6(String str, Bundle bundle, MediaController.Listener listener) {
        ...
        public void onExtrasChanged(final Bundle bundle) {
            ...
            MediaControllerImplLegacy.this.getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplLegacy$ControllerCompatCallback$$ExternalSyntheticLambda2
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplLegacy.ControllerCompatCallback.this.m722x9a6b3370(bundle, (MediaController.Listener) obj);
                }
            });
        }
        ...
        /* synthetic */ void m722x9a6b3370(Bundle bundle, MediaController.Listener listener) {
        ...
        public void onCaptioningEnabledChanged(final boolean z) {
            MediaControllerImplLegacy.this.getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplLegacy$ControllerCompatCallback$$ExternalSyntheticLambda0
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplLegacy.ControllerCompatCallback.this.m721xceb86159(z, (MediaController.Listener) obj);
                }
            });
        }
        ...
        /* synthetic */ void m721xceb86159(boolean z, MediaController.Listener listener) {
    ...
    private static ControllerInfo buildNewControllerInfo(boolean z, LegacyPlayerInfo legacyPlayerInfo, ControllerInfo controllerInfo, LegacyPlayerInfo legacyPlayerInfo2, String str, long j, boolean z2, int i, long j2, String str2) {
        QueueTimeline copy;
        ...
        if (z4 || z5 || z3) {
            ...
            if (findQueueItemIndex != -1 || !z4) {
                ...
                findQueueItemIndex = copy.getWindowCount() - 1;
                i2 = findQueueItemIndex;
                mediaMetadata2 = mediaMetadata;
            } else {
                copy = copy.copyWithClearedFakeMediaItem();
            ...
            int i4 = controllerInfo.playerInfo.sessionPositionInfo.positionInfo.mediaItemIndex;
        ...
        if (legacyPlayerInfo.playbackStateCompat != legacyPlayerInfo2.playbackStateCompat) {
            sessionCommands = LegacyConversions.convertToSessionCommands(legacyPlayerInfo2.playbackStateCompat, z2);
