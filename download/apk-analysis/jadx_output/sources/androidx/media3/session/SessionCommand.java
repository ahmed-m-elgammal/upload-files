...
public final class SessionCommand implements Bundleable {
    ...
    @Deprecated
    public static final Bundleable.Creator<SessionCommand> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.session.SessionCommand$$ExternalSyntheticLambda0
