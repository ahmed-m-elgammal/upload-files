...
class MediaControllerStub extends IMediaController.Stub {
    ...
    static /* synthetic */ void lambda$onDisconnected$1(MediaControllerImplBase mediaControllerImplBase) {
        ...
        mediaControllerImplBase2.runOnApplicationLooper(new MediaControllerImplBase$$ExternalSyntheticLambda40(mediaControllerImplBase3));
    }
    ...
    public void onSetCustomLayout(final int i, List<Bundle> list) {
        ...
        try {
            final ImmutableList fromBundleList = BundleCollectionUtil.fromBundleList(new ConnectionState$$ExternalSyntheticLambda1(), list);
    ...
    public void onPlayerInfoChangedWithExclusions(int i, Bundle bundle, Bundle bundle2) {
        ...
        try {
            final PlayerInfo fromBundle = PlayerInfo.fromBundle(bundle);
            try {
    ...
    private <T extends MediaControllerImplBase> void dispatchControllerTaskOnHandler(final ControllerTask<T> controllerTask) {
        ...
        try {
            ...
            Util.postOrRun(mediaControllerImplBase.getInstance().applicationHandler, new Runnable() { // from class: androidx.media3.session.MediaControllerStub$$ExternalSyntheticLambda5
