...
final class SessionTokenImplLegacy implements SessionToken.SessionTokenImpl {
    ...
    @Deprecated
    public static final Bundleable.Creator<SessionTokenImplLegacy> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.session.SessionTokenImplLegacy$$ExternalSyntheticLambda0
