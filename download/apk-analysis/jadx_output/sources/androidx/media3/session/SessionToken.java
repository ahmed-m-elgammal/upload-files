...
public final class SessionToken implements Bundleable {
    ...
    public static ListenableFuture<SessionToken> createSessionToken(final Context context, final MediaSessionCompat.Token token, Looper looper) {
        ...
        final Runnable runnable = new Runnable() { // from class: androidx.media3.session.SessionToken$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                Context context2 = context;
                String str = packageName;
                create.set(new SessionToken(token, str, SessionToken.getUid(context2.getPackageManager(), str), mediaControllerCompat.getSessionInfo()));
            }
        };
