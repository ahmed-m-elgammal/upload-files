...
final class SessionPositionInfo implements Bundleable {
    ...
    public SessionPositionInfo filterByAvailableCommands(boolean z, boolean z2) {
        ...
        return new SessionPositionInfo(this.positionInfo.filterByAvailableCommands(z, z2), z && this.isPlayingAd, this.eventTimeMs, z ? this.durationMs : -9223372036854775807L, z ? this.bufferedPositionMs : 0L, z ? this.bufferedPercentage : 0, z ? this.totalBufferedDurationMs : 0L, z ? this.currentLiveOffsetMs : -9223372036854775807L, z ? this.contentDurationMs : -9223372036854775807L, z ? this.contentBufferedPositionMs : 0L);
    }
    ...
    public static SessionPositionInfo fromBundle(Bundle bundle) {
        ...
        return new SessionPositionInfo(fromBundle, bundle.getBoolean(FIELD_IS_PLAYING_AD, false), bundle.getLong(FIELD_EVENT_TIME_MS, -9223372036854775807L), bundle.getLong(FIELD_DURATION_MS, -9223372036854775807L), bundle.getLong(FIELD_BUFFERED_POSITION_MS, 0L), bundle.getInt(FIELD_BUFFERED_PERCENTAGE, 0), bundle.getLong(FIELD_TOTAL_BUFFERED_DURATION_MS, 0L), bundle.getLong(FIELD_CURRENT_LIVE_OFFSET_MS, -9223372036854775807L), bundle.getLong(FIELD_CONTENT_DURATION_MS, -9223372036854775807L), bundle.getLong(FIELD_CONTENT_BUFFERED_POSITION_MS, 0L));
    }
}
