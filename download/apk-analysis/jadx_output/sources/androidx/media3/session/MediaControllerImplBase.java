...
class MediaControllerImplBase implements MediaController.MediaControllerImpl {
    ...
    public MediaControllerImplBase(Context context, MediaController mediaController, SessionToken sessionToken, Bundle bundle, Looper looper) {
        ...
        this.listeners = new ListenerSet<>(looper, Clock.DEFAULT, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda87
            @Override // androidx.media3.common.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                MediaControllerImplBase.this.m644lambda$new$0$androidxmedia3sessionMediaControllerImplBase((Player.Listener) obj, flagSet);
            }
        });
        ...
        this.deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda88
            @Override // android.os.IBinder.DeathRecipient
            public final void binderDied() {
                MediaControllerImplBase.this.m645lambda$new$1$androidxmedia3sessionMediaControllerImplBase();
            }
        };
    ...
    /* synthetic */ void m644lambda$new$0$androidxmedia3sessionMediaControllerImplBase(Player.Listener listener, FlagSet flagSet) {
    ...
    /* synthetic */ void m645lambda$new$1$androidxmedia3sessionMediaControllerImplBase() {
        ...
        mediaControllerImplBase.runOnApplicationLooper(new MediaControllerImplBase$$ExternalSyntheticLambda40(mediaControllerImplBase2));
    }
        ...
        if (isPlayerCommandAvailable(3)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda102
                ...
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m705lambda$stop$2$androidxmedia3sessionMediaControllerImplBase(iMediaSession, i);
                }
            });
            ...
            if (copyWithSessionPositionInfo.playbackState != 1) {
                ...
                this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda103
    ...
    /* synthetic */ void m705lambda$stop$2$androidxmedia3sessionMediaControllerImplBase(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void release() {
        ...
        this.sequencedFutureManager.lazyRelease(30000L, new Runnable() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda74
            @Override // java.lang.Runnable
            public final void run() {
                MediaControllerImplBase.this.m657lambda$release$4$androidxmedia3sessionMediaControllerImplBase();
            }
        });
    }

    /* renamed from: lambda$release$4$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m657lambda$release$4$androidxmedia3sessionMediaControllerImplBase() {
    ...
    public void play() {
        if (!isPlayerCommandAvailable(1)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda101
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m655lambda$play$5$androidxmedia3sessionMediaControllerImplBase(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m655lambda$play$5$androidxmedia3sessionMediaControllerImplBase(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void pause() {
        if (isPlayerCommandAvailable(1)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda92
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m654lambda$pause$6$androidxmedia3sessionMediaControllerImplBase(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m654lambda$pause$6$androidxmedia3sessionMediaControllerImplBase(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void prepare() {
        if (isPlayerCommandAvailable(2)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda104
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m656lambda$prepare$7$androidxmedia3sessionMediaControllerImplBase(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m656lambda$prepare$7$androidxmedia3sessionMediaControllerImplBase(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void seekToDefaultPosition() {
        if (isPlayerCommandAvailable(4)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda37
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m666x4935e2a(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m666x4935e2a(IMediaSession iMediaSession, int i) throws RemoteException {
        ...
        if (isPlayerCommandAvailable(10)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda0
                ...
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m667x41cf82b(i, iMediaSession, i2);
                }
            });
    ...
    /* synthetic */ void m667x41cf82b(int i, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    public void seekTo(final long j) {
        if (isPlayerCommandAvailable(5)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda26
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m664lambda$seekTo$10$androidxmedia3sessionMediaControllerImplBase(j, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m664lambda$seekTo$10$androidxmedia3sessionMediaControllerImplBase(long j, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void seekTo(final int i, final long j) {
        if (isPlayerCommandAvailable(10)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda98
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m665lambda$seekTo$11$androidxmedia3sessionMediaControllerImplBase(i, j, iMediaSession, i2);
                }
            });
            seekToInternal(i, j);
        }
    ...
    /* synthetic */ void m665lambda$seekTo$11$androidxmedia3sessionMediaControllerImplBase(int i, long j, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    public void seekBack() {
        if (isPlayerCommandAvailable(11)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda89
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m662xa77bbc45(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m662xa77bbc45(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void seekForward() {
        if (isPlayerCommandAvailable(12)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda28
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m663xc4e101b2(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m663xc4e101b2(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setPlayWhenReady(final boolean z) {
        if (isPlayerCommandAvailable(1)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda115
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m690x3c78c7d3(z, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m690x3c78c7d3(boolean z, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        if (isPlayerCommandAvailable(13)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda24
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m691x7ad849fa(playbackParameters, iMediaSession, i);
                }
            });
            ...
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda25
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    /* synthetic */ void m691x7ad849fa(PlaybackParameters playbackParameters, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setPlaybackSpeed(final float f) {
        if (isPlayerCommandAvailable(13)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda71
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m692x786a6f3f(f, iMediaSession, i);
                }
            });
            if (this.playerInfo.playbackParameters.speed != f) {
                ...
                this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda73
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        ((Player.Listener) obj).onPlaybackParametersChanged(PlaybackParameters.this);
                    }
    ...
    /* synthetic */ void m692x786a6f3f(float f, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public ListenableFuture<SessionResult> setRating(final String str, final Rating rating) {
        return dispatchRemoteSessionTaskWithSessionCommand(SessionCommand.COMMAND_CODE_SESSION_SET_RATING, new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda33
            @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
            public final void run(IMediaSession iMediaSession, int i) {
                MediaControllerImplBase.this.m694x577a1446(str, rating, iMediaSession, i);
            }
        });
    }

    /* renamed from: lambda$setRating$19$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m694x577a1446(String str, Rating rating, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public ListenableFuture<SessionResult> setRating(final Rating rating) {
        return dispatchRemoteSessionTaskWithSessionCommand(SessionCommand.COMMAND_CODE_SESSION_SET_RATING, new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda13
            @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
            public final void run(IMediaSession iMediaSession, int i) {
                MediaControllerImplBase.this.m695x4d4d505c(rating, iMediaSession, i);
            }
        });
    }

    /* renamed from: lambda$setRating$20$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m695x4d4d505c(Rating rating, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public ListenableFuture<SessionResult> sendCustomCommand(final SessionCommand sessionCommand, final Bundle bundle) {
        return dispatchRemoteSessionTaskWithSessionCommand(sessionCommand, new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda36
            @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
            public final void run(IMediaSession iMediaSession, int i) {
                MediaControllerImplBase.this.m673xbdee5b2a(sessionCommand, bundle, iMediaSession, i);
            }
        });
    }

    /* renamed from: lambda$sendCustomCommand$21$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m673xbdee5b2a(SessionCommand sessionCommand, Bundle bundle, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setMediaItem(final MediaItem mediaItem) {
        if (isPlayerCommandAvailable(31)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda32
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m684x9063a1ce(mediaItem, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m684x9063a1ce(MediaItem mediaItem, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setMediaItem(final MediaItem mediaItem, final long j) {
        if (isPlayerCommandAvailable(31)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda83
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m685x8fed3bcf(mediaItem, j, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m685x8fed3bcf(MediaItem mediaItem, long j, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setMediaItem(final MediaItem mediaItem, final boolean z) {
        if (isPlayerCommandAvailable(31)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda4
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m686x8f76d5d0(mediaItem, z, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m686x8f76d5d0(MediaItem mediaItem, boolean z, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setMediaItems(final List<MediaItem> list) {
        if (isPlayerCommandAvailable(20)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda29
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m687x501359e2(list, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m687x501359e2(List list, IMediaSession iMediaSession, int i) throws RemoteException {
        iMediaSession.setMediaItems(this.controllerStub, i, new BundleListRetriever(BundleCollectionUtil.toBundleList(list, new MediaControllerImplBase$$ExternalSyntheticLambda116())));
    }
    ...
    public void setMediaItems(final List<MediaItem> list, final boolean z) {
        if (isPlayerCommandAvailable(20)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda82
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m688x4f9cf3e3(list, z, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m688x4f9cf3e3(List list, boolean z, IMediaSession iMediaSession, int i) throws RemoteException {
        iMediaSession.setMediaItemsWithResetPosition(this.controllerStub, i, new BundleListRetriever(BundleCollectionUtil.toBundleList(list, new MediaControllerImplBase$$ExternalSyntheticLambda116())), z);
    }
    ...
    public void setMediaItems(final List<MediaItem> list, final int i, final long j) {
        if (isPlayerCommandAvailable(20)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda20
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m689x4f268de4(list, i, j, iMediaSession, i2);
                }
            });
    ...
    /* synthetic */ void m689x4f268de4(List list, int i, long j, IMediaSession iMediaSession, int i2) throws RemoteException {
        iMediaSession.setMediaItemsWithStartIndex(this.controllerStub, i2, new BundleListRetriever(BundleCollectionUtil.toBundleList(list, new MediaControllerImplBase$$ExternalSyntheticLambda116())), i, j);
    }
    ...
    public void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        if (isPlayerCommandAvailable(19)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda30
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m693x8d147ea0(mediaMetadata, iMediaSession, i);
                }
            });
            ...
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda31
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    /* synthetic */ void m693x8d147ea0(MediaMetadata mediaMetadata, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void addMediaItem(final MediaItem mediaItem) {
        if (isPlayerCommandAvailable(20)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda61
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m628x274a4faa(mediaItem, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m628x274a4faa(MediaItem mediaItem, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void addMediaItem(final int i, final MediaItem mediaItem) {
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda11
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m629x26d3e9ab(i, mediaItem, iMediaSession, i2);
                }
            });
    ...
    /* synthetic */ void m629x26d3e9ab(int i, MediaItem mediaItem, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    public void addMediaItems(final List<MediaItem> list) {
        if (isPlayerCommandAvailable(20)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda19
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m630x28d76e1f(list, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m630x28d76e1f(List list, IMediaSession iMediaSession, int i) throws RemoteException {
        iMediaSession.addMediaItems(this.controllerStub, i, new BundleListRetriever(BundleCollectionUtil.toBundleList(list, new MediaControllerImplBase$$ExternalSyntheticLambda116())));
    }
    ...
    public void addMediaItems(final int i, final List<MediaItem> list) {
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda91
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m631x28610820(i, list, iMediaSession, i2);
                }
            });
    ...
    /* synthetic */ void m631x28610820(int i, List list, IMediaSession iMediaSession, int i2) throws RemoteException {
        iMediaSession.addMediaItemsWithIndex(this.controllerStub, i2, i, new BundleListRetriever(BundleCollectionUtil.toBundleList(list, new MediaControllerImplBase$$ExternalSyntheticLambda116())));
    }
    ...
    private static PlayerInfo maskPlayerInfoForAddedItems(PlayerInfo playerInfo, int i, List<MediaItem> list, long j, long j2) {
        ...
        for (int i6 = 0; i6 < list.size(); i6++) {
            arrayList.add(i6 + i, createNewWindow(list.get(i6)));
        }
        ...
        return maskTimelineAndPositionInfo(playerInfo, createMaskingTimeline, i2, i4, j, j2, 5);
    }
    ...
    public void removeMediaItem(final int i) {
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda80
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m658xcb8143eb(i, iMediaSession, i2);
                }
            });
    ...
    /* synthetic */ void m658xcb8143eb(int i, IMediaSession iMediaSession, int i2) throws RemoteException {
        ...
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda38
                ...
                public final void run(IMediaSession iMediaSession, int i3) {
                    MediaControllerImplBase.this.m659x43753785(i, i2, iMediaSession, i3);
                }
            });
    ...
    /* synthetic */ void m659x43753785(int i, int i2, IMediaSession iMediaSession, int i3) throws RemoteException {
    ...
    public void clearMediaItems() {
        if (isPlayerCommandAvailable(20)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda84
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m632x7e2b5cb7(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m632x7e2b5cb7(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    private static PlayerInfo maskPlayerInfoForRemovedItems(PlayerInfo playerInfo, int i, int i2, boolean z, long j, long j2) {
        ...
        if (createMaskingTimeline.isEmpty()) {
            ...
            int resolveSubsequentMediaItemIndex = resolveSubsequentMediaItemIndex(playerInfo.repeatMode, playerInfo.shuffleModeEnabled, currentMediaItemIndexInternal, timeline, i, i2);
            ...
            } else if (resolveSubsequentMediaItemIndex >= i2) {
                resolveSubsequentMediaItemIndex -= i2 - i;
            }
            i3 = createMaskingTimeline.getWindow(resolveSubsequentMediaItemIndex, window).firstPeriodIndex;
            i4 = resolveSubsequentMediaItemIndex;
        } else if (currentMediaItemIndexInternal >= i2) {
            i4 = currentMediaItemIndexInternal - (i2 - i);
            i3 = getNewPeriodIndexWithoutRemovedPeriods(timeline, i7, i, i2);
        } else {
            i3 = i7;
        ...
        if (!z2) {
            ...
            i5 = 4;
            Timeline.Window window2 = createMaskingTimeline.getWindow(i4, new Timeline.Window());
        ...
        return (maskTimelineAndPositionInfo.playbackState == 1 || maskTimelineAndPositionInfo.playbackState == i5 || i >= i2 || i2 != timeline.getWindowCount() || currentMediaItemIndexInternal < i) ? maskTimelineAndPositionInfo : maskTimelineAndPositionInfo.copyWithPlaybackState(i5, null);
    }
    ...
    public void moveMediaItem(final int i, final int i2) {
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda1
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i3) {
                    MediaControllerImplBase.this.m642x94a376fb(i, i2, iMediaSession, i3);
                }
            });
    ...
    /* synthetic */ void m642x94a376fb(int i, int i2, IMediaSession iMediaSession, int i3) throws RemoteException {
        ...
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda77
                ...
                public final void run(IMediaSession iMediaSession, int i4) {
                    MediaControllerImplBase.this.m643xc839421b(i, i2, i3, iMediaSession, i4);
                }
            });
    ...
    /* synthetic */ void m643xc839421b(int i, int i2, int i3, IMediaSession iMediaSession, int i4) throws RemoteException {
    ...
    public void replaceMediaItem(final int i, final MediaItem mediaItem) {
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda18
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m660x2a7593c6(i, mediaItem, iMediaSession, i2);
                }
            });
    ...
    /* synthetic */ void m660x2a7593c6(int i, MediaItem mediaItem, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    public void replaceMediaItems(final int i, final int i2, final List<MediaItem> list) {
        if (isPlayerCommandAvailable(20)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda105
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i3) {
                    MediaControllerImplBase.this.m661xfeb44889(list, i, i2, iMediaSession, i3);
                }
            });
    ...
    /* synthetic */ void m661xfeb44889(List list, int i, int i2, IMediaSession iMediaSession, int i3) throws RemoteException {
        BundleListRetriever bundleListRetriever = new BundleListRetriever(BundleCollectionUtil.toBundleList(list, new MediaControllerImplBase$$ExternalSyntheticLambda116()));
        if (((SessionToken) Assertions.checkNotNull(this.connectedToken)).getInterfaceVersion() >= 2) {
    ...
    public void seekToPreviousMediaItem() {
        if (isPlayerCommandAvailable(6)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda72
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m671xb9ec60ad(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m671xb9ec60ad(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void seekToNextMediaItem() {
        if (isPlayerCommandAvailable(8)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda5
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m669x391820aa(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m669x391820aa(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void seekToPrevious() {
        if (isPlayerCommandAvailable(7)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda81
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m670x5c7914d8(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m670x5c7914d8(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void seekToNext() {
        if (isPlayerCommandAvailable(9)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda94
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m668x194a9d5d(iMediaSession, i);
                }
            });
            Timeline currentTimeline = getCurrentTimeline();
            if (currentTimeline.isEmpty() || isPlayingAd()) {
    ...
    /* synthetic */ void m668x194a9d5d(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setRepeatMode(final int i) {
        if (isPlayerCommandAvailable(15)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda2
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m696xe0f5373e(i, iMediaSession, i2);
                }
            });
            if (this.playerInfo.repeatMode != i) {
                this.playerInfo = this.playerInfo.copyWithRepeatMode(i);
                this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda3
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
    ...
    /* synthetic */ void m696xe0f5373e(int i, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    public void setShuffleModeEnabled(final boolean z) {
        if (isPlayerCommandAvailable(14)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda78
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m697x9eb3c759(z, iMediaSession, i);
                }
            });
            if (this.playerInfo.shuffleModeEnabled != z) {
                this.playerInfo = this.playerInfo.copyWithShuffleModeEnabled(z);
                this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda79
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
    ...
    /* synthetic */ void m697x9eb3c759(boolean z, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setVolume(final float f) {
        if (isPlayerCommandAvailable(24)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda108
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m704xd97b1206(f, iMediaSession, i);
                }
            });
            if (this.playerInfo.volume != f) {
                this.playerInfo = this.playerInfo.copyWithVolume(f);
                this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda109
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
    ...
    /* synthetic */ void m704xd97b1206(float f, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setDeviceVolume(final int i) {
        if (isPlayerCommandAvailable(25)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda6
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m679x4638e627(i, iMediaSession, i2);
                }
            });
            ...
            if (deviceInfo.maxVolume == 0 || i <= deviceInfo.maxVolume) {
                ...
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda7
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m680x45c28028(i, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m679x4638e627(int i, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    /* synthetic */ void m680x45c28028(int i, Player.Listener listener) {
    ...
    public void setDeviceVolume(final int i, final int i2) {
        if (isPlayerCommandAvailable(33)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda69
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i3) {
                    MediaControllerImplBase.this.m681x454c1a29(i, i2, iMediaSession, i3);
                }
            });
            DeviceInfo deviceInfo = getDeviceInfo();
            if (this.playerInfo.deviceVolume == i || deviceInfo.minVolume > i) {
            ...
            if (deviceInfo.maxVolume == 0 || i <= deviceInfo.maxVolume) {
                ...
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda70
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m682x44d5b42a(i, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m681x454c1a29(int i, int i2, IMediaSession iMediaSession, int i3) throws RemoteException {
    ...
    /* synthetic */ void m682x44d5b42a(int i, Player.Listener listener) {
        listener.onDeviceVolumeChanged(i, this.playerInfo.deviceMuted);
    }
    ...
    public void increaseDeviceVolume() {
        if (isPlayerCommandAvailable(26)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda93
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m638x83ebc271(iMediaSession, i);
                }
            });
            ...
            if (i2 == 0 || i <= i2) {
                PlayerInfo playerInfo = this.playerInfo;
                this.playerInfo = playerInfo.copyWithDeviceVolume(i, playerInfo.deviceMuted);
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda95
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m639x83755c72(i, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m638x83ebc271(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    /* synthetic */ void m639x83755c72(int i, Player.Listener listener) {
        listener.onDeviceVolumeChanged(i, this.playerInfo.deviceMuted);
    }
    ...
    public void increaseDeviceVolume(final int i) {
        if (isPlayerCommandAvailable(34)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda99
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m640x82fef673(i, iMediaSession, i2);
                }
            });
            ...
            if (i3 == 0 || i2 <= i3) {
                ...
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda100
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m641x82889074(i2, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m640x82fef673(int i, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    /* synthetic */ void m641x82889074(int i, Player.Listener listener) {
        listener.onDeviceVolumeChanged(i, this.playerInfo.deviceMuted);
    }
    ...
    public void decreaseDeviceVolume() {
        if (isPlayerCommandAvailable(26)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda8
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m634x12544499(iMediaSession, i);
                }
            });
            final int i = this.playerInfo.deviceVolume - 1;
            if (i >= getDeviceInfo().minVolume) {
                ...
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda9
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m635x82780af(i, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m634x12544499(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    /* synthetic */ void m635x82780af(int i, Player.Listener listener) {
        listener.onDeviceVolumeChanged(i, this.playerInfo.deviceMuted);
    }
    ...
    public void decreaseDeviceVolume(final int i) {
        if (isPlayerCommandAvailable(34)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda22
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m636x7b11ab0(i, iMediaSession, i2);
                }
            });
            final int i2 = this.playerInfo.deviceVolume - 1;
            if (i2 >= getDeviceInfo().minVolume) {
                ...
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda23
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m637x73ab4b1(i2, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m636x7b11ab0(int i, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    /* synthetic */ void m637x73ab4b1(int i, Player.Listener listener) {
        listener.onDeviceVolumeChanged(i, this.playerInfo.deviceMuted);
    }
    ...
    public void setDeviceMuted(final boolean z) {
        if (isPlayerCommandAvailable(26)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda106
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m675x98e70aad(z, iMediaSession, i);
                }
            });
            if (this.playerInfo.deviceMuted != z) {
                PlayerInfo playerInfo = this.playerInfo;
                this.playerInfo = playerInfo.copyWithDeviceVolume(playerInfo.deviceVolume, z);
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda107
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m676x9870a4ae(z, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m675x98e70aad(boolean z, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    /* synthetic */ void m676x9870a4ae(boolean z, Player.Listener listener) {
    ...
    public void setDeviceMuted(final boolean z, final int i) {
        if (isPlayerCommandAvailable(34)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda75
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i2) {
                    MediaControllerImplBase.this.m677x97fa3eaf(z, i, iMediaSession, i2);
                }
            });
            if (this.playerInfo.deviceMuted != z) {
                PlayerInfo playerInfo = this.playerInfo;
                ...
                this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda76
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m678x9783d8b0(z, (Player.Listener) obj);
                    }
                });
                this.listeners.flushEvents();
            }
    ...
    /* synthetic */ void m677x97fa3eaf(boolean z, int i, IMediaSession iMediaSession, int i2) throws RemoteException {
    ...
    /* synthetic */ void m678x9783d8b0(boolean z, Player.Listener listener) {
        listener.onDeviceVolumeChanged(this.playerInfo.deviceVolume, z);
    }
    ...
    public void setAudioAttributes(final AudioAttributes audioAttributes, final boolean z) {
        if (isPlayerCommandAvailable(35)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda16
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m674xd2c92c19(audioAttributes, z, iMediaSession, i);
                }
            });
            ...
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda17
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    /* synthetic */ void m674xd2c92c19(AudioAttributes audioAttributes, boolean z, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void clearVideoSurface() {
        if (isPlayerCommandAvailable(27)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda27
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m633xf1aa0fe1(iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m633xf1aa0fe1(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setVideoSurface(final Surface surface) {
        if (isPlayerCommandAvailable(27)) {
            ...
            dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda21
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m699x50be6282(surface, iMediaSession, i);
                }
            });
    ...
    /* synthetic */ void m699x50be6282(Surface surface, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setVideoSurfaceHolder(SurfaceHolder surfaceHolder) {
        if (isPlayerCommandAvailable(27)) {
            ...
            if (surface != null && surface.isValid()) {
                this.videoSurface = surface;
                dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda34
                    @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                    public final void run(IMediaSession iMediaSession, int i) {
                        MediaControllerImplBase.this.m700x96618c77(surface, iMediaSession, i);
                    }
                });
            ...
            dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda35
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m701x95eb2678(iMediaSession, i);
                }
            });
            maybeNotifySurfaceSizeChanged(0, 0);
        }
    ...
    /* synthetic */ void m700x96618c77(Surface surface, IMediaSession iMediaSession, int i) throws RemoteException {
        iMediaSession.setVideoSurface(this.controllerStub, i, surface);
    }

    /* renamed from: lambda$setVideoSurfaceHolder$72$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m701x95eb2678(IMediaSession iMediaSession, int i) throws RemoteException {
        iMediaSession.setVideoSurface(this.controllerStub, i, null);
    }
    ...
    public void setVideoTextureView(TextureView textureView) {
        if (isPlayerCommandAvailable(27)) {
            ...
            if (surfaceTexture == null) {
                dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda14
                    @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                    public final void run(IMediaSession iMediaSession, int i) {
                        MediaControllerImplBase.this.m702x1d29f4f2(iMediaSession, i);
                    }
                });
                maybeNotifySurfaceSizeChanged(0, 0);
            } else {
                this.videoSurface = new Surface(surfaceTexture);
                dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda15
                    @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                    public final void run(IMediaSession iMediaSession, int i) {
                        MediaControllerImplBase.this.m703x1cb38ef3(iMediaSession, i);
                    }
                });
    ...
    /* synthetic */ void m702x1d29f4f2(IMediaSession iMediaSession, int i) throws RemoteException {
        iMediaSession.setVideoSurface(this.controllerStub, i, null);
    }

    /* renamed from: lambda$setVideoTextureView$74$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m703x1cb38ef3(IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    public void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        if (isPlayerCommandAvailable(29)) {
            dispatchRemoteSessionTaskWithPlayerCommand(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda10
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.this.m698xd4d571ce(trackSelectionParameters, iMediaSession, i);
                }
            });
            if (trackSelectionParameters != this.playerInfo.trackSelectionParameters) {
                ...
                this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda12
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
    ...
    /* synthetic */ void m698xd4d571ce(TrackSelectionParameters trackSelectionParameters, IMediaSession iMediaSession, int i) throws RemoteException {
    ...
    */
    ...
    private void seekToInternal(int i, long j) {
        ...
        if ((timeline.isEmpty() || i < timeline.getWindowCount()) && !isPlayingAd()) {
            ...
            PlayerInfo copyWithPlaybackState = playerInfo.copyWithPlaybackState(i2, playerInfo.playerError);
            ...
            boolean z = (mediaControllerImplBase.playerInfo.timeline.isEmpty() || maskPositionInfo.sessionPositionInfo.positionInfo.mediaItemIndex == mediaControllerImplBase.playerInfo.sessionPositionInfo.positionInfo.mediaItemIndex) ? false : true;
            if (z || maskPositionInfo.sessionPositionInfo.positionInfo.positionMs != mediaControllerImplBase.playerInfo.sessionPositionInfo.positionInfo.positionMs) {
                updatePlayerInfo(maskPositionInfo, null, null, 1, z ? 2 : null);
            }
        }
    }
    ...
    private void notifyPlayerInfoListenersWithReasons(PlayerInfo playerInfo, final PlayerInfo playerInfo2, final Integer num, final Integer num2, final Integer num3, final Integer num4) {
        if (num != null) {
            this.listeners.queueEvent(0, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda39
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (num3 != null) {
            this.listeners.queueEvent(11, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda51
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (num4 != null) {
            this.listeners.queueEvent(1, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda59
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playbackException != playbackException2 && (playbackException == null || !playbackException.errorInfoEquals(playbackException2))) {
            this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda60
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.currentTracks.equals(playerInfo2.currentTracks)) {
            this.listeners.queueEvent(2, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda63
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.mediaMetadata.equals(playerInfo2.mediaMetadata)) {
            this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda64
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.isLoading != playerInfo2.isLoading) {
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda65
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.playbackState != playerInfo2.playbackState) {
            this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda66
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (num2 != null) {
            this.listeners.queueEvent(5, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda67
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.playbackSuppressionReason != playerInfo2.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda41
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.isPlaying != playerInfo2.isPlaying) {
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda42
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.playbackParameters.equals(playerInfo2.playbackParameters)) {
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda43
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.repeatMode != playerInfo2.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda44
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.shuffleModeEnabled != playerInfo2.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda45
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.playlistMetadata.equals(playerInfo2.playlistMetadata)) {
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda46
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.volume != playerInfo2.volume) {
            this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda47
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.audioAttributes.equals(playerInfo2.audioAttributes)) {
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda48
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.cueGroup.cues.equals(playerInfo2.cueGroup.cues)) {
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda49
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    ((Player.Listener) obj).onCues(PlayerInfo.this.cueGroup.cues);
                }
            });
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda50
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.deviceInfo.equals(playerInfo2.deviceInfo)) {
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda52
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.deviceVolume != playerInfo2.deviceVolume || playerInfo.deviceMuted != playerInfo2.deviceMuted) {
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda53
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.videoSize.equals(playerInfo2.videoSize)) {
            this.listeners.queueEvent(25, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda54
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.seekBackIncrementMs != playerInfo2.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda55
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.seekForwardIncrementMs != playerInfo2.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda56
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (playerInfo.maxSeekToPreviousPositionMs != playerInfo2.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda57
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!playerInfo.trackSelectionParameters.equals(playerInfo2.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda58
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    public void maybeNotifySurfaceSizeChanged(final int i, final int i2) {
        ...
        this.listeners.sendEvent(24, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda114
            @Override // androidx.media3.common.util.ListenerSet.Event
            public final void invoke(Object obj) {
    ...
    <T> void setFutureResult(final int i, T t) {
        ...
        getInstance().runOnApplicationLooper(new Runnable() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda97
            @Override // java.lang.Runnable
            public final void run() {
                MediaControllerImplBase.this.m683x8f22d373(i);
            }
        });
    }

    /* renamed from: lambda$setFutureResult$105$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m683x8f22d373(int i) {
    ...
    public void onConnected(ConnectionState connectionState) {
        ...
        this.playerCommandsFromPlayer = commands;
        this.intersectedPlayerCommands = createIntersectedCommandsEnsuringCommandReleaseAvailable(this.playerCommandsFromSession, commands);
        this.customLayout = CommandButton.getEnabledCommandButtons(connectionState.customLayout, this.sessionCommands, this.intersectedPlayerCommands);
    ...
    private void sendControllerResultWhenReady(final int i, final ListenableFuture<SessionResult> listenableFuture) {
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda86
            @Override // java.lang.Runnable
            public final void run() {
                MediaControllerImplBase.this.m672xccda08fa(listenableFuture, i);
            }
    ...
    /* synthetic */ void m672xccda08fa(ListenableFuture listenableFuture, int i) {
    ...
    public void onCustomCommand(final int i, final SessionCommand sessionCommand, final Bundle bundle) {
        if (isConnected()) {
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda90
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplBase.this.m650xd317daae(sessionCommand, bundle, i, (MediaController.Listener) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ void m650xd317daae(SessionCommand sessionCommand, Bundle bundle, int i, MediaController.Listener listener) {
    ...
    public void onAvailableCommandsChangedFromSession(final SessionCommands sessionCommands, Player.Commands commands) {
        ...
        if (isConnected()) {
            ...
            if (!areEqual2) {
                ...
                z2 = !enabledCommandButtons.equals(immutableList);
            }
            if (z) {
                this.listeners.sendEvent(13, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda110
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        MediaControllerImplBase.this.m647xd538541e((Player.Listener) obj);
                    }
                });
            }
            if (!areEqual2) {
                getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda111
                    @Override // androidx.media3.common.util.Consumer
                    public final void accept(Object obj) {
                        MediaControllerImplBase.this.m648xd4c1ee1f(sessionCommands, (MediaController.Listener) obj);
                    }
                });
            }
            if (z2) {
                getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda112
                    @Override // androidx.media3.common.util.Consumer
                    public final void accept(Object obj) {
                        MediaControllerImplBase.this.m649xca952a35((MediaController.Listener) obj);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m647xd538541e(Player.Listener listener) {
    ...
    /* synthetic */ void m648xd4c1ee1f(SessionCommands sessionCommands, MediaController.Listener listener) {
    ...
    /* synthetic */ void m649xca952a35(MediaController.Listener listener) {
    ...
    public void onAvailableCommandsChangedFromPlayer(Player.Commands commands) {
        if (isConnected() && !Util.areEqual(this.playerCommandsFromPlayer, commands)) {
            ...
            this.listeners.sendEvent(13, new ListenerSet.Event() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda113
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    MediaControllerImplBase.this.m646xdbcc6033((Player.Listener) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ void m646xdbcc6033(Player.Listener listener) {
        listener.onAvailableCommandsChanged(this.intersectedPlayerCommands);
    }
    ...
    public void onSetCustomLayout(final int i, List<CommandButton> list) {
        if (isConnected()) {
            ImmutableList<CommandButton> immutableList = this.customLayout;
            ImmutableList<CommandButton> enabledCommandButtons = CommandButton.getEnabledCommandButtons(list, this.sessionCommands, this.intersectedPlayerCommands);
            this.customLayout = enabledCommandButtons;
            final boolean z = !Objects.equals(enabledCommandButtons, immutableList);
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda96
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplBase.this.m652xdccf9f2b(z, i, (MediaController.Listener) obj);
                }
            });
        }
    }

    /* renamed from: lambda$onSetCustomLayout$112$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m652xdccf9f2b(boolean z, int i, MediaController.Listener listener) {
    ...
    public void onExtrasChanged(final Bundle bundle) {
        if (isConnected()) {
            ...
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda68
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplBase.this.m651xac48780(bundle, (MediaController.Listener) obj);
                }
            });
        }
    }

    /* renamed from: lambda$onExtrasChanged$113$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m651xac48780(Bundle bundle, MediaController.Listener listener) {
    ...
    public void onSetSessionActivity(int i, final PendingIntent pendingIntent) {
        if (isConnected()) {
            ...
            getInstance().notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaControllerImplBase$$ExternalSyntheticLambda85
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    MediaControllerImplBase.this.m653x83d3002b(pendingIntent, (MediaController.Listener) obj);
                }
            });
        }
    }

    /* renamed from: lambda$onSetSessionActivity$114$androidx-media3-session-MediaControllerImplBase, reason: not valid java name */
    /* synthetic */ void m653x83d3002b(PendingIntent pendingIntent, MediaController.Listener listener) {
    ...
    class SurfaceCallback implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            MediaControllerImplBase.this.dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$SurfaceCallback$$ExternalSyntheticLambda0
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.SurfaceCallback.this.m709x74a7f40e(iMediaSession, i);
                }
            });
            Rect surfaceFrame = surfaceHolder.getSurfaceFrame();
        ...
        /* synthetic */ void m709x74a7f40e(IMediaSession iMediaSession, int i) throws RemoteException {
        ...
        public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
            ...
            MediaControllerImplBase.this.dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$SurfaceCallback$$ExternalSyntheticLambda1
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i) {
                    MediaControllerImplBase.SurfaceCallback.this.m710x3f436f00(iMediaSession, i);
                }
            });
        ...
        /* synthetic */ void m710x3f436f00(IMediaSession iMediaSession, int i) throws RemoteException {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            MediaControllerImplBase.this.dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$SurfaceCallback$$ExternalSyntheticLambda2
                @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                public final void run(IMediaSession iMediaSession, int i3) {
                    MediaControllerImplBase.SurfaceCallback.this.m707x47b74597(iMediaSession, i3);
                }
            });
        ...
        /* synthetic */ void m707x47b74597(IMediaSession iMediaSession, int i) throws RemoteException {
            iMediaSession.setVideoSurface(MediaControllerImplBase.this.controllerStub, i, MediaControllerImplBase.this.videoSurface);
        }
        ...
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            if (MediaControllerImplBase.this.videoTextureView != null && MediaControllerImplBase.this.videoTextureView.getSurfaceTexture() == surfaceTexture) {
                ...
                MediaControllerImplBase.this.dispatchRemoteSessionTaskWithPlayerCommandAndWaitForFuture(new RemoteSessionTask() { // from class: androidx.media3.session.MediaControllerImplBase$SurfaceCallback$$ExternalSyntheticLambda3
                    @Override // androidx.media3.session.MediaControllerImplBase.RemoteSessionTask
                    public final void run(IMediaSession iMediaSession, int i) {
                        MediaControllerImplBase.SurfaceCallback.this.m708x1e8b4e8(iMediaSession, i);
                    }
                });
                MediaControllerImplBase.this.maybeNotifySurfaceSizeChanged(0, 0);
            }
        ...
        /* synthetic */ void m708x1e8b4e8(IMediaSession iMediaSession, int i) throws RemoteException {
            iMediaSession.setVideoSurface(MediaControllerImplBase.this.controllerStub, i, null);
        }
    }
