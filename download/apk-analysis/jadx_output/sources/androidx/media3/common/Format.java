...
public final class Format implements Bundleable {
    ...
    @Deprecated
    public static final Bundleable.Creator<Format> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda3
    ...
    private Format(final Builder builder) {
        ...
        if (!builder.labels.isEmpty() || builder.label == null) {
            if (builder.labels.isEmpty() || builder.label != null) {
                if (!builder.labels.isEmpty() || builder.label != null) {
                    stream = builder.labels.stream();
                    anyMatch = stream.anyMatch(new Predicate() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda5
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                            boolean equals;
                            equals = ((Label) obj).value.equals(Format.Builder.this.label);
                            return equals;
                        }
                    });
                    if (!anyMatch) {
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putParcelableArrayList(FIELD_LABELS, BundleCollectionUtil.toBundleArrayList(this.labels, new Function() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda4
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            fromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
