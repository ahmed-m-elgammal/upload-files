...
class TwilightManager {
    ...
    static TwilightManager getInstance(Context context) {
        if (sInstance == null) {
            ...
            sInstance = new TwilightManager(applicationContext, (LocationManager) applicationContext.getSystemService(GeofencingGooglePlayServicesProvider.LOCATION_EXTRA_ID));
        }
        return sInstance;
    }
