...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m2566constructorimpl(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
            ...
            cancellableContinuation2.resumeWith(Result.m2566constructorimpl(ResultKt.createFailure(nonNullCause)));
        }
    }
}
