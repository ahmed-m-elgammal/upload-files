...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m417m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m417m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m417m = HalfKt$$ExternalSyntheticApiModelOutline0.m418m(windowInsets);
            } else {
                m417m = HalfKt$$ExternalSyntheticApiModelOutline0.m417m();
            }
            this.mPlatBuilder = m417m;
        }
