...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = HalfKt$$ExternalSyntheticApiModelOutline0.m409m(textPaint).setBreakStrategy(i);
    ...
    public PrecomputedText getPrecomputedText() {
        if (HalfKt$$ExternalSyntheticApiModelOutline0.m426m((Object) this.mText)) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m410m((Object) this.mText);
        }
        return null;
    }
