...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            isRequestPinShortcutSupported = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).isRequestPinShortcutSupported();
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            requestPinShortcut = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent createShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            shortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).getShortcuts(i);
            return ShortcutInfoCompat.fromShortcuts(context, shortcuts);
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager m345m = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                manifestShortcuts = m345m.getManifestShortcuts();
                arrayList.addAll(manifestShortcuts);
            }
            if ((i & 2) != 0) {
                dynamicShortcuts = m345m.getDynamicShortcuts();
                arrayList.addAll(dynamicShortcuts);
            }
            if ((i & 4) != 0) {
                pinnedShortcuts = m345m.getPinnedShortcuts();
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            addDynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).addDynamicShortcuts(arrayList);
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        maxShortcutCountPerActivity = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).getMaxShortcutCountPerActivity();
    ...
    public static boolean isRateLimitingActive(Context context) {
        ...
        isRateLimitingActive = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).isRateLimitingActive();
    ...
    public static int getIconMaxWidth(Context context) {
        ...
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            iconMaxWidth = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).getIconMaxWidth();
            return iconMaxWidth;
        }
    ...
    public static int getIconMaxHeight(Context context) {
        ...
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            iconMaxHeight = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).getIconMaxHeight();
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            dynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).setDynamicShortcuts(arrayList);
            if (!dynamicShortcuts) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        List dynamicShortcuts;
        if (Build.VERSION.SDK_INT >= 25) {
            dynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).getDynamicShortcuts();
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            updateShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).updateShortcuts(arrayList);
            if (!updateShortcuts) {
                return false;
            }
        }
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(removeShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager m345m = ColorKt$$ExternalSyntheticApiModelOutline0.m345m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m358m()));
            isRateLimitingActive = m345m.isRateLimitingActive();
            if (isRateLimitingActive) {
                return false;
            }
            dynamicShortcuts = m345m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                m345m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            m345m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
