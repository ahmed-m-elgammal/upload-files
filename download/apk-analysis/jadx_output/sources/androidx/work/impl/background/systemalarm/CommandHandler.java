...
public class CommandHandler implements ExecutionListener {
    ...
    public void m894lambda$runOnExecuted$1$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
    ...
    private void handleStopWork(Intent intent, SystemAlarmDispatcher dispatcher) {
        ...
        for (StartStopToken startStopToken : remove) {
            ...
            dispatcher.m894lambda$runOnExecuted$1$androidxworkimplProcessor(startStopToken.getId(), false);
        }
    }
    ...
    private void handleExecutionCompleted(Intent intent, int startId) {
        ...
        m894lambda$runOnExecuted$1$androidxworkimplProcessor(readWorkGenerationalId, z);
    }
