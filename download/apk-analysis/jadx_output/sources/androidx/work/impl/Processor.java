...
public class Processor implements ExecutionListener, ForegroundProcessor {
    ...
    public boolean startWork(StartStopToken startStopToken, WorkerParameters.RuntimeExtras runtimeExtras) {
        ...
        WorkSpec workSpec = (WorkSpec) this.mWorkDatabase.runInTransaction(new Callable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return Processor.this.m895lambda$startWork$0$androidxworkimplProcessor(arrayList, workSpecId);
            }
        });
        if (workSpec == null) {
    ...
    /* synthetic */ WorkSpec m895lambda$startWork$0$androidxworkimplProcessor(ArrayList arrayList, String str) throws Exception {
    ...
    public void m894lambda$runOnExecuted$1$androidxworkimplProcessor(final WorkGenerationalId id, boolean needsReschedule) {
        synchronized (this.mLock) {
            ...
            while (it.hasNext()) {
                it.next().m894lambda$runOnExecuted$1$androidxworkimplProcessor(id, needsReschedule);
            }
        }
    }
    ...
    private void runOnExecuted(final WorkGenerationalId id, final boolean needsReschedule) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                Processor.this.m894lambda$runOnExecuted$1$androidxworkimplProcessor(id, needsReschedule);
            }
        });
    }
    ...
    private static class FutureListener implements Runnable {
        ...
        public void run() {
            ...
            this.mExecutionListener.m894lambda$runOnExecuted$1$androidxworkimplProcessor(this.mWorkGenerationalId, z);
        }
    }
}
