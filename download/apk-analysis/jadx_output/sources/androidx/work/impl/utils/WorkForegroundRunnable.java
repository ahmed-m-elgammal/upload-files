...
public class WorkForegroundRunnable implements Runnable {
    ...
    public void run() {
        ...
        this.mTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.utils.WorkForegroundRunnable$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WorkForegroundRunnable.this.m902lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(create);
            }
        });
    ...
    /* synthetic */ void m902lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(SettableFuture settableFuture) {
