...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo860clone = transition.mo860clone();
        mo860clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo860clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo860clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo860clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo860clone = transition.mo860clone();
        sceneChangeSetup(viewGroup, mo860clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo860clone);
    }
