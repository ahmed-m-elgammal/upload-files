...
public final class InlineSuggestionUi {
    ...
    public static final class Content extends SlicedContent {
        ...
        Content(Slice slice) {
            ...
            while (it.hasNext()) {
                SliceItem m9m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m9m(it.next());
                String itemType = itemType(m9m);
                if (itemType != null) {
                    itemType.hashCode();
                    switch (itemType) {
        ...
        */
        private static java.lang.String itemType(android.app.slice.SliceItem r3) {
            ...
            L35:
                return r0
            L36:
                android.graphics.drawable.Icon r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m10m(r3)
                if (r1 != 0) goto L3d
                return r0
            L3d:
                java.util.List r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m25m(r3)
                java.lang.String r2 = "inline_start_icon"
                boolean r1 = r1.contains(r2)
                if (r1 == 0) goto L4a
                return r2
            L4a:
                java.util.List r3 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m25m(r3)
                java.lang.String r1 = "inline_end_icon"
                boolean r3 = r3.contains(r1)
                if (r3 == 0) goto L9c
                return r1
            L57:
                java.lang.CharSequence r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m(r3)
        ...
        public static final class Builder extends SlicedContent.Builder<Content> {
            ...
            public Content build() {
                ...
                if (this.mAttributionIntent != null) {
                    ...
                    ComponentDialog$$ExternalSyntheticApiModelOutline0.m26m();
