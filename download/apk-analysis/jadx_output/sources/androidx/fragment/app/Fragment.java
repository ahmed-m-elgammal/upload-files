...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m444lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m444lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m444lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m444lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
