    ...
    */
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r7, com.bumptech.glide.load.DataSource r8, boolean r9) {
        /*
            ...
            r2.throwIfRecycled()
            r2 = 0
            java.lang.Object r3 = r6.requestLock     // Catch: java.lang.Throwable -> Lbd
            monitor-enter(r3)     // Catch: java.lang.Throwable -> Lbd
            r6.loadStatus = r2     // Catch: java.lang.Throwable -> Lba
            if (r7 != 0) goto L2e
            ...
            java.lang.Class<R> r9 = r6.transcodeClass     // Catch: java.lang.Throwable -> Lba
            ...
            r6.onLoadFailed(r7)     // Catch: java.lang.Throwable -> Lba
            monitor-exit(r3)     // Catch: java.lang.Throwable -> Lba
            return
        L2e:
            java.lang.Object r1 = r7.get()     // Catch: java.lang.Throwable -> Lba
            if (r1 == 0) goto L62
            java.lang.Class<R> r4 = r6.transcodeClass     // Catch: java.lang.Throwable -> Lba
            java.lang.Class r5 = r1.getClass()     // Catch: java.lang.Throwable -> Lba
            boolean r4 = r4.isAssignableFrom(r5)     // Catch: java.lang.Throwable -> Lba
            if (r4 != 0) goto L41
            goto L62
        L41:
            boolean r0 = r6.canSetResource()     // Catch: java.lang.Throwable -> Lba
            if (r0 != 0) goto L5d
            r6.resource = r2     // Catch: java.lang.Throwable -> Lb6
            com.bumptech.glide.request.SingleRequest$Status r8 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch: java.lang.Throwable -> Lb6
            r6.status = r8     // Catch: java.lang.Throwable -> Lb6
            java.lang.String r8 = "GlideRequest"
            int r9 = r6.cookie     // Catch: java.lang.Throwable -> Lb6
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r8, r9)     // Catch: java.lang.Throwable -> Lb6
        ...
        L5c:
            return
        L5d:
            r6.onResourceReady(r7, r1, r8, r9)     // Catch: java.lang.Throwable -> Lba
            monitor-exit(r3)     // Catch: java.lang.Throwable -> Lba
            return
        L62:
            r6.resource = r2     // Catch: java.lang.Throwable -> Lb6
            com.bumptech.glide.load.engine.GlideException r8 = new com.bumptech.glide.load.engine.GlideException     // Catch: java.lang.Throwable -> Lb6
            ...
            java.lang.Class<R> r0 = r6.transcodeClass     // Catch: java.lang.Throwable -> Lb6
        ...
        La0:
            ...
            r6.onLoadFailed(r8)     // Catch: java.lang.Throwable -> Lb6
            monitor-exit(r3)     // Catch: java.lang.Throwable -> Lb6
            if (r7 == 0) goto Lb5
            com.bumptech.glide.load.engine.Engine r8 = r6.engine
            r8.release(r7)
