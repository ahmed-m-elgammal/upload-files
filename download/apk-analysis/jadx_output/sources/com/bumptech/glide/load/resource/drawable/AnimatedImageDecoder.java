...
public final class AnimatedImageDecoder {
    ...
    Resource<Drawable> decode(ImageDecoder.Source source, int i, int i2, Options options) throws IOException {
        ...
        if (!WebViewCompat$$ExternalSyntheticApiModelOutline0.m890m((Object) decodeDrawable)) {
            throw new IOException("Received unexpected drawable type for animated image, failing: " + decodeDrawable);
        }
        return new AnimatedImageDrawableResource(WebViewCompat$$ExternalSyntheticApiModelOutline0.m868m((Object) decodeDrawable));
    }
