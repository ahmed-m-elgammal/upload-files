...
public class JsonNodeFactory implements Serializable, JsonNodeCreator {
    ...
    public NumericNode numberNode(BigDecimal bigDecimal) {
        ...
        return bigDecimal.compareTo(BigDecimal.ZERO) == 0 ? DecimalNode.ZERO : DecimalNode.valueOf(JsonNodeFactory$$ExternalSyntheticBackportWithForwarding0.m(bigDecimal));
    }
