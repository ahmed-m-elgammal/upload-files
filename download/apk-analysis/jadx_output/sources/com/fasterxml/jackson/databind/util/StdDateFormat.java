    ...
    protected Date parseAsISO8601(String str, ParsePosition parsePosition, boolean z) throws ParseException {
        ...
        if (length <= 10 && Character.isDigit(charAt)) {
            ...
            if (charAt == 'Z') {
                ...
                if (dateFormat2 == null) {
                    dateFormat2 = _cloneFormat(DATE_FORMAT_ISO8601_Z, DATE_FORMAT_STR_ISO8601_Z, DEFAULT_TIMEZONE, this._locale, this._lenient);
                ...
                if (dateFormat == null) {
                    dateFormat = _cloneFormat(DATE_FORMAT_ISO8601_Z, DATE_FORMAT_STR_ISO8601_Z, DEFAULT_TIMEZONE, this._locale, this._lenient);
