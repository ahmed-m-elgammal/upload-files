...
public class NetworkCallbackConnectivityReceiver extends ConnectivityReceiver {
    ...
    */
    ...
    public void asyncUpdateAndSend(int i) {
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.reactnativecommunity.netinfo.NetworkCallbackConnectivityReceiver$$ExternalSyntheticLambda1
