...
public class DatePickerManager extends SimpleViewManager<PickerView> {
    ...
    @ReactPropGroup(names = {DateProp.name, ModeProp.name, "locale", "maximumDate", "minimumDate", "textColor", TimezoneOffsetInMinutesProp.name, "minuteInterval", Is24hourSourceProp.name, DividerColorProp.name})
