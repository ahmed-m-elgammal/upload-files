...
public final class BufferedDiskCache {
    ...
    private final Task<Boolean> containsAsync(final CacheKey key) {
        try {
            ...
            Task<Boolean> call = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda0
    ...
    public final Task<Void> probe(final CacheKey key) {
        ...
        try {
            ...
            Task<Void> call = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda5
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    Void probe$lambda$2;
    ...
    private final Task<EncodedImage> getAsync(final CacheKey key, final AtomicBoolean isCancelled) {
        try {
            ...
            Task<EncodedImage> call = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda2
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    public final Task<Void> remove(final CacheKey key) {
        ...
        try {
            ...
            Task<Void> call = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda3
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    public final Task<Void> clearAll() {
        ...
        try {
            Task<Void> call = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda4
                @Override // java.util.concurrent.Callable
                public final Object call() {
