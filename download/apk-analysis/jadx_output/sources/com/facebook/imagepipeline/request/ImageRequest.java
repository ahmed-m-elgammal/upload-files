...
public class ImageRequest {
    ...
    public int hashCode() {
        ...
        int i = z2 ? imageRequest.mHashcode : 0;
        if (i == 0) {
            Postprocessor postprocessor = imageRequest.mPostprocessor;
            CacheKey cacheKey = postprocessor != null ? postprocessor.getCacheKey() : null;
            if (!MemorySpikeConfig.avoidObjectsHashCode()) {
                z = z2;
                i = Objects.hashCode(imageRequest.mCacheChoice, imageRequest.mSourceUri, Boolean.valueOf(imageRequest.mLocalThumbnailPreviewsEnabled), imageRequest.mBytesRange, imageRequest.mRequestPriority, imageRequest.mLowestPermittedRequestLevel, Integer.valueOf(imageRequest.mCachesDisabled), Boolean.valueOf(imageRequest.mIsDiskCacheEnabled), Boolean.valueOf(imageRequest.mIsMemoryCacheEnabled), imageRequest.mImageDecodeOptions, imageRequest.mDecodePrefetches, imageRequest.mResizeOptions, imageRequest.mRotationOptions, cacheKey, imageRequest.mResizingAllowedOverride, Integer.valueOf(imageRequest.mDelayMs), Boolean.valueOf(imageRequest.mLoadThumbnailOnly));
                imageRequest = this;
            } else {
                z = z2;
