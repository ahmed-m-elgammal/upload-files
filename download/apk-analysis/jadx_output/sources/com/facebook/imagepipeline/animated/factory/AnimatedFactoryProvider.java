    ...
    public static final AnimatedFactory getAnimatedFactory(PlatformBitmapFactory platformBitmapFactory, ExecutorSupplier executorSupplier, CountingMemoryCache<CacheKey, CloseableImage> backingCache, AnimatedCache animatedCache, boolean downscaleFrameToDrawableDimensions, boolean useBalancedAnimationStrategy, int balancedStrategyPreparationMs, int animationFpsLimit, ExecutorService serialExecutorService) {
        ...
        if (!implLoaded) {
            try {
                ...
                Object newInstance = cls.getConstructor(PlatformBitmapFactory.class, ExecutorSupplier.class, CountingMemoryCache.class, AnimatedCache.class, cls2, cls2, cls3, cls3, SerialExecutorService.class).newInstance(platformBitmapFactory, executorSupplier, backingCache, animatedCache, Boolean.valueOf(downscaleFrameToDrawableDimensions), Boolean.valueOf(useBalancedAnimationStrategy), Integer.valueOf(balancedStrategyPreparationMs), Integer.valueOf(animationFpsLimit), serialExecutorService);
