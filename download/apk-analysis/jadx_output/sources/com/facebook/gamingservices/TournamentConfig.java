...
public final class TournamentConfig implements ShareModel {
    ...
    public TournamentConfig(Parcel parcel) {
        ...
        this.endTime = (Build.VERSION.SDK_INT < 26 || (readString = parcel.readString()) == null) ? null : Instant.from(Intl$$ExternalSyntheticApiModelOutline0.m993m((Object) DateFormatter.INSTANCE.format$facebook_gamingservices_release(readString)));
