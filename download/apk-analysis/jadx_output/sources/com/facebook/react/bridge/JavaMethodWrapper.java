...
class JavaMethodWrapper implements JavaModuleWrapper.NativeMethod {
    ...
    private void processArguments() {
        ...
        SystraceMessage.beginSection(0L, "processArguments").arg(Request.JsonKeys.METHOD, this.mModuleWrapper.getName() + "." + this.mMethod.getName()).flush();
        try {
    ...
    public void invoke(JSInstance jSInstance, ReadableArray readableArray) {
        ...
        SystraceMessage.beginSection(0L, "callJavaModuleMethod").arg(Request.JsonKeys.METHOD, str).flush();
        int i = 0;
        if (DEBUG) {
