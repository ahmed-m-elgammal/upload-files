...
public final class ReadableMapBuffer implements MapBuffer {
    ...
    private final void readHeader() {
        ...
        this.count = m1098readUnsignedShortBwKQO78(this.buffer.position()) & UShort.MAX_VALUE;
    }
    ...
    private final int getBucketIndexForKey(int intKey) {
        ...
        if (intKey <= kEY_RANGE$ReactAndroid_release.getLast() && first <= intKey) {
            short m2848constructorimpl = UShort.m2848constructorimpl((short) intKey);
            int count = getCount() - 1;
            int i = 0;
            while (i <= count) {
                int i2 = (i + count) >>> 1;
                int m1098readUnsignedShortBwKQO78 = m1098readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i2)) & UShort.MAX_VALUE;
                int i3 = 65535 & m2848constructorimpl;
                if (Intrinsics.compare(m1098readUnsignedShortBwKQO78, i3) < 0) {
                    i = i2 + 1;
                } else {
                    if (Intrinsics.compare(m1098readUnsignedShortBwKQO78, i3) <= 0) {
                        return i2;
    ...
    private final MapBuffer.DataType readDataType(int bucketIndex) {
        return MapBuffer.DataType.values()[m1098readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(bucketIndex) + 2) & UShort.MAX_VALUE];
    }
    ...
    public final short m1098readUnsignedShortBwKQO78(int bufferPosition) {
        return UShort.m2848constructorimpl(this.buffer.getShort(bufferPosition));
    }
    ...
    final class MapBufferEntry implements MapBuffer.Entry {
        ...
        public int getKey() {
            return ReadableMapBuffer.this.m1098readUnsignedShortBwKQO78(this.bucketOffset) & UShort.MAX_VALUE;
        }

        @Override // com.facebook.react.common.mapbuffer.MapBuffer.Entry
        public MapBuffer.DataType getType() {
            return MapBuffer.DataType.values()[ReadableMapBuffer.this.m1098readUnsignedShortBwKQO78(this.bucketOffset + 2) & UShort.MAX_VALUE];
        }
