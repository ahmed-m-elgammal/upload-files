...
public class FpsDebugFrameCallback implements Choreographer.FrameCallback {
    ...
    public double getFPS() {
        return this.mLastFrameTime == this.mFirstFrameTime ? AudioStats.AUDIO_AMPLITUDE_NONE : (getNumFrames() * 1.0E9d) / (this.mLastFrameTime - this.mFirstFrameTime);
    }

    public double getJSFPS() {
        return this.mLastFrameTime == this.mFirstFrameTime ? AudioStats.AUDIO_AMPLITUDE_NONE : (getNumJSFrames() * 1.0E9d) / (this.mLastFrameTime - this.mFirstFrameTime);
    }
