...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public void setSelectionHandleColor(ReactEditText reactEditText, Integer num) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (num != null) {
                Z$$ExternalSyntheticApiModelOutline0.m1824m();
                int intValue = num.intValue();
                blendMode = BlendMode.SRC_IN;
                BlendModeColorFilter m = Z$$ExternalSyntheticApiModelOutline0.m(intValue, blendMode);
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (textCursorDrawable != null) {
                if (num != null) {
                    ...
                    int intValue = num.intValue();
                    blendMode = BlendMode.SRC_IN;
                    textCursorDrawable.setColorFilter(Z$$ExternalSyntheticApiModelOutline0.m(intValue, blendMode));
                } else {
