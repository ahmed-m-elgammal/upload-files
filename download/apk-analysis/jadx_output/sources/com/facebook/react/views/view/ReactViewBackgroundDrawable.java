...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    private void updatePath() {
        ...
        if (this.mNeedUpdatePathForBorderRadius) {
            ...
            this.mCenterDrawPath.addRoundRect(this.mTempRectForCenterDrawPath, new float[]{Math.max(f - (directionAwareBorderInsets.left * 0.5f), directionAwareBorderInsets.left > 0.0f ? f / directionAwareBorderInsets.left : 0.0f), Math.max(f - (directionAwareBorderInsets.top * 0.5f), directionAwareBorderInsets.top > 0.0f ? f / directionAwareBorderInsets.top : 0.0f), Math.max(f2 - (directionAwareBorderInsets.right * 0.5f), directionAwareBorderInsets.right > 0.0f ? f2 / directionAwareBorderInsets.right : 0.0f), Math.max(f2 - (directionAwareBorderInsets.top * 0.5f), directionAwareBorderInsets.top > 0.0f ? f2 / directionAwareBorderInsets.top : 0.0f), Math.max(borderRadius6 - (directionAwareBorderInsets.right * 0.5f), directionAwareBorderInsets.right > 0.0f ? borderRadius6 / directionAwareBorderInsets.right : 0.0f), Math.max(borderRadius6 - (directionAwareBorderInsets.bottom * 0.5f), directionAwareBorderInsets.bottom > 0.0f ? borderRadius6 / directionAwareBorderInsets.bottom : 0.0f), Math.max(f6 - (directionAwareBorderInsets.left * 0.5f), directionAwareBorderInsets.left > 0.0f ? f6 / directionAwareBorderInsets.left : 0.0f), Math.max(f6 - (directionAwareBorderInsets.bottom * 0.5f), directionAwareBorderInsets.bottom > 0.0f ? f6 / directionAwareBorderInsets.bottom : 0.0f)}, Path.Direction.CW);
