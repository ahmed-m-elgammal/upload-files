...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    protected WritableMap getEventData() {
        ...
        createMap.putDouble("top", AudioStats.AUDIO_AMPLITUDE_NONE);
        createMap.putDouble(ViewProps.BOTTOM, AudioStats.AUDIO_AMPLITUDE_NONE);
        createMap.putDouble("left", AudioStats.AUDIO_AMPLITUDE_NONE);
        createMap.putDouble("right", AudioStats.AUDIO_AMPLITUDE_NONE);
