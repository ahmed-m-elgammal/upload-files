    ...
    private static void fetchOrderMethods() {
        ...
        try {
            if (Build.VERSION.SDK_INT == 28) {
                ...
                mReorderBarrierMethod = Canvas.class.getDeclaredMethod("insertReorderBarrier", null);
                mInorderBarrierMethod = Canvas.class.getDeclaredMethod("insertInorderBarrier", null);
            }
