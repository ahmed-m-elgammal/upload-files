...
public class ViewProps {
    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            ...
            case 1:
                return readableMap.isNull(BORDER_RIGHT_WIDTH) || readableMap.getDouble(BORDER_RIGHT_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 2:
                return readableMap.getType(BORDER_TOP_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_TOP_COLOR) == 0;
            case 3:
                return readableMap.isNull(BORDER_TOP_WIDTH) || readableMap.getDouble(BORDER_TOP_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 4:
                return readableMap.getType(BORDER_BOTTOM_COLOR) == ReadableType.Number && readableMap.getInt(BORDER_BOTTOM_COLOR) == 0;
            case 5:
                return readableMap.isNull(BORDER_BOTTOM_WIDTH) || readableMap.getDouble(BORDER_BOTTOM_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 6:
            ...
            case '\b':
                return readableMap.isNull(BORDER_LEFT_WIDTH) || readableMap.getDouble(BORDER_LEFT_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case '\t':
            ...
            case '\f':
                return readableMap.isNull(BORDER_WIDTH) || readableMap.getDouble(BORDER_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case '\r':
            ...
            case 14:
                if (!readableMap.hasKey("backgroundColor") || (((type = readableMap.getType("backgroundColor")) != ReadableType.Number || readableMap.getInt("backgroundColor") == 0) && type == ReadableType.Null)) {
                    return !readableMap.hasKey(BORDER_WIDTH) || readableMap.isNull(BORDER_WIDTH) || readableMap.getDouble(BORDER_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
                return false;
            default:
                return false;
