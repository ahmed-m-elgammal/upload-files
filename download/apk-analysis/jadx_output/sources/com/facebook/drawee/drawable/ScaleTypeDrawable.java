...
public class ScaleTypeDrawable extends ForwardingDrawable {
    ...
    private void configureBoundsIfUnderlyingChanged() {
        ...
        if (scaleType instanceof ScalingUtils.StatefulScaleType) {
            ...
            r2 = state == null || !state.equals(this.mScaleTypeState);
        ...
        if (this.mUnderlyingWidth == current.getIntrinsicWidth() && this.mUnderlyingHeight == current.getIntrinsicHeight() && !r2) {
            return;
        }
        configureBounds();
    }
