...
public final class Utility {
    ...
    public static final boolean isContentUri(Uri uri) {
        return uri != null && StringsKt.equals(UriUtil.LOCAL_CONTENT_SCHEME, uri.getScheme(), true);
    }
    ...
    public static final void getGraphMeRequestWithCacheAsync(final String accessToken, final GraphMeRequestWithCacheCallback callback) {
        ...
        GraphRequest.Callback callback2 = new GraphRequest.Callback() { // from class: com.facebook.internal.Utility$$ExternalSyntheticLambda4
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                Utility.getGraphMeRequestWithCacheAsync$lambda$5(Utility.GraphMeRequestWithCacheCallback.this, accessToken, graphResponse);
            }
        };
    ...
    private final int refreshBestGuessNumberOfCPUCores() {
        ...
        try {
            File[] listFiles = new File("/sys/devices/system/cpu/").listFiles(new FilenameFilter() { // from class: com.facebook.internal.Utility$$ExternalSyntheticLambda5
    ...
    public static final boolean isAutofillAvailable(Context context) {
        AutofillManager m1030m;
        boolean isAutofillSupported;
        boolean isEnabled;
        Intrinsics.checkNotNullParameter(context, "context");
        if (Build.VERSION.SDK_INT < 26 || (m1030m = Utility$$ExternalSyntheticApiModelOutline0.m1030m(context.getSystemService(Utility$$ExternalSyntheticApiModelOutline0.m1031m()))) == null) {
            return false;
        }
        isAutofillSupported = m1030m.isAutofillSupported();
        if (!isAutofillSupported) {
            return false;
        }
        isEnabled = m1030m.isEnabled();
        return isEnabled;
    }
