...
public final class NativeProtocol {
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x008a A[Catch: all -> 0x0096, TRY_ENTER, TryCatch #2 {all -> 0x0096, blocks: (B:6:0x000d, B:29:0x0092, B:30:0x0095, B:18:0x008a), top: B:5:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x006c A[EXC_TOP_SPLITTER, LOOP:0: B:20:0x006c->B:23:0x0072, LOOP_START, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:29:0x0092 A[Catch: all -> 0x0096, TryCatch #2 {all -> 0x0096, blocks: (B:6:0x000d, B:29:0x0092, B:30:0x0095, B:18:0x008a), top: B:5:0x000d }] */
    /*
    ...
    */
    private final java.util.TreeSet<java.lang.Integer> fetchAllAvailableProtocolVersionsForAppInfo(com.facebook.internal.NativeProtocol.NativeAppInfo r13) {
        /*
            ...
            return r3
        Ld:
            java.util.TreeSet r2 = new java.util.TreeSet     // Catch: java.lang.Throwable -> L96
            r2.<init>()     // Catch: java.lang.Throwable -> L96
            android.content.Context r4 = com.facebook.FacebookSdk.getApplicationContext()     // Catch: java.lang.Throwable -> L96
            android.content.ContentResolver r5 = r4.getContentResolver()     // Catch: java.lang.Throwable -> L96
            java.lang.String[] r7 = new java.lang.String[]{r0}     // Catch: java.lang.Throwable -> L96
            android.net.Uri r6 = r12.buildPlatformProviderVersionURI(r13)     // Catch: java.lang.Throwable -> L96
            android.content.Context r4 = com.facebook.FacebookSdk.getApplicationContext()     // Catch: java.lang.Throwable -> L8e
            android.content.pm.PackageManager r4 = r4.getPackageManager()     // Catch: java.lang.Throwable -> L8e
            ...
            java.lang.String r13 = r13.getPackage()     // Catch: java.lang.Throwable -> L8e
            r8.append(r13)     // Catch: java.lang.Throwable -> L8e
            java.lang.String r13 = ".provider.PlatformProvider"
            r8.append(r13)     // Catch: java.lang.Throwable -> L8e
            java.lang.String r13 = r8.toString()     // Catch: java.lang.Throwable -> L8e
            r8 = 0
            android.content.pm.ProviderInfo r13 = r4.resolveContentProvider(r13, r8)     // Catch: java.lang.RuntimeException -> L45 java.lang.Throwable -> L8e
            goto L4e
        L45:
            r13 = move-exception
            java.lang.String r4 = com.facebook.internal.NativeProtocol.TAG     // Catch: java.lang.Throwable -> L8e
            java.lang.Throwable r13 = (java.lang.Throwable) r13     // Catch: java.lang.Throwable -> L8e
            android.util.Log.e(r4, r1, r13)     // Catch: java.lang.Throwable -> L8e
            r13 = r3
        L4e:
            if (r13 == 0) goto L87
            r9 = 0
            r10 = 0
            r8 = 0
            android.database.Cursor r13 = r5.query(r6, r7, r8, r9, r10)     // Catch: java.lang.IllegalArgumentException -> L58 java.lang.SecurityException -> L5e java.lang.NullPointerException -> L64 java.lang.Throwable -> L8e
            goto L6a
        L58:
            java.lang.String r13 = com.facebook.internal.NativeProtocol.TAG     // Catch: java.lang.Throwable -> L8e
            android.util.Log.e(r13, r1)     // Catch: java.lang.Throwable -> L8e
            goto L69
        L5e:
            java.lang.String r13 = com.facebook.internal.NativeProtocol.TAG     // Catch: java.lang.Throwable -> L8e
            android.util.Log.e(r13, r1)     // Catch: java.lang.Throwable -> L8e
        ...
        L6a:
            if (r13 == 0) goto L88
        L6c:
            boolean r1 = r13.moveToNext()     // Catch: java.lang.Throwable -> L82
            if (r1 == 0) goto L88
            int r1 = r13.getColumnIndex(r0)     // Catch: java.lang.Throwable -> L82
            int r1 = r13.getInt(r1)     // Catch: java.lang.Throwable -> L82
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch: java.lang.Throwable -> L82
            r2.add(r1)     // Catch: java.lang.Throwable -> L82
            goto L6c
        L82:
            r0 = move-exception
            r11 = r0
    ...
    private final Uri buildPlatformProviderVersionURI(NativeAppInfo appInfo) {
        ...
        try {
            Uri parse = Uri.parse("content://" + appInfo.getPackage() + PLATFORM_PROVIDER_VERSIONS);
    ...
    private static final class MessengerAppInfo extends NativeAppInfo {
        ...
        public Void m1018getLoginActivity() {
            return null;
        }

        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m1018getLoginActivity();
        }
    ...
    private static final class EffectTestAppInfo extends NativeAppInfo {
        /* renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m1017getLoginActivity() {
            return null;
        }

        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m1017getLoginActivity();
        }
