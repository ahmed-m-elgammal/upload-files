...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m1042assert(boolean condition) {
            if (!condition) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m1042assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
        } finally {
            reentrantLock.unlock();
        }
    ...
    final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode list, boolean addToFront) {
            WorkQueue.INSTANCE.m1042assert(this.next == null);
            WorkQueue.INSTANCE.m1042assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m1042assert(workNode == this);
            Companion companion2 = WorkQueue.INSTANCE;
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion2.m1042assert(workNode2 == this);
            WorkQueue.INSTANCE.m1042assert(getIsRunning() == shouldBeRunning);
        }
    }
}
