...
public final class GpsTopicsManager {
    ...
    public static final CompletableFuture<List<TopicData>> getTopics() {
        ...
        try {
            ...
            final CompletableFuture<List<TopicData>> m995m = Intl$$ExternalSyntheticApiModelOutline0.m995m();
            try {
                Context applicationContext = FacebookSdk.getApplicationContext();
                OutcomeReceiver<GetTopicsResponse, Exception> m = HalfKt$$ExternalSyntheticApiModelOutline0.m((Object) new OutcomeReceiver<GetTopicsResponse, Exception>() { // from class: com.facebook.appevents.gps.topics.GpsTopicsManager$getTopics$callback$1
                    public void onResult(GetTopicsResponse response) {
                        Intrinsics.checkNotNullParameter(response, "response");
                        try {
                            m995m.complete(GpsTopicsManager.access$processObservedTopics(GpsTopicsManager.INSTANCE, response));
                        } catch (Throwable th) {
                    ...
                    public void onError(Exception error) {
                        ...
                        m995m.completeExceptionally(exc);
                    }
                });
                ...
                if (topicsManager != null) {
                    topicsManager.getTopics(builder.build(), gpsTopicsManager.getExecutor(), m);
                }
            } catch (Throwable th) {
