...
public final class GpsAraTriggersManager {
    ...
    public final void registerTriggerAsync(final String applicationId, final AppEvent event) {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.gps.ara.GpsAraTriggersManager$$ExternalSyntheticLambda4
    ...
    public final void registerTrigger(String applicationId, AppEvent event) {
        ...
        try {
            ...
            if (isValidEvent(event) && canRegisterTrigger()) {
                ...
                try {
                    MeasurementManager m = WebViewCompat$$ExternalSyntheticApiModelOutline0.m(applicationContext.getSystemService(WebViewCompat$$ExternalSyntheticApiModelOutline0.m882m()));
                    if (m == null) {
                    ...
                    m.registerTrigger(parse, FacebookSdk.getExecutor(), HalfKt$$ExternalSyntheticApiModelOutline0.m((Object) new OutcomeReceiver<Object, Exception>() { // from class: com.facebook.appevents.gps.ara.GpsAraTriggersManager$registerTrigger$outcomeReceiver$1
