...
public class NumberFormat {
    ...
    private void setNumberFormatDigitOptions(Map<String, Object> map, Object obj, Object obj2) throws JSRangeErrorException {
        ...
        if (!JSObjects.isUndefined(Get) || !JSObjects.isUndefined(Get2)) {
            ...
            Object DefaultNumberOption3 = OptionHelpers.DefaultNumberOption("minimumFractionDigits", Get, JSObjects.newNumber(AudioStats.AUDIO_AMPLITUDE_NONE), JSObjects.newNumber(20.0d), JSObjects.Undefined());
            Object DefaultNumberOption4 = OptionHelpers.DefaultNumberOption("maximumFractionDigits", Get2, JSObjects.newNumber(AudioStats.AUDIO_AMPLITUDE_NONE), JSObjects.newNumber(20.0d), JSObjects.Undefined());
    ...
    private void initializeNumberFormat(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        ...
        if (this.mResolvedStyle == IPlatformNumberFormatter.Style.CURRENCY) {
            ...
            newNumber = JSObjects.newNumber(AudioStats.AUDIO_AMPLITUDE_NONE);
            newNumber2 = this.mResolvedStyle == IPlatformNumberFormatter.Style.PERCENT ? JSObjects.newNumber(AudioStats.AUDIO_AMPLITUDE_NONE) : JSObjects.newNumber(3.0d);
        }
