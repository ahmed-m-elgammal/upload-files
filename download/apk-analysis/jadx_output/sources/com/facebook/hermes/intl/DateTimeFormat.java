...
public class DateTimeFormat {
    ...
    private Object ToDateTimeOptions(Object obj, String str, String str2) throws JSRangeErrorException {
        ...
        boolean z = true;
        if (str.equals(DateProp.name) || str.equals(Languages.ANY)) {
        ...
        if (z && (str2.equals(DateProp.name) || str2.equals("all"))) {
    ...
    private void initializeDateTimeFormat(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        ...
        Object ToDateTimeOptions = ToDateTimeOptions(map, Languages.ANY, DateProp.name);
        ...
        this.mTimeZoneName = (IPlatformDateTimeFormatter.TimeZoneName) OptionHelpers.searchEnum(IPlatformDateTimeFormatter.TimeZoneName.class, OptionHelpers.GetOption(ToDateTimeOptions, RNConstants.ARG_TZ_NAME, OptionHelpers.OptionType.STRING, new String[]{"long", "longOffset", "longGeneric", "short", "shortOffset", "shortGeneric"}, JSObjects.Undefined()));
    ...
    public Map<String, Object> resolvedOptions() throws JSRangeErrorException {
        ...
        if (this.mTimeZoneName != IPlatformDateTimeFormatter.TimeZoneName.UNDEFINED) {
            linkedHashMap.put(RNConstants.ARG_TZ_NAME, this.mTimeZoneName.toString());
        }
