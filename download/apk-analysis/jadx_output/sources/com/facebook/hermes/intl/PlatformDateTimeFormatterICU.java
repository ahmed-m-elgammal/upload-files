...
public class PlatformDateTimeFormatterICU implements IPlatformDateTimeFormatter {
    ...
    public String getDefaultCalendarName(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        Calendar calendar;
        String type;
        dateInstance = DateFormat.getDateInstance(3, Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
    ...
    public IPlatformDateTimeFormatter.HourCycle getDefaultHourCycle(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        try {
            timeInstance = DateFormat.getTimeInstance(0, Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
            pattern = Intl$$ExternalSyntheticApiModelOutline0.m982m((Object) timeInstance).toPattern();
    ...
    public String getDefaultTimeZone(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        TimeZone timeZone;
        String id;
        calendar = Calendar.getInstance(Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
    ...
    public String getDefaultNumberingSystem(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        String name;
        numberingSystem = NumberingSystem.getInstance(Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
    ...
    private static String getPatternForStyle(ILocaleObject<?> iLocaleObject, IPlatformDateTimeFormatter.DateStyle dateStyle, IPlatformDateTimeFormatter.TimeStyle timeStyle) throws JSRangeErrorException {
        ...
        if (dateStyle == IPlatformDateTimeFormatter.DateStyle.UNDEFINED) {
            timeInstance = DateFormat.getTimeInstance(toICUTimeStyle(timeStyle), Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
            localizedPattern3 = Intl$$ExternalSyntheticApiModelOutline0.m982m((Object) timeInstance).toLocalizedPattern();
            return localizedPattern3;
        }
        if (timeStyle == IPlatformDateTimeFormatter.TimeStyle.UNDEFINED) {
            dateInstance = DateFormat.getDateInstance(toICUDateStyle(dateStyle), Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
            localizedPattern2 = Intl$$ExternalSyntheticApiModelOutline0.m982m((Object) dateInstance).toLocalizedPattern();
            return localizedPattern2;
        }
        dateTimeInstance = DateFormat.getDateTimeInstance(toICUDateStyle(dateStyle), toICUTimeStyle(timeStyle), Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
        localizedPattern = Intl$$ExternalSyntheticApiModelOutline0.m982m((Object) dateTimeInstance).toLocalizedPattern();
    ...
    public void configure(ILocaleObject<?> iLocaleObject, String str, String str2, IPlatformDateTimeFormatter.FormatMatcher formatMatcher, IPlatformDateTimeFormatter.WeekDay weekDay, IPlatformDateTimeFormatter.Era era, IPlatformDateTimeFormatter.Year year, IPlatformDateTimeFormatter.Month month, IPlatformDateTimeFormatter.Day day, IPlatformDateTimeFormatter.Hour hour, IPlatformDateTimeFormatter.Minute minute, IPlatformDateTimeFormatter.Second second, IPlatformDateTimeFormatter.TimeZoneName timeZoneName, IPlatformDateTimeFormatter.HourCycle hourCycle, Object obj, IPlatformDateTimeFormatter.DateStyle dateStyle, IPlatformDateTimeFormatter.TimeStyle timeStyle, Object obj2) throws JSRangeErrorException {
        ...
        if (str.isEmpty()) {
            ...
            calendar = Calendar.getInstance(Intl$$ExternalSyntheticApiModelOutline0.m987m(cloneObject.getLocale()));
        }
        if (!str2.isEmpty()) {
            try {
        ...
        if (calendar != null) {
            patternInstance2 = DateFormat.getPatternInstance(calendar, skeleton, Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
            this.mDateFormat = patternInstance2;
        } else {
            patternInstance = DateFormat.getPatternInstance(skeleton, Intl$$ExternalSyntheticApiModelOutline0.m987m(iLocaleObject.getLocale()));
