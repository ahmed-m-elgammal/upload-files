...
public final class DrawViewStartAnnotation extends DrawViewAnnotation {
    ...
    public /* synthetic */ DrawViewStartAnnotation(int i, String str, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public DrawViewStartAnnotation(int i, String name, boolean z) {
        super(i, name, z);
