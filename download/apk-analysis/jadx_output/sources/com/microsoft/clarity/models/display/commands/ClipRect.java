...
public final class ClipRect extends ClipCommand {
    ...
    public DisplayCommand copy2() {
        return new ClipRect(this.rect.copy2(), getOp(), getAntiAlias());
    }
    ...
    public MutationPayload$DisplayCommand toProtobufInstance() {
        GeneratedMessageLite build = MutationPayload$DisplayCommand.newBuilder().a(getType().toProtobufType()).f(this.rect.toProtobufInstance()).i(getOp()).a(getAntiAlias()).build();
