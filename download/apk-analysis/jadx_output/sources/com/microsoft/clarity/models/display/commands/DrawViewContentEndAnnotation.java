...
public final class DrawViewContentEndAnnotation extends DrawViewAnnotation {
    ...
    public DisplayCommand copy2() {
        return new DrawViewContentEndAnnotation(getId(), getName());
    }
    ...
    public /* synthetic */ DrawViewContentEndAnnotation(int i, String str, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, (i2 & 2) != 0 ? "" : str);
    }
}
