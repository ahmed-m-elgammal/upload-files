...
public class FirestoreChannel {
    ...
    <ReqT, RespT> ClientCall<ReqT, RespT> runBidiStreamingRpc(MethodDescriptor<ReqT, RespT> methodDescriptor, final IncomingStreamObserver<RespT> incomingStreamObserver) {
        ...
        createClientCall.addOnCompleteListener(this.asyncQueue.getExecutor(), new OnCompleteListener() { // from class: com.google.firebase.firestore.remote.FirestoreChannel$$ExternalSyntheticLambda0
            ...
            public final void onComplete(Task task) {
                FirestoreChannel.this.m1698xae2b8084(clientCallArr, incomingStreamObserver, task);
            }
        });
    ...
    /* synthetic */ void m1698xae2b8084(final ClientCall[] clientCallArr, final IncomingStreamObserver incomingStreamObserver, Task task) {
    ...
    <ReqT, RespT> void runStreamingResponseRpc(MethodDescriptor<ReqT, RespT> methodDescriptor, final ReqT reqt, final StreamingListener<RespT> streamingListener) {
        this.callProvider.createClientCall(methodDescriptor).addOnCompleteListener(this.asyncQueue.getExecutor(), new OnCompleteListener() { // from class: com.google.firebase.firestore.remote.FirestoreChannel$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                FirestoreChannel.this.m1700x26428698(streamingListener, reqt, task);
            }
        });
    }
    ...
    /* synthetic */ void m1700x26428698(final StreamingListener streamingListener, Object obj, Task task) {
    ...
    <ReqT, RespT> Task<RespT> runRpc(MethodDescriptor<ReqT, RespT> methodDescriptor, final ReqT reqt) {
        ...
        this.callProvider.createClientCall(methodDescriptor).addOnCompleteListener(this.asyncQueue.getExecutor(), new OnCompleteListener() { // from class: com.google.firebase.firestore.remote.FirestoreChannel$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                FirestoreChannel.this.m1699x7c1edc40(taskCompletionSource, reqt, task);
            }
        });
    ...
    /* synthetic */ void m1699x7c1edc40(final TaskCompletionSource taskCompletionSource, Object obj, Task task) {
        ClientCall clientCall = (ClientCall) task.getResult();
