    ...
    public static int compareUtf8Strings(String str, String str2) {
        ...
        while (i < str.length() && i < str2.length()) {
            ...
            if (codePointAt != codePointAt2) {
                ...
                int compareByteStrings = compareByteStrings(ByteString.copyFromUtf8(getUtf8SafeBytes(str, i)), ByteString.copyFromUtf8(getUtf8SafeBytes(str2, i)));
                return compareByteStrings != 0 ? compareByteStrings : Integer.compare(codePointAt, codePointAt2);
            }
