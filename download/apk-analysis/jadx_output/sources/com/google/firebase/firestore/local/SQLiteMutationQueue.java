...
final class SQLiteMutationQueue implements MutationQueue {
    ...
    public void start() {
        ...
        if (this.db.query("SELECT last_stream_token FROM mutation_queues WHERE uid = ?").binding(this.uid).first(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda5
            ...
            public final void accept(Object obj) {
                SQLiteMutationQueue.this.m1665xf87fd3c7((Cursor) obj);
            }
        }) == 0) {
    ...
    /* synthetic */ void m1665xf87fd3c7(Cursor cursor) {
    ...
    private void loadNextBatchIdAcrossAllUsers() {
        ...
        while (it.hasNext()) {
            this.db.query("SELECT MAX(batch_id) FROM mutations WHERE uid = ?").binding((String) it.next()).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda9
                @Override // com.google.firebase.firestore.util.Consumer
                public final void accept(Object obj) {
                    SQLiteMutationQueue.this.m1663xa3a174c9((Cursor) obj);
                }
            });
        }
        this.nextBatchId++;
    ...
    /* synthetic */ void m1663xa3a174c9(Cursor cursor) {
    ...
    public MutationBatch lookupMutationBatch(final int i) {
        return (MutationBatch) this.db.query("SELECT SUBSTR(mutations, 1, ?) FROM mutations WHERE uid = ? AND batch_id = ?").binding(1000000, this.uid, Integer.valueOf(i)).firstValue(new Function() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda2
            ...
            public final Object apply(Object obj) {
                return SQLiteMutationQueue.this.m1664xb685bf9f(i, (Cursor) obj);
            }
        });
    }
    ...
    /* synthetic */ MutationBatch m1664xb685bf9f(int i, Cursor cursor) {
    ...
    public MutationBatch getNextMutationBatchAfterBatchId(int i) {
        return (MutationBatch) this.db.query("SELECT batch_id, SUBSTR(mutations, 1, ?) FROM mutations WHERE uid = ? AND batch_id >= ? ORDER BY batch_id ASC LIMIT 1").binding(1000000, this.uid, Integer.valueOf(i + 1)).firstValue(new Function() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda10
            @Override // com.google.firebase.firestore.util.Function
            public final Object apply(Object obj) {
                return SQLiteMutationQueue.this.m1662x6512fc44((Cursor) obj);
            }
        });
    }
    ...
    /* synthetic */ MutationBatch m1662x6512fc44(Cursor cursor) {
    ...
    public List<MutationBatch> getAllMutationBatches() {
        ...
        this.db.query("SELECT batch_id, SUBSTR(mutations, 1, ?) FROM mutations WHERE uid = ? ORDER BY batch_id ASC").binding(1000000, this.uid).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda6
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteMutationQueue.this.m1658x425a097f(arrayList, (Cursor) obj);
            }
        });
        return arrayList;
    }
    ...
    /* synthetic */ void m1658x425a097f(List list, Cursor cursor) {
    ...
    public List<MutationBatch> getAllMutationBatchesAffectingDocumentKey(DocumentKey documentKey) {
        ...
        this.db.query("SELECT m.batch_id, SUBSTR(m.mutations, 1, ?) FROM document_mutations dm, mutations m WHERE dm.uid = ? AND dm.path = ? AND dm.uid = m.uid AND dm.batch_id = m.batch_id ORDER BY dm.batch_id").binding(1000000, this.uid, encode).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda0
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteMutationQueue.this.m1659xb3096ab7(arrayList, (Cursor) obj);
            }
        });
        return arrayList;
    }
    ...
    /* synthetic */ void m1659xb3096ab7(List list, Cursor cursor) {
        list.add(decodeInlineMutationBatch(cursor.getInt(0), cursor.getBlob(1)));
    }
    ...
    public List<MutationBatch> getAllMutationBatchesAffectingDocumentKeys(Iterable<DocumentKey> iterable) {
        ...
        while (longQuery.hasMoreSubqueries()) {
            longQuery.performNextSubquery().forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda11
                @Override // com.google.firebase.firestore.util.Consumer
                public final void accept(Object obj) {
                    SQLiteMutationQueue.this.m1660x1f85c24f(hashSet, arrayList2, (Cursor) obj);
                }
            });
        }
    ...
    /* synthetic */ void m1660x1f85c24f(Set set, List list, Cursor cursor) {
    ...
    public List<MutationBatch> getAllMutationBatchesAffectingQuery(Query query) {
        ...
        this.db.query("SELECT dm.batch_id, dm.path, SUBSTR(m.mutations, 1, ?) FROM document_mutations dm, mutations m WHERE dm.uid = ? AND dm.path >= ? AND dm.path < ? AND dm.uid = m.uid AND dm.batch_id = m.batch_id ORDER BY dm.batch_id").binding(1000000, this.uid, encode, prefixSuccessor).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteMutationQueue$$ExternalSyntheticLambda3
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteMutationQueue.this.m1661xb8a43fc7(arrayList, length, (Cursor) obj);
            }
        });
        return arrayList;
    }
    ...
    /* synthetic */ void m1661xb8a43fc7(List list, int i, Cursor cursor) {
