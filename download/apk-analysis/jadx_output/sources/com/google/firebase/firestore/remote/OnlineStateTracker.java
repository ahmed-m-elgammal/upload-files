...
class OnlineStateTracker {
    ...
    void handleWatchStreamStart() {
        if (this.watchStreamFailures == 0) {
            ...
            this.onlineStateTimer = this.workerQueue.enqueueAfterDelay(AsyncQueue.TimerId.ONLINE_STATE_TIMEOUT, WorkRequest.MIN_BACKOFF_MILLIS, new Runnable() { // from class: com.google.firebase.firestore.remote.OnlineStateTracker$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    OnlineStateTracker.this.m1708x16bdafa1();
                }
            });
        }
    }
