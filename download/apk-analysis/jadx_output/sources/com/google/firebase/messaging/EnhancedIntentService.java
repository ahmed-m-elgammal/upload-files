...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void run() {
                EnhancedIntentService.this.m1723x624ce8b2(intent, taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m1723x624ce8b2(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(final Intent intent, int i, int i2) {
        ...
        processIntent.addOnCompleteListener(new DefaultDownloaderFactory$$ExternalSyntheticLambda0(), new OnCompleteListener() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda0
            ...
            public final void onComplete(Task task) {
                EnhancedIntentService.this.m1722x83fa35aa(intent, task);
            }
        });
        return 3;
    }
    ...
    /* synthetic */ void m1722x83fa35aa(Intent intent, Task task) {
        finishTask(intent);
    }
