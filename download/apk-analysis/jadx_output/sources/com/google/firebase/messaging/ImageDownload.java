...
public class ImageDownload implements Closeable {
    ...
    public void start(ExecutorService executorService) {
        ...
        this.future = executorService.submit(new Runnable() { // from class: com.google.firebase.messaging.ImageDownload$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ImageDownload.this.m1738lambda$start$0$comgooglefirebasemessagingImageDownload(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m1738lambda$start$0$comgooglefirebasemessagingImageDownload(TaskCompletionSource taskCompletionSource) {
        try {
