...
final class zzfi implements ObjectEncoderContext {
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzfh
            @Override // com.google.firebase.encoders.Encoder
            public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) {
                zzfi.zzg((Map.Entry) obj, objectEncoderContext);
            }
        };
    }

    zzfi(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static zzfg zzj(FieldDescriptor fieldDescriptor) {
        zzfg zzfgVar = (zzfg) fieldDescriptor.getProperty(zzfg.class);
        if (zzfgVar != null) {
            return zzfgVar;
        }
    ...
    private final zzfi zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zzfi zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    final ObjectEncoderContext zzc(FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof zzfe) {
            zzd(fieldDescriptor, ((zzfe) obj).zza(), true);
            return this;
        }
    ...
    final zzfi zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzfg zzj = zzj(fieldDescriptor);
    ...
    final zzfi zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzfg zzj = zzj(fieldDescriptor);
    ...
    final zzfi zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
