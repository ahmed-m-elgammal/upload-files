...
public enum zziv implements zzag {
    ...
    OPTIONAL_MODULE_LANGUAGE_ID(HttpServletResponse.SC_UNAUTHORIZED),
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(HttpServletResponse.SC_PAYMENT_REQUIRED),
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(HttpServletResponse.SC_FORBIDDEN),
    OPTIONAL_MODULE_LANGUAGE_ID_INFERENCE(HttpServletResponse.SC_NOT_FOUND),
    OPTIONAL_MODULE_LANGUAGE_ID_RELEASE(HttpServletResponse.SC_METHOD_NOT_ALLOWED),
    OPTIONAL_MODULE_NLCLASSIFIER(HttpServletResponse.SC_LENGTH_REQUIRED),
    OPTIONAL_MODULE_NLCLASSIFIER_CREATE(412),
    OPTIONAL_MODULE_NLCLASSIFIER_INIT(HttpServletResponse.SC_REQUEST_ENTITY_TOO_LARGE),
    OPTIONAL_MODULE_NLCLASSIFIER_INFERENCE(HttpServletResponse.SC_REQUEST_URI_TOO_LONG),
    OPTIONAL_MODULE_NLCLASSIFIER_RELEASE(HttpServletResponse.SC_UNSUPPORTED_MEDIA_TYPE),
    NLCLASSIFIER_CLIENT_LIBRARY(StatusLine.HTTP_MISDIRECTED_REQUEST),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_CREATE(HttpServletResponse.SC_NOT_IMPLEMENTED),
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(HttpServletResponse.SC_BAD_GATEWAY),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(HttpServletResponse.SC_SERVICE_UNAVAILABLE),
    ON_DEVICE_EXPLICIT_CONTENT_CLOSE(HttpServletResponse.SC_GATEWAY_TIMEOUT),
