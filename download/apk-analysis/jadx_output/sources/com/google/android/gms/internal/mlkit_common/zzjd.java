...
final class zzjd implements ObjectEncoder {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzonVar.zzg());
        objectEncoderContext2.add(zzc, zzonVar.zzh());
        objectEncoderContext2.add(zzd, (Object) null);
        objectEncoderContext2.add(zze, zzonVar.zzj());
        objectEncoderContext2.add(zzf, zzonVar.zzk());
        objectEncoderContext2.add(zzg, (Object) null);
        objectEncoderContext2.add(zzh, (Object) null);
        objectEncoderContext2.add(zzi, zzonVar.zza());
        objectEncoderContext2.add(zzj, zzonVar.zzi());
        objectEncoderContext2.add(zzk, zzonVar.zzb());
        objectEncoderContext2.add(zzl, zzonVar.zzd());
        objectEncoderContext2.add(zzm, zzonVar.zzc());
        objectEncoderContext2.add(zzn, zzonVar.zze());
        objectEncoderContext2.add(zzo, zzonVar.zzf());
    }
}
