...
final class zzgl implements ObjectEncoder {
    ...
    static {
        ...
        zzbkVar104.zza(107);
        zzba = builder104.withProperty(zzbkVar104.zzb()).build();
        FieldDescriptor.Builder builder105 = FieldDescriptor.builder("lowLightFrameProcessEvent");
        zzbk zzbkVar105 = new zzbk();
        zzbkVar105.zza(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR);
        zzbb = builder105.withProperty(zzbkVar105.zzb()).build();
        FieldDescriptor.Builder builder106 = FieldDescriptor.builder("lowLightSceneDetectionEvent");
        zzbk zzbkVar106 = new zzbk();
        zzbkVar106.zza(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY);
        zzbc = builder106.withProperty(zzbkVar106.zzb()).build();
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzlqVar.zzf());
        objectEncoderContext2.add(zzc, zzlqVar.zzd());
        objectEncoderContext2.add(zzd, (Object) null);
        objectEncoderContext2.add(zze, (Object) null);
        objectEncoderContext2.add(zzf, zzlqVar.zze());
        ...
        objectEncoderContext2.add(zzL, (Object) null);
        objectEncoderContext2.add(zzM, (Object) null);
        objectEncoderContext2.add(zzN, zzlqVar.zzb());
        objectEncoderContext2.add(zzO, zzlqVar.zza());
        objectEncoderContext2.add(zzP, (Object) null);
        objectEncoderContext2.add(zzQ, (Object) null);
        objectEncoderContext2.add(zzR, (Object) null);
        objectEncoderContext2.add(zzS, (Object) null);
        ...
        objectEncoderContext2.add(zzab, zzlqVar.zzc());
