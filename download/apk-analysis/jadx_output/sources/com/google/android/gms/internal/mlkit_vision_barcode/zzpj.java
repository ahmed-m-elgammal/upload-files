...
public enum zzpj implements zzfe {
    ...
    CAMERA1_SOURCE_NO_SUITABLE_SIZE_ERROR(HttpServletResponse.SC_SEE_OTHER),
    CAMERA1_SOURCE_NO_SUITABLE_FPS_ERROR(HttpServletResponse.SC_NOT_MODIFIED),
    CAMERA1_SOURCE_NO_BYTE_SOURCE_FOUND_ERROR(HttpServletResponse.SC_USE_PROXY),
    CODE_SCANNER_UNAVAILABLE(400),
    CODE_SCANNER_CANCELLED(HttpServletResponse.SC_UNAUTHORIZED),
    CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED(HttpServletResponse.SC_PAYMENT_REQUIRED),
    CODE_SCANNER_APP_NAME_UNAVAILABLE(HttpServletResponse.SC_FORBIDDEN),
    CODE_SCANNER_TASK_IN_PROGRESS(HttpServletResponse.SC_NOT_FOUND),
    CODE_SCANNER_PIPELINE_INITIALIZATION_ERROR(HttpServletResponse.SC_METHOD_NOT_ALLOWED),
    CODE_SCANNER_PIPELINE_INFERENCE_ERROR(HttpServletResponse.SC_NOT_ACCEPTABLE),
    CODE_SCANNER_GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD(HttpServletResponse.SC_PROXY_AUTHENTICATION_REQUIRED),
    LOW_LIGHT_AUTO_EXPOSURE_COMPUTATION_FAILURE(500),
    LOW_LIGHT_IMAGE_CAPTURE_PROCESSING_FAILURE(HttpServletResponse.SC_NOT_IMPLEMENTED),
    UNKNOWN_ERROR(9999);
