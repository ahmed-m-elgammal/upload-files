...
public abstract class zzdb implements Iterable, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzd()), zzd() <= 50 ? zzgw.zza(this) : zzgw.zza(zzk(0, 47)).concat("..."));
    }
