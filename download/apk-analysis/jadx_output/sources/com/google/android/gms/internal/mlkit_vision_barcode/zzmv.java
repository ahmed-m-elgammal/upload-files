...
final class zzmv implements ObjectEncoder {
    ...
    static {
        ...
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder(ClarityEmitter.CLARITY_SESSION_ID_PARAMETER);
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzsgVar.zze());
        objectEncoderContext2.add(zzc, zzsgVar.zzf());
        objectEncoderContext2.add(zzd, zzsgVar.zzc());
        objectEncoderContext2.add(zze, zzsgVar.zzb());
        objectEncoderContext2.add(zzf, zzsgVar.zzd());
        objectEncoderContext2.add(zzg, zzsgVar.zza());
    }
}
