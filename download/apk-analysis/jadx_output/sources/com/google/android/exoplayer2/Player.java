...
public interface Player {
    ...
    public static final class PositionInfo implements Bundleable {
        ...
        public static PositionInfo fromBundle(Bundle bundle) {
            ...
            return new PositionInfo(null, i, bundle2 == null ? null : MediaItem.CREATOR.fromBundle(bundle2), null, bundle.getInt(keyForField(2), -1), bundle.getLong(keyForField(3), -9223372036854775807L), bundle.getLong(keyForField(4), -9223372036854775807L), bundle.getInt(keyForField(5), -1), bundle.getInt(keyForField(6), -1));
        }
