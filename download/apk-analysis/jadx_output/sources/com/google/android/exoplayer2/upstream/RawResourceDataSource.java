...
public final class RawResourceDataSource extends BaseDataSource {
    ...
    public long open(DataSpec dataSpec) throws RawResourceDataSourceException {
        ...
        this.uri = uri;
        if (TextUtils.equals("rawresource", uri.getScheme()) || (TextUtils.equals(UriUtil.QUALIFIED_RESOURCE_SCHEME, uri.getScheme()) && uri.getPathSegments().size() == 1 && ((String) Assertions.checkNotNull(uri.getLastPathSegment())).matches("\\d+"))) {
            try {
