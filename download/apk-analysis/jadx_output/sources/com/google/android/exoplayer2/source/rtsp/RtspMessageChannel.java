...
import androidx.media3.session.SessionToken$$ExternalSyntheticLambda1;
...
final class RtspMessageChannel implements Closeable {
    ...
    final class Sender implements Closeable {
        ...
        public void send(final List<String> list) {
            ...
            this.senderThreadHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RtspMessageChannel.Sender.this.m1488x9fa6909d(convertMessageToByteArray, list);
                }
            });
        }
        ...
        /* synthetic */ void m1488x9fa6909d(byte[] bArr, List list) {
            try {
        ...
        public void close() {
            ...
            handler.post(new SessionToken$$ExternalSyntheticLambda1(handlerThread));
            try {
