...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        ListenableFuture<V> loadAsync(final K key, final int hash, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            loadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    LocalCache.Segment.this.m1534lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(key, hash, loadingValueReference, loadFuture);
                }
        ...
        /* synthetic */ void m1534lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
            ...
            try {
                ...
                return Futures.transform(reload, new Function() { // from class: com.google.common.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return LocalCache.LoadingValueReference.this.m1533x59597480(obj);
                    }
                }, MoreExecutors.directExecutor());
            } catch (Throwable th) {
        ...
        /* synthetic */ Object m1533x59597480(Object obj) {
            set(obj);
            return obj;
        }
