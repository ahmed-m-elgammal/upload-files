    ...
    class AnonymousClass2 extends IncidentEdgeSet<N> {
        ...
        public UnmodifiableIterator<EndpointPair<N>> iterator() {
            if (this.graph.isDirected()) {
                return Iterators.unmodifiableIterator(Iterators.concat(Iterators.transform(this.graph.predecessors((BaseGraph<N>) this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.AnonymousClass2.this.m1542lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                    ...
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.AnonymousClass2.this.m1543lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                })));
            }
            return Iterators.unmodifiableIterator(Iterators.transform(this.graph.adjacentNodes(this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return AbstractBaseGraph.AnonymousClass2.this.m1544lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(obj);
                }
            }));
        }

        /* renamed from: lambda$iterator$0$com-google-common-graph-AbstractBaseGraph$2, reason: not valid java name */
        /* synthetic */ EndpointPair m1542lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        /* synthetic */ EndpointPair m1543lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        /* synthetic */ EndpointPair m1544lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
