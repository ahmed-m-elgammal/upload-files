...
public final class Stats implements Serializable {
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper(this).add("count", this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add(MetricSummary.JsonKeys.MIN, this.min).add(MetricSummary.JsonKeys.MAX, this.max).toString();
        }
