...
public final class FirestoreGrpc {
    ...
    public interface AsyncService {
        ...
        /* renamed from: com.google.firestore.v1.FirestoreGrpc$AsyncService$-CC, reason: invalid class name */
        public final /* synthetic */ class CC {
            public static void $default$getDocument(AsyncService _this, GetDocumentRequest getDocumentRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getGetDocumentMethod(), streamObserver);
            }

            public static void $default$listDocuments(AsyncService _this, ListDocumentsRequest listDocumentsRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getListDocumentsMethod(), streamObserver);
            }

            public static void $default$updateDocument(AsyncService _this, UpdateDocumentRequest updateDocumentRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getUpdateDocumentMethod(), streamObserver);
            }

            public static void $default$deleteDocument(AsyncService _this, DeleteDocumentRequest deleteDocumentRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getDeleteDocumentMethod(), streamObserver);
            }

            public static void $default$batchGetDocuments(AsyncService _this, BatchGetDocumentsRequest batchGetDocumentsRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getBatchGetDocumentsMethod(), streamObserver);
            }

            public static void $default$beginTransaction(AsyncService _this, BeginTransactionRequest beginTransactionRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getBeginTransactionMethod(), streamObserver);
            }

            public static void $default$commit(AsyncService _this, CommitRequest commitRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getCommitMethod(), streamObserver);
            }

            public static void $default$rollback(AsyncService _this, RollbackRequest rollbackRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getRollbackMethod(), streamObserver);
            }

            public static void $default$runQuery(AsyncService _this, RunQueryRequest runQueryRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getRunQueryMethod(), streamObserver);
            }

            public static void $default$runAggregationQuery(AsyncService _this, RunAggregationQueryRequest runAggregationQueryRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getRunAggregationQueryMethod(), streamObserver);
            }

            public static StreamObserver $default$write(AsyncService _this, StreamObserver streamObserver) {
                return ServerCalls.asyncUnimplementedStreamingCall(FirestoreGrpc.getWriteMethod(), streamObserver);
            }

            public static StreamObserver $default$listen(AsyncService _this, StreamObserver streamObserver) {
                return ServerCalls.asyncUnimplementedStreamingCall(FirestoreGrpc.getListenMethod(), streamObserver);
            }

            public static void $default$listCollectionIds(AsyncService _this, ListCollectionIdsRequest listCollectionIdsRequest, StreamObserver streamObserver) {
                ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getListCollectionIdsMethod(), streamObserver);
            }

            public static void $default$createDocument(AsyncService _this, CreateDocumentRequest createDocumentRequest, StreamObserver streamObserver) {
    ...
    public static abstract class FirestoreImplBase implements BindableService, AsyncService {
        ...
        public /* synthetic */ void runAggregationQuery(RunAggregationQueryRequest runAggregationQueryRequest, StreamObserver streamObserver) {
            AsyncService.CC.$default$runAggregationQuery(this, runAggregationQueryRequest, streamObserver);
        }

        @Override // com.google.firestore.v1.FirestoreGrpc.AsyncService
        public /* synthetic */ void runQuery(RunQueryRequest runQueryRequest, StreamObserver streamObserver) {
            AsyncService.CC.$default$runQuery(this, runQueryRequest, streamObserver);
        }

        @Override // com.google.firestore.v1.FirestoreGrpc.AsyncService
        public /* synthetic */ void updateDocument(UpdateDocumentRequest updateDocumentRequest, StreamObserver streamObserver) {
            AsyncService.CC.$default$updateDocument(this, updateDocumentRequest, streamObserver);
        }

        @Override // com.google.firestore.v1.FirestoreGrpc.AsyncService
        public /* synthetic */ StreamObserver write(StreamObserver streamObserver) {
            return AsyncService.CC.$default$write(this, streamObserver);
        }
