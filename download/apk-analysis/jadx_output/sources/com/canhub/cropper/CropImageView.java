...
public final class CropImageView extends FrameLayout implements CropOverlayView.CropWindowChangeListener {
    ...
    /* compiled from: CropImageView.kt */
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J(\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u000e\u0010\b\u001a\n\u0018\u00010\tj\u0004\u0018\u0001`\nH&¨\u0006\u000b"}, d2 = {"Lcom/canhub/cropper/CropImageView$OnSetImageUriCompleteListener;", "", "onSetImageUriComplete", "", ViewHierarchyConstants.VIEW_KEY, "Lcom/canhub/cropper/CropImageView;", "uri", "Landroid/net/Uri;", "error", "Ljava/lang/Exception;", "Lkotlin/Exception;", "cropper_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
        ...
        if (cropImageOptions == null) {
            ...
            if (attributeSet != null) {
                ...
                try {
                    ...
                    cropImageOptions.cornerShape = CropCornerShape.values()[obtainStyledAttributes.getInt(R.styleable.CropImageView_cornerShape, cropImageOptions.cornerShape.ordinal())];
                    cropImageOptions.cropCornerRadius = obtainStyledAttributes.getDimension(R.styleable.CropImageView_cropCornerRadius, cropImageOptions.cropCornerRadius);
                    ...
                    cropImageOptions.circleCornerFillColorHexValue = obtainStyledAttributes.getInteger(R.styleable.CropImageView_cropCornerCircleFillColor, cropImageOptions.circleCornerFillColorHexValue);
                    ...
                    cropImageOptions.cropperLabelTextSize = obtainStyledAttributes.getDimension(R.styleable.CropImageView_cropperLabelTextSize, cropImageOptions.cropperLabelTextSize);
                    cropImageOptions.cropperLabelTextColor = obtainStyledAttributes.getInteger(R.styleable.CropImageView_cropperLabelTextColor, cropImageOptions.cropperLabelTextColor);
                    cropImageOptions.cropperLabelText = obtainStyledAttributes.getString(R.styleable.CropImageView_cropperLabelText);
                    cropImageOptions.showCropLabel = obtainStyledAttributes.getBoolean(R.styleable.CropImageView_cropShowLabel, cropImageOptions.showCropLabel);
    ...
    public final void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
        ...
        if (bitmap == null || exif == null) {
            ...
            BitmapUtils.RotateBitmapResult orientateBitmapByExif = BitmapUtils.INSTANCE.orientateBitmapByExif(bitmap, exif);
    ...
    public final void rotateImage(int degrees) {
        ...
        if (this.originalBitmap != null) {
            ...
            float height = (z ? rect.height() : rect.width()) / 2.0f;
            RectF rect2 = BitmapUtils.INSTANCE.getRECT();
            float width = (z ? rect2.width() : rect2.height()) / 2.0f;
            if (z) {
            ...
            float sqrt = this.mZoom / ((float) Math.sqrt(Math.pow(BitmapUtils.INSTANCE.getPOINTS2()[4] - BitmapUtils.INSTANCE.getPOINTS2()[2], 2.0d) + Math.pow(BitmapUtils.INSTANCE.getPOINTS2()[5] - BitmapUtils.INSTANCE.getPOINTS2()[3], 2.0d)));
            this.mZoom = sqrt;
            this.mZoom = Math.max(sqrt, 1.0f);
            applyImageMatrix(getWidth(), getHeight(), true, false);
            this.mImageMatrix.mapPoints(BitmapUtils.INSTANCE.getPOINTS2(), BitmapUtils.INSTANCE.getPOINTS());
            float sqrt2 = (float) Math.sqrt(Math.pow(BitmapUtils.INSTANCE.getPOINTS2()[4] - BitmapUtils.INSTANCE.getPOINTS2()[2], 2.0d) + Math.pow(BitmapUtils.INSTANCE.getPOINTS2()[5] - BitmapUtils.INSTANCE.getPOINTS2()[3], 2.0d));
    ...
    */
    ...
    private final void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (this.originalBitmap != null) {
            ...
            float min = Math.min(width / BitmapUtils.INSTANCE.getRectWidth(this.mImagePoints), height / BitmapUtils.INSTANCE.getRectHeight(this.mImagePoints));
