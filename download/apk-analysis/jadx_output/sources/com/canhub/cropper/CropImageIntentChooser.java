...
public final class CropImageIntentChooser {
    ...
    public CropImageIntentChooser(ComponentActivity activity, ResultCallback callback) {
        ...
        ActivityResultLauncher<Intent> registerForActivityResult = activity.registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback() { // from class: com.canhub.cropper.CropImageIntentChooser$$ExternalSyntheticLambda0
            ...
            public final void onActivityResult(Object obj) {
                CropImageIntentChooser.m924intentChooser$lambda1(CropImageIntentChooser.this, (ActivityResult) obj);
            }
        });
    ...
    public static final void m924intentChooser$lambda1(CropImageIntentChooser this$0, ActivityResult activityResult) {
        Uri uri;
    ...
    private final List<Intent> getGalleryIntents(PackageManager packageManager, String action) {
        ...
        for (String str : this.priorityIntentList) {
            ...
            while (true) {
                ...
                obj = it.next();
                if (Intrinsics.areEqual(((Intent) obj).getPackage(), str)) {
                    break;
                }
            }
