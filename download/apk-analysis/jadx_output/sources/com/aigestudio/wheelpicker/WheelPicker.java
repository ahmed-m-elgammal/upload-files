    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i5 < this.mSelectedItemPosition + i4 + this.mDrawnItemCount) {
            if (this.isCyclic) {
                ...
                str = String.valueOf(this.mData.get(i5));
            }
            ...
            if (this.isCurved) {
                float abs = (((i7 - Math.abs(i7 - i9)) - this.mRectDrawn.top) * 1.0f) / (this.mDrawnCenterY - this.mRectDrawn.top);
            ...
            if (this.hasAtmospheric) {
                ...
                int abs2 = (int) ((((i14 - Math.abs(i14 - i9)) * 1.0f) / this.mDrawnCenterY) * 255.0f);
            ...
            if (this.isDebug) {
                ...
                int i15 = this.mWheelCenterY + (this.mItemHeight * i6);
                float f8 = i15;
                canvas.drawLine(this.mRectDrawn.left, f8, this.mRectDrawn.right, f8, this.mPaint);
                this.mPaint.setColor(-13421586);
                this.mPaint.setStyle(Paint.Style.STROKE);
                canvas.drawRect(this.mRectDrawn.left, i15 - this.mHalfItemHeight, this.mRectDrawn.right, r11 + this.mItemHeight, this.mPaint);
                canvas.restore();
            }
            i5++;
            i6++;
