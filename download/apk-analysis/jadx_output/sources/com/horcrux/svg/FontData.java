...
class FontData {
    ...
    static class AbsoluteFontWeight {
        ...
        private static final int[] absoluteFontWeights = {400, 700, 100, 200, 300, 400, 500, LogSeverity.CRITICAL_VALUE, 700, LogSeverity.EMERGENCY_VALUE, SQLitePersistence.MAX_ARGS};
        ...
        private static int bolder(int i) {
            ...
            return i < 900 ? SQLitePersistence.MAX_ARGS : i;
        }
    ...
    FontData(ReadableMap readableMap, FontData fontData, double d) {
        ...
        if (readableMap.hasKey(WORD_SPACING)) {
            d2 = toAbsolute(readableMap, WORD_SPACING, d, this.fontSize, AudioStats.AUDIO_AMPLITUDE_NONE);
        } else {
            d2 = fontData.wordSpacing;
        }
        this.wordSpacing = d2;
        if (readableMap.hasKey("letterSpacing")) {
            d3 = toAbsolute(readableMap, "letterSpacing", d, this.fontSize, AudioStats.AUDIO_AMPLITUDE_NONE);
        } else {
