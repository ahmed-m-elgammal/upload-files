...
class TSpanView extends TextView {
    ...
    private void drawWrappedText(Canvas canvas, Paint paint) {
        ...
        float nextX = (float) textRootGlyphContext.nextX(AudioStats.AUDIO_AMPLITUDE_NONE);
    ...
    */
    ...
    private void applyTextPropertiesToPaint(Paint paint, FontData fontData) {
        ...
        if (str != null && str.length() > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                Downloader$$ExternalSyntheticApiModelOutline0.m2156m();
                Typeface.Builder m = Downloader$$ExternalSyntheticApiModelOutline0.m(this.assets, str2);
                ...
                if (typeface == null) {
                    Downloader$$ExternalSyntheticApiModelOutline0.m2156m();
                    Typeface.Builder m2 = Downloader$$ExternalSyntheticApiModelOutline0.m(this.assets, str3);
