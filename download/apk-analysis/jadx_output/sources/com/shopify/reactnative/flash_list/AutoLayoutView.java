...
public final class AutoLayoutView extends ReactViewGroup {
    ...
    private final void emitBlankAreaEvent() {
        ...
        createMap.putDouble("offsetStart", this.alShadow.getBlankOffsetAtStart() / this.pixelDensity);
        createMap.putDouble("offsetEnd", this.alShadow.getBlankOffsetAtEnd() / this.pixelDensity);
