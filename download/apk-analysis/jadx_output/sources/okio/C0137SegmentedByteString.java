...
public final class C0137SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0137SegmentedByteString, endIndex);
        if (beginIndex < 0) {
