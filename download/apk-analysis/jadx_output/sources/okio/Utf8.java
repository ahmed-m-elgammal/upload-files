        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) charAt2, 128) < 0) {
                ...
                if (Intrinsics.compare((int) charAt2, 2048) < 0) {
                    ...
                    yield.invoke(Byte.valueOf((byte) ((charAt2 & '?') | 128)));
                } else if (Intrinsics.compare((int) charAt2, GeneratorBase.SURR1_LAST) > 0 || i2 <= (i3 = i + 1) || 56320 > (charAt = str.charAt(i3)) || charAt >= 57344) {
