...
public final class SegmentedByteString {
    ...
    public static final int segment(C0137SegmentedByteString c0137SegmentedByteString, int i) {
        ...
        int binarySearch = binarySearch(c0137SegmentedByteString.getDirectory(), i + 1, 0, c0137SegmentedByteString.getSegments().length);
    ...
    private static final void forEachSegment(C0137SegmentedByteString c0137SegmentedByteString, int i, int i2, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        int segment = segment(c0137SegmentedByteString, i);
        while (i < i2) {
            int i3 = segment == 0 ? 0 : c0137SegmentedByteString.getDirectory()[segment - 1];
            int i4 = c0137SegmentedByteString.getDirectory()[segment] - i3;
            int i5 = c0137SegmentedByteString.getDirectory()[c0137SegmentedByteString.getSegments().length + segment];
            int min = Math.min(i2, i4 + i3) - i;
            function3.invoke(c0137SegmentedByteString.getSegments()[segment], Integer.valueOf(i5 + (i - i3)), Integer.valueOf(min));
            i += min;
            segment++;
        }
    }
    ...
    public static final ByteString commonSubstring(C0137SegmentedByteString c0137SegmentedByteString, int i, int i2) {
        ...
        int resolveDefaultParameter = okio.SegmentedByteString.resolveDefaultParameter(c0137SegmentedByteString2, i2);
        if (i < 0) {
            throw new IllegalArgumentException(("beginIndex=" + i + " < 0").toString());
        }
        if (resolveDefaultParameter > c0137SegmentedByteString.size()) {
            throw new IllegalArgumentException(("endIndex=" + resolveDefaultParameter + " > length(" + c0137SegmentedByteString.size() + ')').toString());
        }
        ...
        if (i == 0 && resolveDefaultParameter == c0137SegmentedByteString.size()) {
        ...
        int segment = segment(c0137SegmentedByteString, i);
        int segment2 = segment(c0137SegmentedByteString, resolveDefaultParameter - 1);
        byte[][] bArr = (byte[][]) ArraysKt.copyOfRange(c0137SegmentedByteString.getSegments(), segment, segment2 + 1);
        byte[][] bArr2 = bArr;
        ...
        int i7 = segment != 0 ? c0137SegmentedByteString.getDirectory()[segment - 1] : 0;
    ...
    public static final byte commonInternalGet(C0137SegmentedByteString c0137SegmentedByteString, int i) {
        ...
        int segment = segment(c0137SegmentedByteString, i);
        return c0137SegmentedByteString.getSegments()[segment][(i - (segment == 0 ? 0 : c0137SegmentedByteString.getDirectory()[segment - 1])) + c0137SegmentedByteString.getDirectory()[c0137SegmentedByteString.getSegments().length + segment]];
    }
    ...
    public static final boolean commonRangeEquals(C0137SegmentedByteString c0137SegmentedByteString, int i, ByteString other, int i2, int i3) {
        ...
        int segment = segment(c0137SegmentedByteString, i);
        while (i < i4) {
            int i5 = segment == 0 ? 0 : c0137SegmentedByteString.getDirectory()[segment - 1];
            int i6 = c0137SegmentedByteString.getDirectory()[segment] - i5;
            int i7 = c0137SegmentedByteString.getDirectory()[c0137SegmentedByteString.getSegments().length + segment];
            int min = Math.min(i4, i6 + i5) - i;
            if (!other.rangeEquals(i2, c0137SegmentedByteString.getSegments()[segment], i7 + (i - i5), min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final boolean commonRangeEquals(C0137SegmentedByteString c0137SegmentedByteString, int i, byte[] other, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            int i7 = c0137SegmentedByteString.getDirectory()[c0137SegmentedByteString.getSegments().length + segment];
            int min = Math.min(i4, i6 + i5) - i;
            if (!okio.SegmentedByteString.arrayRangeEquals(c0137SegmentedByteString.getSegments()[segment], i7 + (i - i5), other, i2, min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final void commonCopyInto(C0137SegmentedByteString c0137SegmentedByteString, int i, byte[] target, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            int min = Math.min(i4, i6 + i5) - i;
            int i8 = i7 + (i - i5);
            ArraysKt.copyInto(c0137SegmentedByteString.getSegments()[segment], target, i2, i8, i8 + min);
            i2 += min;
            i += min;
            segment++;
        }
    ...
    public static final void commonWrite(C0137SegmentedByteString c0137SegmentedByteString, Buffer buffer, int i, int i2) {
        ...
        int segment = segment(c0137SegmentedByteString, i);
        while (i < i3) {
            int i4 = segment == 0 ? 0 : c0137SegmentedByteString.getDirectory()[segment - 1];
            int i5 = c0137SegmentedByteString.getDirectory()[segment] - i4;
            int i6 = c0137SegmentedByteString.getDirectory()[c0137SegmentedByteString.getSegments().length + segment];
            int min = Math.min(i3, i5 + i4) - i;
            int i7 = i6 + (i - i4);
            Segment segment2 = new Segment(c0137SegmentedByteString.getSegments()[segment], i7, i7 + min, true, false);
            if (buffer.head == null) {
